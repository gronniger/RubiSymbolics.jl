@testset "3.1.4 (f x)^m (d+e x^r)^q (a+b log(c x^n))^p" begin
    (a, b, c, d, e, f, g, m, n, p, q, r, x, ) = @variables a b c d e f g m n p q r x
    ...
    @test_int [x^3*sqrt(d + e*x)*(a + b*log(c*x^n)), x, If(13>=8, 8, 9), (64*b*d^4*n*sqrt(d + e*x))/(315*e^4) + (64*b*d^3*n*(d + e*x)^(3/2))/(945*e^4) - (356*b*d^2*n*(d + e*x)^(5/2))/(1575*e^4) + (80*b*d*n*(d + e*x)^(7/2))/(441*e^4) - (4*b*n*(d + e*x)^(9/2))/(81*e^4) - (64*b*d^(9/2)*n*atanh(sqrt(d + e*x)/sqrt(d)))/(315*e^4) - (2*d^3*(d + e*x)^(3/2)*(a + b*log(c*x^n)))/(3*e^4) + (6*d^2*(d + e*x)^(5/2)*(a + b*log(c*x^n)))/(5*e^4) - (6*d*(d + e*x)^(7/2)*(a + b*log(c*x^n)))/(7*e^4) + (2*(d + e*x)^(9/2)*(a + b*log(c*x^n)))/(9*e^4)]
    @test_int [x^2*sqrt(d + e*x)*(a + b*log(c*x^n)), x, If(13>=8, 6, 7), -((32*b*d^3*n*sqrt(d + e*x))/(105*e^3)) - (32*b*d^2*n*(d + e*x)^(3/2))/(315*e^3) + (36*b*d*n*(d + e*x)^(5/2))/(175*e^3) - (4*b*n*(d + e*x)^(7/2))/(49*e^3) + (32*b*d^(7/2)*n*atanh(sqrt(d + e*x)/sqrt(d)))/(105*e^3) + (2*d^2*(d + e*x)^(3/2)*(a + b*log(c*x^n)))/(3*e^3) - (4*d*(d + e*x)^(5/2)*(a + b*log(c*x^n)))/(5*e^3) + (2*(d + e*x)^(7/2)*(a + b*log(c*x^n)))/(7*e^3)]
    @test_int [x^1*sqrt(d + e*x)*(a + b*log(c*x^n)), x, If(13>=8, 7, 8), (8*b*d^2*n*sqrt(d + e*x))/(15*e^2) + (8*b*d*n*(d + e*x)^(3/2))/(45*e^2) - (4*b*n*(d + e*x)^(5/2))/(25*e^2) - (8*b*d^(5/2)*n*atanh(sqrt(d + e*x)/sqrt(d)))/(15*e^2) - (2*d*(d + e*x)^(3/2)*(a + b*log(c*x^n)))/(3*e^2) + (2*(d + e*x)^(5/2)*(a + b*log(c*x^n)))/(5*e^2)]
    ...
    @test_int [x^0*(a + b*x)^m*log(c*x^n), x, 2, (n*(a + b*x)^(2 + m)*HypergeometricFunctions._₂F₁(1, 2 + m, 3 + m, 1 + (b*x)/a))/(a*b*(2 + 3*m + m^2)) + ((a + b*x)^(1 + m)*log(c*x^n))/(b*(1 + m))]
    ...
    @test_int [x^5*sqrt(d + e*x^2)*(a + b*log(c*x^n)), x, If(13>=8, 7, 8), -((8*b*d^3*n*sqrt(d + e*x^2))/(105*e^3)) - (8*b*d^2*n*(d + e*x^2)^(3/2))/(315*e^3) + (9*b*d*n*(d + e*x^2)^(5/2))/(175*e^3) - (b*n*(d + e*x^2)^(7/2))/(49*e^3) + (8*b*d^(7/2)*n*atanh(sqrt(d + e*x^2)/sqrt(d)))/(105*e^3) + (d^2*(d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(3*e^3) - (2*d*(d + e*x^2)^(5/2)*(a + b*log(c*x^n)))/(5*e^3) + ((d + e*x^2)^(7/2)*(a + b*log(c*x^n)))/(7*e^3)]
    @test_int [x^3*sqrt(d + e*x^2)*(a + b*log(c*x^n)), x, If(13>=8, 8, 9), (2*b*d^2*n*sqrt(d + e*x^2))/(15*e^2) + (2*b*d*n*(d + e*x^2)^(3/2))/(45*e^2) - (b*n*(d + e*x^2)^(5/2))/(25*e^2) - (2*b*d^(5/2)*n*atanh(sqrt(d + e*x^2)/sqrt(d)))/(15*e^2) - (d*(d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(3*e^2) + ((d + e*x^2)^(5/2)*(a + b*log(c*x^n)))/(5*e^2)]
    ...
    @test_int [sqrt(d + e*x^2)*(a + b*log(c*x^n))/x^6, x, If(13>=8, 7, 8), If(13>=8, (2*b*e^2*n*sqrt(d + e*x^2))/(15*d^2*x) + (2*b*e*n*(d + e*x^2)^(3/2))/(45*d^2*x^3) - (b*n*(d + e*x^2)^(5/2))/(25*d^2*x^5) - (2*b*e^(5/2)*n*atanh((sqrt(e)*x)/sqrt(d + e*x^2)))/(15*d^2) - ((d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(5*d*x^5) + (2*e*(d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(15*d^2*x^3), (2*b*e^2*n*sqrt(d + e*x^2))/(15*d^2*x) + (2*b*e*n*(d + e*x^2)^(3/2))/(45*d^2*x^3) - (b*n*(d + e*x^2)^(5/2))/(25*d^2*x^5) - (2*b*e^(5/2)*n*atanh((sqrt(e)*x)/sqrt(d + e*x^2)))/(15*d^2) - ((d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(5*d*x^5) + (2*e*(d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(15*d^2*x^3))]
    @test_int [sqrt(d + e*x^2)*(a + b*log(c*x^n))/x^8, x, If(13>=8, 8, 9), If(13>=8, -((8*b*e^3*n*sqrt(d + e*x^2))/(105*d^3*x)) - (8*b*e^2*n*(d + e*x^2)^(3/2))/(315*d^3*x^3) - (b*n*(d + e*x^2)^(5/2))/(49*d^2*x^7) + (38*b*e*n*(d + e*x^2)^(5/2))/(1225*d^3*x^5) + (8*b*e^(7/2)*n*atanh((sqrt(e)*x)/sqrt(d + e*x^2)))/(105*d^3) - ((d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(7*d*x^7) + (4*e*(d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(35*d^2*x^5) - (8*e^2*(d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(105*d^3*x^3), -((8*b*e^3*n*sqrt(d + e*x^2))/(105*d^3*x)) - (b*n*(d + e*x^2)^(3/2))/(49*d*x^7) + (13*b*e*n*(d + e*x^2)^(3/2))/(1225*d^2*x^5) + (62*b*e^2*n*(d + e*x^2)^(3/2))/(11025*d^3*x^3) + (8*b*e^(7/2)*n*atanh((sqrt(e)*x)/sqrt(d + e*x^2)))/(105*d^3) - ((d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(7*d*x^7) + (4*e*(d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(35*d^2*x^5) - (8*e^2*(d + e*x^2)^(3/2)*(a + b*log(c*x^n)))/(105*d^3*x^3))]
    ...
    @test_int [(d + e/x^(1/(q + 1)))^q*(a + b*log(c*x^n)), x, 3, ((-b)*n*x*(d + e/x^(1/(1 + q)))^q*HypergeometricFunctions._₂F₁(-1 - q, -1 - q, -q, -(e/(x^(1/(1 + q))*d))))/(1 + e/(x^(1/(1 + q))*d))^q + (x*(d + e/x^(1/(1 + q)))^(1 + q)*(a + b*log(c*x^n)))/d]


    @test_int [(d + e*x^r)^q*(a + b*log(c*x^n))/(f*x)^(r*(q + 1) + 1), x, 3, -((b*n*(d + e*x^r)^q*HypergeometricFunctions._₂F₁(-1 - q, -1 - q, -q, -((e*x^r)/d)))/((f*x)^((1 + q)*r)*(1 + (e*x^r)/d)^q*(f*(1 + q)^2*r^2))) - ((d + e*x^r)^(1 + q)*(a + b*log(c*x^n)))/((f*x)^((1 + q)*r)*(d*f*(1 + q)*r))]
