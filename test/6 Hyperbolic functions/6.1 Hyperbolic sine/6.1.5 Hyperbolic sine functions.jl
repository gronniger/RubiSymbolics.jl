@testset "6.1.5 Hyperbolic sine functions" begin
    ...
    @test_int [sinh(a + b*x)^(7/2), x, 4, -((10*im*EllipticF((1/2)*(im*a - pi/2 + im*b*x), 2)*sqrt(im*sinh(a + b*x)))/(21*b*sqrt(sinh(a + b*x)))) - (10*cosh(a + b*x)*sqrt(sinh(a + b*x)))/(21*b) + (2*cosh(a + b*x)*sinh(a + b*x)^(5/2))/(7*b)]
    @test_int [sinh(a + b*x)^(5/2), x, 3, (6*im*EllipticE((1/2)*(im*a - pi/2 + im*b*x), 2)*sqrt(sinh(a + b*x)))/(5*b*sqrt(im*sinh(a + b*x))) + (2*cosh(a + b*x)*sinh(a + b*x)^(3/2))/(5*b)]
    @test_int [sinh(a + b*x)^(3/2), x, 3, (2*im*EllipticF((1/2)*(im*a - pi/2 + im*b*x), 2)*sqrt(im*sinh(a + b*x)))/(3*b*sqrt(sinh(a + b*x))) + (2*cosh(a + b*x)*sqrt(sinh(a + b*x)))/(3*b)]
    @test_int [sinh(a + b*x)^(1/2), x, 2, -((2*im*EllipticE((1/2)*(im*a - pi/2 + im*b*x), 2)*sqrt(sinh(a + b*x)))/(b*sqrt(im*sinh(a + b*x))))]
    @test_int [1/sinh(a + b*x)^(1/2), x, 2, -((2*im*EllipticF((1/2)*(im*a - pi/2 + im*b*x), 2)*sqrt(im*sinh(a + b*x)))/(b*sqrt(sinh(a + b*x))))]
    @test_int [1/sinh(a + b*x)^(3/2), x, 3, -((2*cosh(a + b*x))/(b*sqrt(sinh(a + b*x)))) - (2*im*EllipticE((1/2)*(im*a - pi/2 + im*b*x), 2)*sqrt(sinh(a + b*x)))/(b*sqrt(im*sinh(a + b*x)))]
    @test_int [1/sinh(a + b*x)^(5/2), x, 3, -((2*cosh(a + b*x))/(3*b*sinh(a + b*x)^(3/2))) + (2*im*EllipticF((1/2)*(im*a - pi/2 + im*b*x), 2)*sqrt(im*sinh(a + b*x)))/(3*b*sqrt(sinh(a + b*x)))]
    @test_int [1/sinh(a + b*x)^(7/2), x, 4, -((2*cosh(a + b*x))/(5*b*sinh(a + b*x)^(5/2))) + (6*cosh(a + b*x))/(5*b*sqrt(sinh(a + b*x))) + (6*im*EllipticE((1/2)*(im*a - pi/2 + im*b*x), 2)*sqrt(sinh(a + b*x)))/(5*b*sqrt(im*sinh(a + b*x)))]
    ...
    @test_int [(b*sinh(c + d*x))^(7/2), x, 4, -((10*im*b^4*EllipticF((1/2)*(im*c - pi/2 + im*d*x), 2)*sqrt(im*sinh(c + d*x)))/(21*d*sqrt(b*sinh(c + d*x)))) - (10*b^3*cosh(c + d*x)*sqrt(b*sinh(c + d*x)))/(21*d) + (2*b*cosh(c + d*x)*(b*sinh(c + d*x))^(5/2))/(7*d)]
    @test_int [(b*sinh(c + d*x))^(5/2), x, 3, (6*im*b^2*EllipticE((1/2)*(im*c - pi/2 + im*d*x), 2)*sqrt(b*sinh(c + d*x)))/(5*d*sqrt(im*sinh(c + d*x))) + (2*b*cosh(c + d*x)*(b*sinh(c + d*x))^(3/2))/(5*d)]
    @test_int [(b*sinh(c + d*x))^(3/2),x, 3, (2*im*b^2*EllipticF((1/2)*(im*c - pi/2 + im*d*x), 2)*sqrt(im*sinh(c + d*x)))/(3*d*sqrt(b*sinh(c + d*x))) + (2*b*cosh(c + d*x)*sqrt(b*sinh(c + d*x)))/(3*d)]
    @test_int [(b*sinh(c + d*x))^(1/2), x, 2, -((2*im*EllipticE((1/2)*(im*c - pi/2 + im*d*x), 2)*sqrt(b*sinh(c + d*x)))/(d*sqrt(im*sinh(c + d*x))))]
    @test_int [1/(b*sinh(c + d*x))^(1/2), x, 2, -((2*im*EllipticF((1/2)*(im*c - pi/2 + im*d*x), 2)*sqrt(im*sinh(c + d*x)))/(d*sqrt(b*sinh(c + d*x))))]
    @test_int [1/(b*sinh(c + d*x))^(3/2), x, 3, -((2*cosh(c + d*x))/(b*d*sqrt(b*sinh(c + d*x)))) - (2*im*EllipticE((1/2)*(im*c - pi/2 + im*d*x), 2)*sqrt(b*sinh(c + d*x)))/(b^2*d*sqrt(im*sinh(c + d*x)))]
    @test_int [1/(b*sinh(c + d*x))^(5/2), x, 3, -((2*cosh(c + d*x))/(3*b*d*(b*sinh(c + d*x))^(3/2))) + (2*im*EllipticF((1/2)*(im*c - pi/2 + im*d*x), 2)*sqrt(im*sinh(c + d*x)))/(3*b^2*d*sqrt(b*sinh(c + d*x)))]
    @test_int [1/(b*sinh(c + d*x))^(7/2), x, 4, -((2*cosh(c + d*x))/(5*b*d*(b*sinh(c + d*x))^(5/2))) + (6*cosh(c + d*x))/(5*b^3*d*sqrt(b*sinh(c + d*x))) + (6*im*EllipticE((1/2)*(im*c - pi/2 + im*d*x), 2)*sqrt(b*sinh(c + d*x)))/(5*b^4*d*sqrt(im*sinh(c + d*x)))]


    @test_int [(im*sinh(c + d*x))^(7/2), x, 3, -((10*im*EllipticF((1/2)*(im*c - pi/2 + im*d*x), 2))/(21*d)) + (10*im*cosh(c + d*x)*sqrt(im*sinh(c + d*x)))/(21*d) + (2*im*cosh(c + d*x)*(im*sinh(c + d*x))^(5/2))/(7*d)]
    @test_int [(im*sinh(c + d*x))^(5/2), x, 2, -((6*im*EllipticE((1/2)*(im*c - pi/2 + im*d*x), 2))/(5*d)) + (2*im*cosh(c + d*x)*(im*sinh(c + d*x))^(3/2))/(5*d)]
    @test_int [(im*sinh(c + d*x))^(3/2),x, 2, -((2*im*EllipticF((1/2)*(im*c - pi/2 + im*d*x), 2))/(3*d)) + (2*im*cosh(c + d*x)*sqrt(im*sinh(c + d*x)))/(3*d)]
    @test_int [(im*sinh(c + d*x))^(1/2), x, 1, -((2*im*EllipticE((1/2)*(im*c - pi/2 + im*d*x), 2))/d)]
    @test_int [1/(im*sinh(c + d*x))^(1/2), x, 1, -((2*im*EllipticF((1/2)*(im*c - pi/2 + im*d*x), 2))/d)]
    @test_int [1/(im*sinh(c + d*x))^(3/2), x, 2, (2*im*EllipticE((1/2)*(im*c - pi/2 + im*d*x), 2))/d + (2*im*cosh(c + d*x))/(d*sqrt(im*sinh(c + d*x)))]
    @test_int [1/(im*sinh(c + d*x))^(5/2), x, 2, -((2*im*EllipticF((1/2)*(im*c - pi/2 + im*d*x), 2))/(3*d)) + (2*im*cosh(c + d*x))/(3*d*(im*sinh(c + d*x))^(3/2))]
    @test_int [1/(im*sinh(c + d*x))^(7/2), x, 3, (6*im*EllipticE((1/2)*(im*c - pi/2 + im*d*x), 2))/(5*d) + (2*im*cosh(c + d*x))/(5*d*(im*sinh(c + d*x))^(5/2)) + (6*im*cosh(c + d*x))/(5*d*sqrt(im*sinh(c + d*x)))]
    ...
    @test_int [(b*sinh(c + d*x))^(4/3),x, 1, (3*cosh(c + d*x)*Hypergeometric2F1(1/2, 7/6, 13/6, -sinh(c + d*x)^2)*(b*sinh(c + d*x))^(7/3))/(7*b*d*sqrt(cosh(c + d*x)^2))]
    @test_int [(b*sinh(c + d*x))^(2/3),x, 1, (3*cosh(c + d*x)*Hypergeometric2F1(1/2, 5/6, 11/6, -sinh(c + d*x)^2)*(b*sinh(c + d*x))^(5/3))/(5*b*d*sqrt(cosh(c + d*x)^2))]
    @test_int [(b*sinh(c + d*x))^(1/3),x, 1, (3*cosh(c + d*x)*Hypergeometric2F1(1/2, 2/3, 5/3, -sinh(c + d*x)^2)*(b*sinh(c + d*x))^(4/3))/(4*b*d*sqrt(cosh(c + d*x)^2))]
    @test_int [1/(b*sinh(c + d*x))^(1/3),x, 1, (3*cosh(c + d*x)*Hypergeometric2F1(1/3, 1/2, 4/3, -sinh(c + d*x)^2)*(b*sinh(c + d*x))^(2/3))/(2*b*d*sqrt(cosh(c + d*x)^2))]
    @test_int [1/(b*sinh(c + d*x))^(2/3),x, 1, (3*cosh(c + d*x)*Hypergeometric2F1(1/6, 1/2, 7/6, -sinh(c + d*x)^2)*(b*sinh(c + d*x))^(1/3))/(b*d*sqrt(cosh(c + d*x)^2))]
    @test_int [1/(b*sinh(c + d*x))^(4/3),x, 1, -((3*cosh(c + d*x)*Hypergeometric2F1(-(1/6), 1/2, 5/6, -sinh(c + d*x)^2))/(b*d*sqrt(cosh(c + d*x)^2)*(b*sinh(c + d*x))^(1/3)))]
    ...
    @test_int [(b*sinh(c + d*x))^n, x, 1, (cosh(c + d*x)*Hypergeometric2F1(1/2, (1 + n)/2, (3 + n)/2, -sinh(c + d*x)^2)*(b*sinh(c + d*x))^(1 + n))/(b*d*(1 + n)*sqrt(cosh(c + d*x)^2))]


    @test_int [(im*sinh(c + d*x))^n, x, 1, -((im*cosh(c + d*x)*Hypergeometric2F1(1/2, (1 + n)/2, (3 + n)/2, -sinh(c + d*x)^2)*(im*sinh(c + d*x))^(1 + n))/(d*(1 + n)*sqrt(cosh(c + d*x)^2)))]
    @test_int [(-im*sinh(c + d*x))^n, x, 1, (im*cosh(c + d*x)*Hypergeometric2F1(1/2, (1 + n)/2, (3 + n)/2, -sinh(c + d*x)^2)*((-im)*sinh(c + d*x))^(1 + n))/(d*(1 + n)*sqrt(cosh(c + d*x)^2))]
    ...
    @test_int [(a + b*sinh(x))^(5/2), x, 7, (16/15)*a*b*cosh(x)*sqrt(a + b*sinh(x)) + (2/5)*b*cosh(x)*(a + b*sinh(x))^(3/2) + (2*im*(23*a^2 - 9*b^2)*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/(15*sqrt((a + b*sinh(x))/(a - im*b))) - (16*im*a*(a^2 + b^2)*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/(15*sqrt(a + b*sinh(x)))]
    @test_int [(a + b*sinh(x))^(3/2), x, 6, (2/3)*b*cosh(x)*sqrt(a + b*sinh(x)) + (8*im*a*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/(3*sqrt((a + b*sinh(x))/(a - im*b))) - (2*im*(a^2 + b^2)*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/(3*sqrt(a + b*sinh(x)))]
    @test_int [(a + b*sinh(x))^(1/2), x, 2, (2*im*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/sqrt((a + b*sinh(x))/(a - im*b))]
    @test_int [1/(a + b*sinh(x))^(1/2), x, 2, (2*im*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/sqrt(a + b*sinh(x))]
    @test_int [1/(a + b*sinh(x))^(3/2), x, 4, -((2*b*cosh(x))/((a^2 + b^2)*sqrt(a + b*sinh(x)))) + (2*im*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/((a^2 + b^2)*sqrt((a + b*sinh(x))/(a - im*b)))]
    @test_int [1/(a + b*sinh(x))^(5/2), x, 7, -((2*b*cosh(x))/(3*(a^2 + b^2)*(a + b*sinh(x))^(3/2))) - (8*a*b*cosh(x))/(3*(a^2 + b^2)^2*sqrt(a + b*sinh(x))) + (8*im*a*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/(3*(a^2 + b^2)^2*sqrt((a + b*sinh(x))/(a - im*b))) - (2*im*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/(3*(a^2 + b^2)*sqrt(a + b*sinh(x)))]


    @test_int [sinh(x)/sqrt(a + b*sinh(x)), x, 5, (2*im*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/(b*sqrt((a + b*sinh(x))/(a - im*b))) - (2*im*a*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/(b*sqrt(a + b*sinh(x)))]
    ...
    @test_int [(A + B*sinh(x))*(a + b*sinh(x))^(5/2), x, 8, (2/105)*(56*a*A*b + 15*a^2*B - 25*b^2*B)*cosh(x)*sqrt(a + b*sinh(x)) + (2/35)*(7*A*b + 5*a*B)*cosh(x)*(a + b*sinh(x))^(3/2) + (2/7)*B*cosh(x)*(a + b*sinh(x))^(5/2) + (2*im*(161*a^2*A*b - 63*A*b^3 + 15*a^3*B - 145*a*b^2*B)*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/(105*b*sqrt((a + b*sinh(x))/(a - im*b))) - (2*im*(a^2 + b^2)*(56*a*A*b + 15*a^2*B - 25*b^2*B)*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/(105*b*sqrt(a + b*sinh(x)))]
    @test_int [(A + B*sinh(x))*(a + b*sinh(x))^(3/2), x, 7, (2/15)*(5*A*b + 3*a*B)*cosh(x)*sqrt(a + b*sinh(x)) + (2/5)*B*cosh(x)*(a + b*sinh(x))^(3/2) + (2*im*(20*a*A*b + 3*a^2*B - 9*b^2*B)*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/(15*b*sqrt((a + b*sinh(x))/(a - im*b))) - (2*im*(a^2 + b^2)*(5*A*b + 3*a*B)*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/(15*b*sqrt(a + b*sinh(x)))]
    @test_int [(A + B*sinh(x))*(a + b*sinh(x))^(1/2), x, 6, (2/3)*B*cosh(x)*sqrt(a + b*sinh(x)) + (2*im*(3*A*b + a*B)*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/(3*b*sqrt((a + b*sinh(x))/(a - im*b))) - (2*im*(a^2 + b^2)*B*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/(3*b*sqrt(a + b*sinh(x)))]
    ...
    @test_int [(A + B*sinh(x))/(a + b*sinh(x))^(1/2), x, 5, (2*im*B*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/(b*sqrt((a + b*sinh(x))/(a - im*b))) + (2*im*(A*b - a*B)*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/(b*sqrt(a + b*sinh(x)))]
    @test_int [(A + B*sinh(x))/(a + b*sinh(x))^(3/2), x, 6, -((2*(A*b - a*B)*cosh(x))/((a^2 + b^2)*sqrt(a + b*sinh(x)))) + (2*im*(A*b - a*B)*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/(b*(a^2 + b^2)*sqrt((a + b*sinh(x))/(a - im*b))) + (2*im*B*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/(b*sqrt(a + b*sinh(x)))]
    @test_int [(A + B*sinh(x))/(a + b*sinh(x))^(5/2), x, 7, -((2*(A*b - a*B)*cosh(x))/(3*(a^2 + b^2)*(a + b*sinh(x))^(3/2))) - (2*(4*a*A*b - a^2*B + 3*b^2*B)*cosh(x))/(3*(a^2 + b^2)^2*sqrt(a + b*sinh(x))) + (2*im*(4*a*A*b - a^2*B + 3*b^2*B)*EllipticE(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt(a + b*sinh(x)))/(3*b*(a^2 + b^2)^2*sqrt((a + b*sinh(x))/(a - im*b))) - (2*im*(A*b - a*B)*EllipticF(pi/4 - (im*x)/2, (2*b)/(im*a + b))*sqrt((a + b*sinh(x))/(a - im*b)))/(3*b*(a^2 + b^2)*sqrt(a + b*sinh(x)))]
    ...
    @test_int [(a*sinh(x)^3)^(5/2),x, 7, (-(26/77))*a^2*coth(x)*sqrt(a*sinh(x)^3) + (26/77)*im*a^2*csch(x)^2*EllipticF(pi/4 - (im*x)/2, 2)*sqrt(im*sinh(x))*sqrt(a*sinh(x)^3) + (78/385)*a^2*cosh(x)*sinh(x)*sqrt(a*sinh(x)^3) - (26/165)*a^2*cosh(x)*sinh(x)^3*sqrt(a*sinh(x)^3) + (2/15)*a^2*cosh(x)*sinh(x)^5*sqrt(a*sinh(x)^3)]
    @test_int [(a*sinh(x)^3)^(3/2),x, 5, (-(14/45))*a*cosh(x)*sqrt(a*sinh(x)^3) + (14*im*a*csch(x)*EllipticE(pi/4 - (im*x)/2, 2)*sqrt(a*sinh(x)^3))/(15*sqrt(im*sinh(x))) + (2/9)*a*cosh(x)*sinh(x)^2*sqrt(a*sinh(x)^3)]
    @test_int [(a*sinh(x)^3)^(1/2), x, 4, (2/3)*coth(x)*sqrt(a*sinh(x)^3) - (2/3)*im*csch(x)^2*EllipticF(pi/4 - (im*x)/2, 2)*sqrt(im*sinh(x))*sqrt(a*sinh(x)^3)]
    @test_int [1/(a*sinh(x)^3)^(1/2), x, 4, -((2*cosh(x)*sinh(x))/sqrt(a*sinh(x)^3)) + (2*im*EllipticE(pi/4 - (im*x)/2, 2)*sinh(x)^2)/(sqrt(im*sinh(x))*sqrt(a*sinh(x)^3))]
    @test_int [1/(a*sinh(x)^3)^(3/2),x, 5, (10*cosh(x))/(21*a*sqrt(a*sinh(x)^3)) - (2*coth(x)*csch(x))/(7*a*sqrt(a*sinh(x)^3)) + (10*im*EllipticF(pi/4 - (im*x)/2, 2)*sqrt(im*sinh(x))*sinh(x))/(21*a*sqrt(a*sinh(x)^3))]
    @test_int [1/(a*sinh(x)^3)^(5/2),x, 7, -((154*coth(x))/(585*a^2*sqrt(a*sinh(x)^3))) + (22*coth(x)*csch(x)^2)/(117*a^2*sqrt(a*sinh(x)^3)) - (2*coth(x)*csch(x)^4)/(13*a^2*sqrt(a*sinh(x)^3)) + (154*cosh(x)*sinh(x))/(195*a^2*sqrt(a*sinh(x)^3)) - (154*im*EllipticE(pi/4 - (im*x)/2, 2)*sinh(x)^2)/(195*a^2*sqrt(im*sinh(x))*sqrt(a*sinh(x)^3))]
    ...
    @test_int [coth(x)^2/(im + sinh(x))^2, x, If($VersionNumber<9, 9, 7), If($VersionNumber<9, 2*im*atanh(cosh(x)) + 3*coth(x) - (2*im*coth(x))/(im + sinh(x)), 2*im*atanh(cosh(x)) + coth(x) + (2*im*coth(x))/(im - csch(x)))]
    ...
    @test_int [sinh(a + b*log(c*x^n))^(5/2)/x, x, 4, (6*im*EllipticE((1/2)*(im*a - pi/2 + im*b*log(c*x^n)), 2)*sqrt(sinh(a + b*log(c*x^n))))/(5*b*n*sqrt(im*sinh(a + b*log(c*x^n)))) + (2*cosh(a + b*log(c*x^n))*sinh(a + b*log(c*x^n))^(3/2))/(5*b*n)]
    @test_int [sinh(a + b*log(c*x^n))^(3/2)/x, x, 4, (2*im*EllipticF((1/2)*(im*a - pi/2 + im*b*log(c*x^n)), 2)*sqrt(im*sinh(a + b*log(c*x^n))))/(3*b*n*sqrt(sinh(a + b*log(c*x^n)))) + (2*cosh(a + b*log(c*x^n))*sqrt(sinh(a + b*log(c*x^n))))/(3*b*n)]
    @test_int [sqrt(sinh(a + b*log(c*x^n)))/x, x, 3, -((2*im*EllipticE((1/2)*(im*a - pi/2 + im*b*log(c*x^n)), 2)*sqrt(sinh(a + b*log(c*x^n))))/(b*n*sqrt(im*sinh(a + b*log(c*x^n)))))]
    @test_int [1/(x*sqrt(sinh(a + b*log(c*x^n)))), x, 3, -((2*im*EllipticF((1/2)*(im*a - pi/2 + im*b*log(c*x^n)), 2)*sqrt(im*sinh(a + b*log(c*x^n))))/(b*n*sqrt(sinh(a + b*log(c*x^n)))))]
    @test_int [1/(x*sinh(a + b*log(c*x^n))^(3/2)), x, 4, -((2*cosh(a + b*log(c*x^n)))/(b*n*sqrt(sinh(a + b*log(c*x^n))))) - (2*im*EllipticE((1/2)*(im*a - pi/2 + im*b*log(c*x^n)), 2)*sqrt(sinh(a + b*log(c*x^n))))/(b*n*sqrt(im*sinh(a + b*log(c*x^n))))]
    @test_int [1/(x*sinh(a + b*log(c*x^n))^(5/2)), x, 4, -((2*cosh(a + b*log(c*x^n)))/(3*b*n*sinh(a + b*log(c*x^n))^(3/2))) + (2*im*EllipticF((1/2)*(im*a - pi/2 + im*b*log(c*x^n)), 2)*sqrt(im*sinh(a + b*log(c*x^n))))/(3*b*n*sqrt(sinh(a + b*log(c*x^n))))]
    ...
    @test_int [F^(c*(a + b*x))*csch(d + e*x)^1, x, 1, -((2*ℯ^(d + e*x)*F^(c*(a + b*x))*Hypergeometric2F1(1, (e + b*c*log(F))/(2*e), (1/2)*(3 + (b*c*log(F))/e), ℯ^(2*(d + e*x))))/(e + b*c*log(F)))]
    @test_int [F^(c*(a + b*x))*csch(d + e*x)^2, x, 1, (4*ℯ^(2*(d + e*x))*F^(c*(a + b*x))*Hypergeometric2F1(2, 1 + (b*c*log(F))/(2*e), 2 + (b*c*log(F))/(2*e), ℯ^(2*(d + e*x))))/(2*e + b*c*log(F))]
    @test_int [F^(c*(a + b*x))*csch(d + e*x)^3, x, 2, -((F^(c*(a + b*x))*coth(d + e*x)*csch(d + e*x))/(2*e)) - (b*c*F^(c*(a + b*x))*csch(d + e*x)*log(F))/(2*e^2) + (ℯ^(d + e*x)*F^(c*(a + b*x))*Hypergeometric2F1(1, (e + b*c*log(F))/(2*e), (1/2)*(3 + (b*c*log(F))/e), ℯ^(2*(d + e*x)))*(e - b*c*log(F)))/e^2]
    @test_int [F^(c*(a + b*x))*csch(d + e*x)^4, x, 2, -((F^(c*(a + b*x))*coth(d + e*x)*csch(d + e*x)^2)/(3*e)) - (b*c*F^(c*(a + b*x))*csch(d + e*x)^2*log(F))/(6*e^2) - (2*ℯ^(2*(d + e*x))*F^(c*(a + b*x))*Hypergeometric2F1(2, 1 + (b*c*log(F))/(2*e), 2 + (b*c*log(F))/(2*e), ℯ^(2*(d + e*x)))*(2*e - b*c*log(F)))/(3*e^2)]
    ...
    @test_int [f^(a + c*x^2)*sinh(d + e*x), x, 8, If($VersionNumber>=8, (ℯ^(-d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*Erfi((e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(4*sqrt(c)*sqrt(log(f))) + (ℯ^(d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*Erfi((e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(4*sqrt(c)*sqrt(log(f))), -((ℯ^(-d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*Erfi(-((e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f))))))/(4*sqrt(c)*sqrt(log(f)))) + (ℯ^(d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*Erfi((e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(4*sqrt(c)*sqrt(log(f))))]
    @test_int [f^(a + c*x^2)*sinh(d + e*x)^2, x, 9, If($VersionNumber>=8, -(f^a*sqrt(pi)*Erfi(sqrt(c)*x*sqrt(log(f))))/(4*sqrt(c)*sqrt(log(f))) - (ℯ^(-2*d - e^2/(c*log(f)))*f^a*sqrt(pi)*Erfi((e - c*x*log(f))/(sqrt(c)*sqrt(log(f)))))/(8*sqrt(c)*sqrt(log(f))) + (ℯ^(2*d - e^2/(c*log(f)))*f^a*sqrt(pi)*Erfi((e + c*x*log(f))/(sqrt(c)*sqrt(log(f)))))/(8*sqrt(c)*sqrt(log(f))), -((f^a*sqrt(pi)*Erfi(sqrt(c)*x*sqrt(log(f))))/(4*sqrt(c)*sqrt(log(f)))) + (ℯ^(-2*d - e^2/(c*log(f)))*f^a*sqrt(pi)*Erfi(-((e - c*x*log(f))/(sqrt(c)*sqrt(log(f))))))/(8*sqrt(c)*sqrt(log(f))) + (ℯ^(2*d - e^2/(c*log(f)))*f^a*sqrt(pi)*Erfi((e + c*x*log(f))/(sqrt(c)*sqrt(log(f)))))/(8*sqrt(c)*sqrt(log(f))))]
    @test_int [f^(a + c*x^2)*sinh(d + e*x)^3, x, 14, If($VersionNumber>=8, (-3*ℯ^(-d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*Erfi((e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) + (ℯ^(-3*d - (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*Erfi((3*e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) - (3*ℯ^(d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*Erfi((e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) + (ℯ^(3*d - (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*Erfi((3*e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))), (3*ℯ^(-d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*Erfi(-((e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f))))))/(16*sqrt(c)*sqrt(log(f))) - (ℯ^(-3*d - (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*Erfi(-((3*e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f))))))/(16*sqrt(c)*sqrt(log(f))) - (3*ℯ^(d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*Erfi((e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) + (ℯ^(3*d - (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*Erfi((3*e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))))]
