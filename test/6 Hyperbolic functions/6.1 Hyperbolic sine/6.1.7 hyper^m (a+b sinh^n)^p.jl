@testset "6.1.7 hyper^m (a+b sinh^n)^p" begin
    ...
    @test_int [sinh(e + f*x)^4*sqrt(a + b*sinh(e + f*x)^2), x, 7, ((a - 4*b)*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(15*b*f) + (cosh(e + f*x)*sinh(e + f*x)^3*sqrt(a + b*sinh(e + f*x)^2))/(5*f) + ((2*a^2 + 3*a*b - 8*b^2)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(15*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((a - 4*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(15*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((2*a^2 + 3*a*b - 8*b^2)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(15*b^2*f)]
    @test_int [sinh(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2), x, 6, (cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - ((im/3)*(a - 2*b)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(b*f*sqrt(1 + (b*sinh(e + f*x)^2)/a)) + ((im/3)*a*(a - b)*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(b*f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [sinh(e + f*x)^0*sqrt(a + b*sinh(e + f*x)^2), x, 2, ((-im)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt(1 + (b*sinh(e + f*x)^2)/a))]
    @test_int [csch(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2), x, 7, -((coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/f) - (Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/f]
    @test_int [csch(e + f*x)^4*sqrt(a + b*sinh(e + f*x)^2), x, 7, ((2*a - b)*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*f) - (coth(e + f*x)*csch(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2))/(3*f) + ((2*a - b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((2*a - b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*a*f)]
    ...
    @test_int [sinh(e + f*x)^4*(a + b*sinh(e + f*x)^2)^(3/2), x, 8, ((a^2 - 11*a*b + 8*b^2)*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(35*b*f) + (2*(4*a - 3*b)*cosh(e + f*x)*sinh(e + f*x)^3*sqrt(a + b*sinh(e + f*x)^2))/(35*f) + (b*cosh(e + f*x)*sinh(e + f*x)^5*sqrt(a + b*sinh(e + f*x)^2))/(7*f) + (2*(a - 2*b)*(a^2 + 4*a*b - 4*b^2)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(35*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((a^2 - 11*a*b + 8*b^2)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(35*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (2*(a - 2*b)*(a^2 + 4*a*b - 4*b^2)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(35*b^2*f)]
    @test_int [sinh(e + f*x)^2*(a + b*sinh(e + f*x)^2)^(3/2), x, 7, ((3*a - 4*b)*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(15*f) + (cosh(e + f*x)*sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^(3/2))/(5*f) - ((im/15)*(3*a^2 - 13*a*b + 8*b^2)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(b*f*sqrt(1 + (b*sinh(e + f*x)^2)/a)) + ((im/15)*a*(3*a - 4*b)*(a - b)*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(b*f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [sinh(e + f*x)^0*(a + b*sinh(e + f*x)^2)^(3/2), x, 6, (b*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - (((2*im)/3)*(2*a - b)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt(1 + (b*sinh(e + f*x)^2)/a)) + ((im/3)*a*(a - b)*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [csch(e + f*x)^2*(a + b*sinh(e + f*x)^2)^(3/2), x, 6, -((a*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/f) - ((a + b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (2*b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((a + b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/f]
    @test_int [csch(e + f*x)^4*(a + b*sinh(e + f*x)^2)^(3/2), x, 7, (2*(a - 2*b)*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - (a*coth(e + f*x)*csch(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2))/(3*f) + (2*(a - 2*b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((a - 3*b)*b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (2*(a - 2*b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*f)]


    @test_int [(a + b*sinh(c + d*x)^2)^(5/2), x, 7, (4*(2*a - b)*b*cosh(c + d*x)*sinh(c + d*x)*sqrt(a + b*sinh(c + d*x)^2))/(15*d) + (b*cosh(c + d*x)*sinh(c + d*x)*(a + b*sinh(c + d*x)^2)^(3/2))/(5*d) - ((im/15)*(23*a^2 - 23*a*b + 8*b^2)*Elliptic.E(im*c + im*d*x, b/a)*sqrt(a + b*sinh(c + d*x)^2))/(d*sqrt(1 + (b*sinh(c + d*x)^2)/a)) + (((4*im)/15)*a*(a - b)*(2*a - b)*Elliptic.F(im*c + im*d*x, b/a)*sqrt(1 + (b*sinh(c + d*x)^2)/a))/(d*sqrt(a + b*sinh(c + d*x)^2))]


    @test_int [sqrt(1 + sinh(x)^2), x, 3, sqrt(cosh(x)^2)*tanh(x)]
    @test_int [sqrt(-1 - sinh(x)^2), x, 3, sqrt(-cosh(x)^2)*tanh(x)]
    @test_int [sqrt(1 - sinh(x)^2), x, 1, (-im)*Elliptic.E(im*x, -1)]
    @test_int [sqrt(-1 + sinh(x)^2), x, 2, -((im*Elliptic.E(im*x, -1)*sqrt(-1 + sinh(x)^2))/sqrt(1 - sinh(x)^2))]
    @test_int [sqrt(a + b*sinh(x)^2), x, 2, -((im*Elliptic.E(im*x, b/a)*sqrt(a + b*sinh(x)^2))/sqrt(1 + (b*sinh(x)^2)/a))]


    @test_int [(1 + sinh(x)^2)^(3/2), x, 4, (2/3)*sqrt(cosh(x)^2)*tanh(x) + (1/3)*(cosh(x)^2)^(3/2)*tanh(x)]
    @test_int [(-1 - sinh(x)^2)^(3/2), x, 4, (-(2/3))*sqrt(-cosh(x)^2)*tanh(x) + (1/3)*(-cosh(x)^2)^(3/2)*tanh(x)]
    @test_int [(1 - sinh(x)^2)^(3/2), x, 4, -2*im*Elliptic.E(im*x, -1) + (2/3)*im*Elliptic.F(im*x, -1) - (1/3)*cosh(x)*sinh(x)*sqrt(1 - sinh(x)^2)]
    @test_int [(-1 + sinh(x)^2)^(3/2), x, 6, (2*im*Elliptic.F(im*x, -1)*sqrt(1 - sinh(x)^2))/(3*sqrt(-1 + sinh(x)^2)) + (1/3)*cosh(x)*sinh(x)*sqrt(-1 + sinh(x)^2) + (2*im*Elliptic.E(im*x, -1)*sqrt(-1 + sinh(x)^2))/sqrt(1 - sinh(x)^2)]
    @test_int [(a + b*sinh(x)^2)^(3/2), x, 6, (1/3)*b*cosh(x)*sinh(x)*sqrt(a + b*sinh(x)^2) - (2*im*(2*a - b)*Elliptic.E(im*x, b/a)*sqrt(a + b*sinh(x)^2))/(3*sqrt(1 + (b*sinh(x)^2)/a)) + (im*a*(a - b)*Elliptic.F(im*x, b/a)*sqrt(1 + (b*sinh(x)^2)/a))/(3*sqrt(a + b*sinh(x)^2))]
    ...
    @test_int [sinh(e + f*x)^4/sqrt(a + b*sinh(e + f*x)^2), x, 6, (cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*b*f) + (2*(a + b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (2*(a + b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*b^2*f)]
    @test_int [sinh(e + f*x)^2/sqrt(a + b*sinh(e + f*x)^2), x, 5, ((-im)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(b*f*sqrt(1 + (b*sinh(e + f*x)^2)/a)) + (im*a*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(b*f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [sinh(e + f*x)^0/sqrt(a + b*sinh(e + f*x)^2), x, 2, ((-im)*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [csch(e + f*x)^2/sqrt(a + b*sinh(e + f*x)^2), x, 5, -((coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*f)) - (Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(a*f)]
    @test_int [csch(e + f*x)^4/sqrt(a + b*sinh(e + f*x)^2), x, 7, (2*(a + b)*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^2*f) - (coth(e + f*x)*csch(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2))/(3*a*f) + (2*(a + b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (2*(a + b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*a^2*f)]
    ...
    @test_int [sinh(e + f*x)^6/(a + b*sinh(e + f*x)^2)^(3/2), x, 7, -((a*cosh(e + f*x)*sinh(e + f*x)^3)/((a - b)*b*f*sqrt(a + b*sinh(e + f*x)^2))) + ((4*a - b)*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)*b^2*f) + ((8*a^2 - 3*a*b - 2*b^2)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)*b^3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((4*a - b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((8*a^2 - 3*a*b - 2*b^2)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*(a - b)*b^3*f)]
    @test_int [sinh(e + f*x)^4/(a + b*sinh(e + f*x)^2)^(3/2), x, 6, -((a*cosh(e + f*x)*sinh(e + f*x))/((a - b)*b*f*sqrt(a + b*sinh(e + f*x)^2))) - ((2*a - b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/((a - b)*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/((a - b)*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((2*a - b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/((a - b)*b^2*f)]
    @test_int [sinh(e + f*x)^2/(a + b*sinh(e + f*x)^2)^(3/2), x, 6, (cosh(e + f*x)*sinh(e + f*x))/((a - b)*f*sqrt(a + b*sinh(e + f*x)^2)) + (im*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/((a - b)*b*f*sqrt(1 + (b*sinh(e + f*x)^2)/a)) - (im*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(b*f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [sinh(e + f*x)^0/(a + b*sinh(e + f*x)^2)^(3/2), x, 4, -((b*cosh(e + f*x)*sinh(e + f*x))/(a*(a - b)*f*sqrt(a + b*sinh(e + f*x)^2))) - (im*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(a*(a - b)*f*sqrt(1 + (b*sinh(e + f*x)^2)/a))]
    @test_int [csch(e + f*x)^2/(a + b*sinh(e + f*x)^2)^(3/2), x, 7, -((b*coth(e + f*x))/(a*(a - b)*f*sqrt(a + b*sinh(e + f*x)^2))) - ((a - 2*b)*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a^2*(a - b)*f) - ((a - 2*b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a^2*(a - b)*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a^2*(a - b)*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((a - 2*b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(a^2*(a - b)*f)]
    ...
    @test_int [sinh(e + f*x)^6/(a + b*sinh(e + f*x)^2)^(5/2), x, 7, -(a*cosh(e + f*x)*sinh(e + f*x)^3)/(3*(a - b)*b*f*(a + b*sinh(e + f*x)^2)^(3/2)) - (2*a*(2*a - 3*b)*cosh(e + f*x)*sinh(e + f*x))/(3*(a - b)^2*b^2*f*sqrt(a + b*sinh(e + f*x)^2)) - ((8*a^2 - 13*a*b + 3*b^2)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)^2*b^3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (2*(2*a - 3*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)^2*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((8*a^2 - 13*a*b + 3*b^2)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*(a - b)^2*b^3*f)]
    @test_int [sinh(e + f*x)^4/(a + b*sinh(e + f*x)^2)^(5/2), x, 5, -(a*cosh(e + f*x)*sinh(e + f*x))/(3*(a - b)*b*f*(a + b*sinh(e + f*x)^2)^(3/2)) + (2*sqrt(a)*(a - 2*b)*cosh(e + f*x)*Elliptic.E(atan((sqrt(b)*sinh(e + f*x))/sqrt(a)), 1 - a/b))/(3*(a - b)^2*b^(3/2)*f*sqrt((a*cosh(e + f*x)^2)/(a + b*sinh(e + f*x)^2))*sqrt(a + b*sinh(e + f*x)^2)) - ((a - 3*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*(a - b)^2*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a))]
    @test_int [sinh(e + f*x)^2/(a + b*sinh(e + f*x)^2)^(5/2), x, 7, (cosh(e + f*x)*sinh(e + f*x))/(3*(a - b)*f*(a + b*sinh(e + f*x)^2)^(3/2)) + ((a + b)*cosh(e + f*x)*sinh(e + f*x))/(3*a*(a - b)^2*f*sqrt(a + b*sinh(e + f*x)^2)) + ((im/3)*(a + b)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(a*(a - b)^2*b*f*sqrt(1 + (b*sinh(e + f*x)^2)/a)) - ((im/3)*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/((a - b)*b*f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [sinh(e + f*x)^0/(a + b*sinh(e + f*x)^2)^(5/2), x, 7, -(b*cosh(e + f*x)*sinh(e + f*x))/(3*a*(a - b)*f*(a + b*sinh(e + f*x)^2)^(3/2)) - (2*(2*a - b)*b*cosh(e + f*x)*sinh(e + f*x))/(3*a^2*(a - b)^2*f*sqrt(a + b*sinh(e + f*x)^2)) - (((2*im)/3)*(2*a - b)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(a^2*(a - b)^2*f*sqrt(1 + (b*sinh(e + f*x)^2)/a)) + ((im/3)*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(a*(a - b)*f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [csch(e + f*x)^2/(a + b*sinh(e + f*x)^2)^(5/2), x, 8, -(b*coth(e + f*x))/(3*a*(a - b)*f*(a + b*sinh(e + f*x)^2)^(3/2)) - (2*(3*a - 2*b)*b*coth(e + f*x))/(3*a^2*(a - b)^2*f*sqrt(a + b*sinh(e + f*x)^2)) - ((3*a^2 - 13*a*b + 8*b^2)*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^3*(a - b)^2*f) - ((3*a^2 - 13*a*b + 8*b^2)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^3*(a - b)^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (2*(3*a - 2*b)*b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^3*(a - b)^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a^2 - 13*a*b + 8*b^2)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*a^3*(a - b)^2*f)]


    @test_int [1/sqrt(1 + sinh(x)^2), x, 3, (atan(sinh(x))*cosh(x))/sqrt(cosh(x)^2)]
    @test_int [1/sqrt(1 - sinh(x)^2), x, 1, (-im)*Elliptic.F(im*x, -1)]
    @test_int [1/sqrt(-1 + sinh(x)^2), x, 2, -((im*Elliptic.F(im*x, -1)*sqrt(1 - sinh(x)^2))/sqrt(-1 + sinh(x)^2))]
    @test_int [1/sqrt(-1 - sinh(x)^2), x, 3, (atan(sinh(x))*cosh(x))/sqrt(-cosh(x)^2)]
    @test_int [1/sqrt(a + b*sinh(x)^2), x, 2, -((im*Elliptic.F(im*x, b/a)*sqrt(1 + (b*sinh(x)^2)/a))/sqrt(a + b*sinh(x)^2))]
    ...
    @test_int [sinh(e + f*x)^5*(a + b*sinh(e + f*x)^2)^p, x, 5, If(13>=8, -(((3*a + 2*b*(2 + p))*cosh(e + f*x)*(a - b + b*cosh(e + f*x)^2)^(1 + p))/(b^2*f*(3 + 2*p)*(5 + 2*p))) + ((3*a^2 + 4*a*b*(1 + p) + 4*b^2*(2 + 3*p + p^2))*cosh(e + f*x)*(a - b + b*cosh(e + f*x)^2)^p*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*cosh(e + f*x)^2)/(a - b))))/(b^2*f*(3 + 2*p)*(5 + 2*p)*(1 + (b*cosh(e + f*x)^2)/(a - b))^p) + (cosh(e + f*x)*(a - b + b*cosh(e + f*x)^2)^(1 + p)*sinh(e + f*x)^2)/(b*f*(5 + 2*p)), -(((3*a + 2*b*(2 + p))*cosh(e + f*x)*(a - b + b*cosh(e + f*x)^2)^(1 + p))/(b^2*f*(15 + 16*p + 4*p^2))) + ((3*a^2 + 4*a*b*(1 + p) + 4*b^2*(2 + 3*p + p^2))*cosh(e + f*x)*(a - b + b*cosh(e + f*x)^2)^p*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*cosh(e + f*x)^2)/(a - b))))/((1 + (b*cosh(e + f*x)^2)/(a - b))^p*(b^2*f*(15 + 16*p + 4*p^2))) + (cosh(e + f*x)*(a - b + b*cosh(e + f*x)^2)^(1 + p)*sinh(e + f*x)^2)/(b*f*(5 + 2*p)))]
    @test_int [sinh(e + f*x)^3*(a + b*sinh(e + f*x)^2)^p, x, 4, (cosh(e + f*x)*(a - b + b*cosh(e + f*x)^2)^(1 + p))/(b*f*(3 + 2*p)) - ((a + 2*b*(1 + p))*cosh(e + f*x)*(a - b + b*cosh(e + f*x)^2)^p*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*cosh(e + f*x)^2)/(a - b))))/(b*f*(3 + 2*p)*(1 + (b*cosh(e + f*x)^2)/(a - b))^p)]
    @test_int [sinh(e + f*x)^1*(a + b*sinh(e + f*x)^2)^p, x, 3, (cosh(e + f*x)*(a - b + b*cosh(e + f*x)^2)^p*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*cosh(e + f*x)^2)/(a - b))))/(f*(1 + (b*cosh(e + f*x)^2)/(a - b))^p)]
    ...
    @test_int [cosh(e + f*x)^4*sqrt(a + b*sinh(e + f*x)^2), x, 7, -((2*(a - 3*b)*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(15*b*f)) + (cosh(e + f*x)*sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^(3/2))/(5*b*f) + ((2*a^2 - 7*a*b - 3*b^2)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(15*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((a - 9*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(15*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((2*a^2 - 7*a*b - 3*b^2)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(15*b^2*f)]
    @test_int [cosh(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2), x, 6, (cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - ((a + b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (2*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((a + b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*b*f)]
    @test_int [cosh(e + f*x)^0*sqrt(a + b*sinh(e + f*x)^2), x, 2, ((-im)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt(1 + (b*sinh(e + f*x)^2)/a))]
    @test_int [sech(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2), x, 2, (Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a))]
    @test_int [sech(e + f*x)^4*sqrt(a + b*sinh(e + f*x)^2), x, 5, ((2*a - b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (sech(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*f)]
    ...
    @test_int [cosh(e + f*x)^4*(a + b*sinh(e + f*x)^2)^(3/2), x, 8, ((a^2 + 9*a*b - 2*b^2)*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(35*b*f) + (2*(4*a - b)*cosh(e + f*x)^3*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(35*f) + (b*cosh(e + f*x)^5*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(7*f) + (2*(a + b)*(a^2 - 6*a*b + b^2)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(35*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((a^2 - 18*a*b + b^2)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(35*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (2*(a + b)*(a^2 - 6*a*b + b^2)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(35*b^2*f)]
    @test_int [cosh(e + f*x)^2*(a + b*sinh(e + f*x)^2)^(3/2), x, 7, (2*(3*a - b)*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(15*f) + (b*cosh(e + f*x)^3*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(5*f) - ((3*a^2 + 7*a*b - 2*b^2)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(15*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((9*a - b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(15*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a^2 + 7*a*b - 2*b^2)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(15*b*f)]
    @test_int [cosh(e + f*x)^0*(a + b*sinh(e + f*x)^2)^(3/2), x, 6, (b*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - (((2*im)/3)*(2*a - b)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt(1 + (b*sinh(e + f*x)^2)/a)) + ((im/3)*a*(a - b)*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [sech(e + f*x)^2*(a + b*sinh(e + f*x)^2)^(3/2), x, 6, ((a - 2*b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((a - 2*b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/f + ((a - b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/f]
    @test_int [sech(e + f*x)^4*(a + b*sinh(e + f*x)^2)^(3/2), x, 5, (2*(a + b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((a - b)*sech(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*f)]
    ...
    @test_int [cosh(e + f*x)^4/sqrt(a + b*sinh(e + f*x)^2), x, 6, (cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*b*f) + (2*(a - 2*b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((a - 3*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (2*(a - 2*b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*b^2*f)]
    @test_int [cosh(e + f*x)^2/sqrt(a + b*sinh(e + f*x)^2), x, 5, -((Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a))) + (Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(b*f)]
    @test_int [cosh(e + f*x)^0/sqrt(a + b*sinh(e + f*x)^2), x, 2, ((-im)*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [sech(e + f*x)^2/sqrt(a + b*sinh(e + f*x)^2), x, 7, (Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/((a - b)*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*(a - b)*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a))]
    @test_int [sech(e + f*x)^4/sqrt(a + b*sinh(e + f*x)^2), x, 5, (2*(a - 2*b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((a - 3*b)*b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*(a - b)^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (sech(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*(a - b)*f)]
    ...
    @test_int [cosh(e + f*x)^6/(a + b*sinh(e + f*x)^2)^(3/2), x, 7, -(((a - b)*cosh(e + f*x)^3*sinh(e + f*x))/(a*b*f*sqrt(a + b*sinh(e + f*x)^2))) + ((4*a - 3*b)*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*b^2*f) + ((8*a^2 - 13*a*b + 3*b^2)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*b^3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (2*(2*a - 3*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - ((8*a^2 - 13*a*b + 3*b^2)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*a*b^3*f)]
    @test_int [cosh(e + f*x)^4/(a + b*sinh(e + f*x)^2)^(3/2), x, 6, -(((a - b)*cosh(e + f*x)*sinh(e + f*x))/(a*b*f*sqrt(a + b*sinh(e + f*x)^2))) - ((2*a - b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*b^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*b*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((2*a - b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(a*b^2*f)]
    @test_int [cosh(e + f*x)^2/(a + b*sinh(e + f*x)^2)^(3/2), x, 2, (cosh(e + f*x)*Elliptic.E(atan((sqrt(b)*sinh(e + f*x))/sqrt(a)), 1 - a/b))/(sqrt(a)*sqrt(b)*f*sqrt((a*cosh(e + f*x)^2)/(a + b*sinh(e + f*x)^2))*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [cosh(e + f*x)^0/(a + b*sinh(e + f*x)^2)^(3/2), x, 4, -((b*cosh(e + f*x)*sinh(e + f*x))/(a*(a - b)*f*sqrt(a + b*sinh(e + f*x)^2))) - (im*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(a*(a - b)*f*sqrt(1 + (b*sinh(e + f*x)^2)/a))]
    @test_int [sech(e + f*x)^2/(a + b*sinh(e + f*x)^2)^(3/2), x, 5, (sqrt(b)*(a + b)*cosh(e + f*x)*Elliptic.E(atan((sqrt(b)*sinh(e + f*x))/sqrt(a)), 1 - a/b))/(sqrt(a)*(a - b)^2*f*sqrt((a*cosh(e + f*x)^2)/(a + b*sinh(e + f*x)^2))*sqrt(a + b*sinh(e + f*x)^2)) - (2*b*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*(a - b)^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + tanh(e + f*x)/((a - b)*f*sqrt(a + b*sinh(e + f*x)^2))]
    ...
    @test_int [cosh(e + f*x)^5*(a + b*sinh(e + f*x)^2)^p, x, 5, If(13>=8, -(((3*a - b*(7 + 2*p))*sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^(1 + p))/(b^2*f*(3 + 2*p)*(5 + 2*p))) + (cosh(e + f*x)^2*sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^(1 + p))/(b*f*(5 + 2*p)) + ((3*a^2 - 2*a*b*(5 + 2*p) + b^2*(15 + 16*p + 4*p^2))*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*sinh(e + f*x)^2)/a))*sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^p)/(b^2*f*(3 + 2*p)*(5 + 2*p)*(1 + (b*sinh(e + f*x)^2)/a)^p), -(((3*a - b*(7 + 2*p))*sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^(1 + p))/(b^2*f*(15 + 16*p + 4*p^2))) + (cosh(e + f*x)^2*sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^(1 + p))/(b*f*(5 + 2*p)) + ((3*a^2 - 2*a*b*(5 + 2*p) + b^2*(15 + 16*p + 4*p^2))*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*sinh(e + f*x)^2)/a))*sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^p)/((1 + (b*sinh(e + f*x)^2)/a)^p*(b^2*f*(15 + 16*p + 4*p^2))))]
    @test_int [cosh(e + f*x)^3*(a + b*sinh(e + f*x)^2)^p, x, 4, (sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^(1 + p))/(b*f*(3 + 2*p)) - ((a - b*(3 + 2*p))*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*sinh(e + f*x)^2)/a))*sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^p)/(b*f*(3 + 2*p)*(1 + (b*sinh(e + f*x)^2)/a)^p)]
    @test_int [cosh(e + f*x)^1*(a + b*sinh(e + f*x)^2)^p, x, 3, (HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*sinh(e + f*x)^2)/a))*sinh(e + f*x)*(a + b*sinh(e + f*x)^2)^p)/(f*(1 + (b*sinh(e + f*x)^2)/a)^p)]
    ...
    @test_int [cosh(c + d*x)^5/(a + b*sinh(c + d*x)^n), x, 6, (HypergeometricFunctions._₂F₁(1, 1/n, 1 + 1/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x))/(a*d) + (2*HypergeometricFunctions._₂F₁(1, 3/n, (3 + n)/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x)^3)/(3*a*d) + (HypergeometricFunctions._₂F₁(1, 5/n, (5 + n)/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x)^5)/(5*a*d)]
    @test_int [cosh(c + d*x)^3/(a + b*sinh(c + d*x)^n), x, 5, (HypergeometricFunctions._₂F₁(1, 1/n, 1 + 1/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x))/(a*d) + (HypergeometricFunctions._₂F₁(1, 3/n, (3 + n)/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x)^3)/(3*a*d)]
    @test_int [cosh(c + d*x)^1/(a + b*sinh(c + d*x)^n), x, 2, (HypergeometricFunctions._₂F₁(1, 1/n, 1 + 1/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x))/(a*d)]


    @test_int [cosh(c + d*x)^5/(a + b*sinh(c + d*x)^n)^2, x, 6, (HypergeometricFunctions._₂F₁(2, 1/n, 1 + 1/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x))/(a^2*d) + (2*HypergeometricFunctions._₂F₁(2, 3/n, (3 + n)/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x)^3)/(3*a^2*d) + (HypergeometricFunctions._₂F₁(2, 5/n, (5 + n)/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x)^5)/(5*a^2*d)]
    @test_int [cosh(c + d*x)^3/(a + b*sinh(c + d*x)^n)^2, x, 5, (HypergeometricFunctions._₂F₁(2, 1/n, 1 + 1/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x))/(a^2*d) + (HypergeometricFunctions._₂F₁(2, 3/n, (3 + n)/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x)^3)/(3*a^2*d)]
    @test_int [cosh(c + d*x)^1/(a + b*sinh(c + d*x)^n)^2, x, 2, (HypergeometricFunctions._₂F₁(2, 1/n, 1 + 1/n, -((b*sinh(c + d*x)^n)/a))*sinh(c + d*x))/(a^2*d)]
    ...
    @test_int [sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x)^4, x, 7, -((7*a - 8*b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a - 4*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((7*a - 8*b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*(a - b)*f) - ((3*a - 4*b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*(a - b)*f) - (sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x)^3)/(3*f)]
    @test_int [sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x)^2, x, 6, (-2*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/f]
    @test_int [sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x)^0, x, 2, ((-im)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt(1 + (b*sinh(e + f*x)^2)/a))]
    @test_int [coth(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2), x, 6, -((coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/f) - (2*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((a + b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (2*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/f]
    @test_int [coth(e + f*x)^4*sqrt(a + b*sinh(e + f*x)^2), x, 7, -((3*a + b)*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*f) - (coth(e + f*x)^3*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - ((7*a + b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a + 5*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((7*a + b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*a*f)]
    ...
    @test_int [(a + b*sinh(e + f*x)^2)^(3/2)*tanh(e + f*x)^4, x, 8, -((3*a - 8*b)*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - (8*(a - 2*b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a - 8*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (8*(a - 2*b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*f) + ((a - 2*b)*sinh(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/f - ((a + b*sinh(e + f*x)^2)^(3/2)*tanh(e + f*x)^3)/(3*f)]
    @test_int [(a + b*sinh(e + f*x)^2)^(3/2)*tanh(e + f*x)^2, x, 7, (4*b*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - ((7*a - 8*b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a - 4*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((7*a - 8*b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*f) - ((a + b*sinh(e + f*x)^2)^(3/2)*tanh(e + f*x))/f]
    @test_int [(a + b*sinh(e + f*x)^2)^(3/2)*tanh(e + f*x)^0, x, 6, (b*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - (((2*im)/3)*(2*a - b)*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(f*sqrt(1 + (b*sinh(e + f*x)^2)/a)) + ((im/3)*a*(a - b)*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [coth(e + f*x)^2*(a + b*sinh(e + f*x)^2)^(3/2), x, 7, (4*b*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - (coth(e + f*x)*(a + b*sinh(e + f*x)^2)^(3/2))/f - ((7*a + b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a + 5*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((7*a + b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*f)]
    @test_int [coth(e + f*x)^4*(a + b*sinh(e + f*x)^2)^(3/2), x, 8, -(((a + b)*cosh(e + f*x)^2*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/f) + ((3*a + 5*b)*cosh(e + f*x)*sinh(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f) - (coth(e + f*x)^3*(a + b*sinh(e + f*x)^2)^(3/2))/(3*f) - (8*(a + b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a + b)*(a + 3*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (8*(a + b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*f)]
    ...
    @test_int [tanh(e + f*x)^4/sqrt(a + b*sinh(e + f*x)^2), x, 5, (-2*(2*a - b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a - b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (sech(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*(a - b)*f)]
    @test_int [tanh(e + f*x)^2/sqrt(a + b*sinh(e + f*x)^2), x, 6, -((Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/((a - b)*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a))) + (Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/((a - b)*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a))]
    @test_int [tanh(e + f*x)^0/sqrt(a + b*sinh(e + f*x)^2), x, 2, ((-im)*Elliptic.F(im*e + im*f*x, b/a)*sqrt(1 + (b*sinh(e + f*x)^2)/a))/(f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [coth(e + f*x)^2/sqrt(a + b*sinh(e + f*x)^2), x, 6, -((coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*f)) - (Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(a*f)]
    @test_int [coth(e + f*x)^4/sqrt(a + b*sinh(e + f*x)^2), x, 7, (-2*(2*a - b)*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^2*f) - (coth(e + f*x)*csch(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2))/(3*a*f) - (2*(2*a - b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a - b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (2*(2*a - b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*a^2*f)]
    ...
    @test_int [tanh(e + f*x)^4/(a + b*sinh(e + f*x)^2)^(3/2), x, 6, -(sqrt(a)*sqrt(b)*(7*a + b)*cosh(e + f*x)*Elliptic.E(atan((sqrt(b)*sinh(e + f*x))/sqrt(a)), 1 - a/b))/(3*(a - b)^3*f*sqrt((a*cosh(e + f*x)^2)/(a + b*sinh(e + f*x)^2))*sqrt(a + b*sinh(e + f*x)^2)) + ((3*a + 5*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*(a - b)^3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - (4*a*tanh(e + f*x))/(3*(a - b)^2*f*sqrt(a + b*sinh(e + f*x)^2)) + (sech(e + f*x)^2*tanh(e + f*x))/(3*(a - b)*f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [tanh(e + f*x)^2/(a + b*sinh(e + f*x)^2)^(3/2), x, 5, (-2*sqrt(a)*sqrt(b)*cosh(e + f*x)*Elliptic.E(atan((sqrt(b)*sinh(e + f*x))/sqrt(a)), 1 - a/b))/((a - b)^2*f*sqrt((a*cosh(e + f*x)^2)/(a + b*sinh(e + f*x)^2))*sqrt(a + b*sinh(e + f*x)^2)) + ((a + b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a*(a - b)^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) - tanh(e + f*x)/((a - b)*f*sqrt(a + b*sinh(e + f*x)^2))]
    @test_int [tanh(e + f*x)^0/(a + b*sinh(e + f*x)^2)^(3/2), x, 4, -((b*cosh(e + f*x)*sinh(e + f*x))/(a*(a - b)*f*sqrt(a + b*sinh(e + f*x)^2))) - (im*Elliptic.E(im*e + im*f*x, b/a)*sqrt(a + b*sinh(e + f*x)^2))/(a*(a - b)*f*sqrt(1 + (b*sinh(e + f*x)^2)/a))]
    @test_int [coth(e + f*x)^2/(a + b*sinh(e + f*x)^2)^(3/2), x, 7, coth(e + f*x)/(a*f*sqrt(a + b*sinh(e + f*x)^2)) - (2*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a^2*f) - (2*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(a^2*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + (2*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(a^2*f)]
    @test_int [coth(e + f*x)^4/(a + b*sinh(e + f*x)^2)^(3/2), x, 8, -(((a - b)*coth(e + f*x)*csch(e + f*x)^2)/(a*b*f*sqrt(a + b*sinh(e + f*x)^2))) - ((7*a - 8*b)*coth(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^3*f) + ((3*a - 4*b)*coth(e + f*x)*csch(e + f*x)^2*sqrt(a + b*sinh(e + f*x)^2))/(3*a^2*b*f) - ((7*a - 8*b)*Elliptic.E(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((3*a - 4*b)*Elliptic.F(atan(sinh(e + f*x)), 1 - b/a)*sech(e + f*x)*sqrt(a + b*sinh(e + f*x)^2))/(3*a^3*f*sqrt((sech(e + f*x)^2*(a + b*sinh(e + f*x)^2))/a)) + ((7*a - 8*b)*sqrt(a + b*sinh(e + f*x)^2)*tanh(e + f*x))/(3*a^3*f)]
    ...
    @test_int [(a + b*sinh(c + d*x)^2)^p*tanh(c + d*x)^3, x, 3, -((a - b*(1 + p))*HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, (a + b*sinh(c + d*x)^2)/(a - b))*(a + b*sinh(c + d*x)^2)^(1 + p))/(2*(a - b)^2*d*(1 + p)) + (sech(c + d*x)^2*(a + b*sinh(c + d*x)^2)^(1 + p))/(2*(a - b)*d)]
    @test_int [(a + b*sinh(c + d*x)^2)^p*tanh(c + d*x)^1, x, 2, -(HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, (a + b*sinh(c + d*x)^2)/(a - b))*(a + b*sinh(c + d*x)^2)^(1 + p))/(2*(a - b)*d*(1 + p))]
    @test_int [coth(c + d*x)^1*(a + b*sinh(c + d*x)^2)^p, x, 2, -(HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, 1 + (b*sinh(c + d*x)^2)/a)*(a + b*sinh(c + d*x)^2)^(1 + p))/(2*a*d*(1 + p))]
    @test_int [coth(c + d*x)^3*(a + b*sinh(c + d*x)^2)^p, x, 3, -(csch(c + d*x)^2*(a + b*sinh(c + d*x)^2)^(1 + p))/(2*a*d) - ((a + b*p)*HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, 1 + (b*sinh(c + d*x)^2)/a)*(a + b*sinh(c + d*x)^2)^(1 + p))/(2*a^2*d*(1 + p))]
