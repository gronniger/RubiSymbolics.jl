@testset "6.2.5 Hyperbolic cosine functions" begin
    ...
    @test_int [cosh(a + b*x)^(7/2), x, 3, -((10*im*Elliptic.F((1/2)*im*(a + b*x), 2))/(21*b)) + (10*sqrt(cosh(a + b*x))*sinh(a + b*x))/(21*b) + (2*cosh(a + b*x)^(5/2)*sinh(a + b*x))/(7*b)]
    @test_int [cosh(a + b*x)^(5/2), x, 2, -((6*im*Elliptic.E((1/2)*im*(a + b*x), 2))/(5*b)) + (2*cosh(a + b*x)^(3/2)*sinh(a + b*x))/(5*b)]
    @test_int [cosh(a + b*x)^(3/2), x, 2, -((2*im*Elliptic.F((1/2)*im*(a + b*x), 2))/(3*b)) + (2*sqrt(cosh(a + b*x))*sinh(a + b*x))/(3*b)]
    @test_int [cosh(a + b*x)^(1/2), x, 1, -((2*im*Elliptic.E((1/2)*im*(a + b*x), 2))/b)]
    @test_int [1/cosh(a + b*x)^(1/2), x, 1, -((2*im*Elliptic.F((1/2)*im*(a + b*x), 2))/b)]
    @test_int [1/cosh(a + b*x)^(3/2), x, 2, (2*im*Elliptic.E((1/2)*im*(a + b*x), 2))/b + (2*sinh(a + b*x))/(b*sqrt(cosh(a + b*x)))]
    @test_int [1/cosh(a + b*x)^(5/2), x, 2, -((2*im*Elliptic.F((1/2)*im*(a + b*x), 2))/(3*b)) + (2*sinh(a + b*x))/(3*b*cosh(a + b*x)^(3/2))]
    @test_int [1/cosh(a + b*x)^(7/2), x, 3, (6*im*Elliptic.E((1/2)*im*(a + b*x), 2))/(5*b) + (2*sinh(a + b*x))/(5*b*cosh(a + b*x)^(5/2)) + (6*sinh(a + b*x))/(5*b*sqrt(cosh(a + b*x)))]
    ...
    @test_int [(a*cosh(x))^(7/2), x, 4, -((10*im*a^4*sqrt(cosh(x))*Elliptic.F((im*x)/2, 2))/(21*sqrt(a*cosh(x)))) + (10/21)*a^3*sqrt(a*cosh(x))*sinh(x) + (2/7)*a*(a*cosh(x))^(5/2)*sinh(x)]
    @test_int [(a*cosh(x))^(5/2), x, 3, -((6*im*a^2*sqrt(a*cosh(x))*Elliptic.E((im*x)/2, 2))/(5*sqrt(cosh(x)))) + (2/5)*a*(a*cosh(x))^(3/2)*sinh(x)]
    @test_int [(a*cosh(x))^(3/2),x, 3, -((2*im*a^2*sqrt(cosh(x))*Elliptic.F((im*x)/2, 2))/(3*sqrt(a*cosh(x)))) + (2/3)*a*sqrt(a*cosh(x))*sinh(x)]
    @test_int [(a*cosh(x))^(1/2), x, 2, -((2*im*sqrt(a*cosh(x))*Elliptic.E((im*x)/2, 2))/sqrt(cosh(x)))]
    @test_int [1/(a*cosh(x))^(1/2), x, 2, -((2*im*sqrt(cosh(x))*Elliptic.F((im*x)/2, 2))/sqrt(a*cosh(x)))]
    @test_int [1/(a*cosh(x))^(3/2), x, 3, (2*im*sqrt(a*cosh(x))*Elliptic.E((im*x)/2, 2))/(a^2*sqrt(cosh(x))) + (2*sinh(x))/(a*sqrt(a*cosh(x)))]
    @test_int [1/(a*cosh(x))^(5/2), x, 3, -((2*im*sqrt(cosh(x))*Elliptic.F((im*x)/2, 2))/(3*a^2*sqrt(a*cosh(x)))) + (2*sinh(x))/(3*a*(a*cosh(x))^(3/2))]
    @test_int [1/(a*cosh(x))^(7/2), x, 4, (6*im*sqrt(a*cosh(x))*Elliptic.E((im*x)/2, 2))/(5*a^4*sqrt(cosh(x))) + (2*sinh(x))/(5*a*(a*cosh(x))^(5/2)) + (6*sinh(x))/(5*a^3*sqrt(a*cosh(x)))]
    ...
    @test_int [(b*cosh(c + d*x))^n, x, 1, -(((b*cosh(c + d*x))^(1 + n)*HypergeometricFunctions._₂F₁(1/2, (1 + n)/2, (3 + n)/2, cosh(c + d*x)^2)*sinh(c + d*x))/(b*d*(1 + n)*sqrt(-sinh(c + d*x)^2)))]
    ...
    @test_int [(a + b*cosh(x))^(5/2), x, 7, -((2*im*(23*a^2 + 9*b^2)*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(15*sqrt((a + b*cosh(x))/(a + b)))) + (16*im*a*(a^2 - b^2)*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(15*sqrt(a + b*cosh(x))) + (16/15)*a*b*sqrt(a + b*cosh(x))*sinh(x) + (2/5)*b*(a + b*cosh(x))^(3/2)*sinh(x)]
    @test_int [(a + b*cosh(x))^(3/2), x, 6, -((8*im*a*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(3*sqrt((a + b*cosh(x))/(a + b)))) + (2*im*(a^2 - b^2)*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(3*sqrt(a + b*cosh(x))) + (2/3)*b*sqrt(a + b*cosh(x))*sinh(x)]
    @test_int [(a + b*cosh(c + d*x))^(1/2), x, 2, -((2*im*sqrt(a + b*cosh(c + d*x))*Elliptic.E((1/2)*im*(c + d*x), (2*b)/(a + b)))/(d*sqrt((a + b*cosh(c + d*x))/(a + b))))]
    @test_int [1/(a + b*cosh(x))^(1/2), x, 2, -((2*im*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/sqrt(a + b*cosh(x)))]
    @test_int [1/(a + b*cosh(x))^(3/2), x, 4, -((2*im*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/((a^2 - b^2)*sqrt((a + b*cosh(x))/(a + b)))) - (2*b*sinh(x))/((a^2 - b^2)*sqrt(a + b*cosh(x)))]
    @test_int [1/(a + b*cosh(x))^(5/2), x, 7, -((8*im*a*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(3*(a^2 - b^2)^2*sqrt((a + b*cosh(x))/(a + b)))) + (2*im*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(3*(a^2 - b^2)*sqrt(a + b*cosh(x))) - (2*b*sinh(x))/(3*(a^2 - b^2)*(a + b*cosh(x))^(3/2)) - (8*a*b*sinh(x))/(3*(a^2 - b^2)^2*sqrt(a + b*cosh(x)))]
    @test_int [1/(a + b*cosh(x))^(7/2), x, 8, -((2*im*(23*a^2 + 9*b^2)*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(15*(a^2 - b^2)^3*sqrt((a + b*cosh(x))/(a + b)))) + (16*im*a*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(15*(a^2 - b^2)^2*sqrt(a + b*cosh(x))) - (2*b*sinh(x))/(5*(a^2 - b^2)*(a + b*cosh(x))^(5/2)) - (16*a*b*sinh(x))/(15*(a^2 - b^2)^2*(a + b*cosh(x))^(3/2)) - (2*b*(23*a^2 + 9*b^2)*sinh(x))/(15*(a^2 - b^2)^3*sqrt(a + b*cosh(x)))]


    @test_int [cosh(x)/sqrt(a + b*cosh(x)), x, 5, -((2*im*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(b*sqrt((a + b*cosh(x))/(a + b)))) + (2*im*a*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(b*sqrt(a + b*cosh(x)))]
    ...
    @test_int [(A + B*cosh(x))*(a + b*cosh(x))^(5/2), x, 8, -((2*im*(161*a^2*A*b + 63*A*b^3 + 15*a^3*B + 145*a*b^2*B)*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(105*b*sqrt((a + b*cosh(x))/(a + b)))) + (2*im*(a^2 - b^2)*(56*a*A*b + 15*a^2*B + 25*b^2*B)*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(105*b*sqrt(a + b*cosh(x))) + (2/105)*(56*a*A*b + 15*a^2*B + 25*b^2*B)*sqrt(a + b*cosh(x))*sinh(x) + (2/35)*(7*A*b + 5*a*B)*(a + b*cosh(x))^(3/2)*sinh(x) + (2/7)*B*(a + b*cosh(x))^(5/2)*sinh(x)]
    @test_int [(A + B*cosh(x))*(a + b*cosh(x))^(3/2), x, 7, -((2*im*(20*a*A*b + 3*a^2*B + 9*b^2*B)*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(15*b*sqrt((a + b*cosh(x))/(a + b)))) + (2*im*(a^2 - b^2)*(5*A*b + 3*a*B)*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(15*b*sqrt(a + b*cosh(x))) + (2/15)*(5*A*b + 3*a*B)*sqrt(a + b*cosh(x))*sinh(x) + (2/5)*B*(a + b*cosh(x))^(3/2)*sinh(x)]
    @test_int [(A + B*cosh(x))*(a + b*cosh(x))^(1/2), x, 6, -((2*im*(3*A*b + a*B)*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(3*b*sqrt((a + b*cosh(x))/(a + b)))) + (2*im*(a^2 - b^2)*B*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(3*b*sqrt(a + b*cosh(x))) + (2/3)*B*sqrt(a + b*cosh(x))*sinh(x)]
    ...
    @test_int [(A + B*cosh(x))/(a + b*cosh(x))^(1/2), x, 5, -((2*im*B*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(b*sqrt((a + b*cosh(x))/(a + b)))) - (2*im*(A*b - a*B)*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(b*sqrt(a + b*cosh(x)))]
    @test_int [(A + B*cosh(x))/(a + b*cosh(x))^(3/2), x, 6, -((2*im*(A*b - a*B)*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(b*(a^2 - b^2)*sqrt((a + b*cosh(x))/(a + b)))) - (2*im*B*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(b*sqrt(a + b*cosh(x))) - (2*(A*b - a*B)*sinh(x))/((a^2 - b^2)*sqrt(a + b*cosh(x)))]
    @test_int [(A + B*cosh(x))/(a + b*cosh(x))^(5/2), x, 7, -((2*im*(4*a*A*b - a^2*B - 3*b^2*B)*sqrt(a + b*cosh(x))*Elliptic.E((im*x)/2, (2*b)/(a + b)))/(3*b*(a^2 - b^2)^2*sqrt((a + b*cosh(x))/(a + b)))) + (2*im*(A*b - a*B)*sqrt((a + b*cosh(x))/(a + b))*Elliptic.F((im*x)/2, (2*b)/(a + b)))/(3*b*(a^2 - b^2)*sqrt(a + b*cosh(x))) - (2*(A*b - a*B)*sinh(x))/(3*(a^2 - b^2)*(a + b*cosh(x))^(3/2)) - (2*(4*a*A*b - a^2*B - 3*b^2*B)*sinh(x))/(3*(a^2 - b^2)^2*sqrt(a + b*cosh(x)))]
    ...
    @test_int [(a*cosh(x)^3)^(5/2),x, 6, -((26*im*a^2*sqrt(a*cosh(x)^3)*Elliptic.F((im*x)/2, 2))/(77*cosh(x)^(3/2))) + (78/385)*a^2*cosh(x)*sqrt(a*cosh(x)^3)*sinh(x) + (26/165)*a^2*cosh(x)^3*sqrt(a*cosh(x)^3)*sinh(x) + (2/15)*a^2*cosh(x)^5*sqrt(a*cosh(x)^3)*sinh(x) + (26/77)*a^2*sqrt(a*cosh(x)^3)*tanh(x)]
    @test_int [(a*cosh(x)^3)^(3/2),x, 4, -((14*im*a*sqrt(a*cosh(x)^3)*Elliptic.E((im*x)/2, 2))/(15*cosh(x)^(3/2))) + (14/45)*a*sqrt(a*cosh(x)^3)*sinh(x) + (2/9)*a*cosh(x)^2*sqrt(a*cosh(x)^3)*sinh(x)]
    @test_int [(a*cosh(x)^3)^(1/2), x, 3, -((2*im*sqrt(a*cosh(x)^3)*Elliptic.F((im*x)/2, 2))/(3*cosh(x)^(3/2))) + (2/3)*sqrt(a*cosh(x)^3)*tanh(x)]
    @test_int [1/(a*cosh(x)^3)^(1/2), x, 3, (2*im*cosh(x)^(3/2)*Elliptic.E((im*x)/2, 2))/sqrt(a*cosh(x)^3) + (2*cosh(x)*sinh(x))/sqrt(a*cosh(x)^3)]
    @test_int [1/(a*cosh(x)^3)^(3/2),x, 4, -((10*im*cosh(x)^(3/2)*Elliptic.F((im*x)/2, 2))/(21*a*sqrt(a*cosh(x)^3))) + (10*sinh(x))/(21*a*sqrt(a*cosh(x)^3)) + (2*sech(x)*tanh(x))/(7*a*sqrt(a*cosh(x)^3))]
    @test_int [1/(a*cosh(x)^3)^(5/2),x, 6, (154*im*cosh(x)^(3/2)*Elliptic.E((im*x)/2, 2))/(195*a^2*sqrt(a*cosh(x)^3)) + (154*cosh(x)*sinh(x))/(195*a^2*sqrt(a*cosh(x)^3)) + (154*tanh(x))/(585*a^2*sqrt(a*cosh(x)^3)) + (22*sech(x)^2*tanh(x))/(117*a^2*sqrt(a*cosh(x)^3)) + (2*sech(x)^4*tanh(x))/(13*a^2*sqrt(a*cosh(x)^3))]
    ...
    @test_int [cosh(a + b*log(c*x^n))^(5/2)/x, x, 3, -((6*im*Elliptic.E((1/2)*im*(a + b*log(c*x^n)), 2))/(5*b*n)) + (2*cosh(a + b*log(c*x^n))^(3/2)*sinh(a + b*log(c*x^n)))/(5*b*n)]
    @test_int [cosh(a + b*log(c*x^n))^(3/2)/x, x, 3, -((2*im*Elliptic.F((1/2)*im*(a + b*log(c*x^n)), 2))/(3*b*n)) + (2*sqrt(cosh(a + b*log(c*x^n)))*sinh(a + b*log(c*x^n)))/(3*b*n)]
    @test_int [sqrt(cosh(a + b*log(c*x^n)))/x, x, 2, -((2*im*Elliptic.E((1/2)*im*(a + b*log(c*x^n)), 2))/(b*n))]
    @test_int [1/(x*sqrt(cosh(a + b*log(c*x^n)))), x, 2, -((2*im*Elliptic.F((1/2)*im*(a + b*log(c*x^n)), 2))/(b*n))]
    @test_int [1/(x*cosh(a + b*log(c*x^n))^(3/2)), x, 3, (2*im*Elliptic.E((1/2)*im*(a + b*log(c*x^n)), 2))/(b*n) + (2*sinh(a + b*log(c*x^n)))/(b*n*sqrt(cosh(a + b*log(c*x^n))))]
    @test_int [1/(x*cosh(a + b*log(c*x^n))^(5/2)), x, 3, -((2*im*Elliptic.F((1/2)*im*(a + b*log(c*x^n)), 2))/(3*b*n)) + (2*sinh(a + b*log(c*x^n)))/(3*b*n*cosh(a + b*log(c*x^n))^(3/2))]
    ...
    @test_int [F^(c*(a + b*x))*sech(d + e*x)^1, x, 1, (2*ℯ^(d + e*x)*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, (e + b*c*log(F))/(2*e), (1/2)*(3 + (b*c*log(F))/e), -ℯ^(2*(d + e*x))))/(e + b*c*log(F))]
    @test_int [F^(c*(a + b*x))*sech(d + e*x)^2, x, 1, (4*ℯ^(2*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, 1 + (b*c*log(F))/(2*e), 2 + (b*c*log(F))/(2*e), -ℯ^(2*(d + e*x))))/(2*e + b*c*log(F))]
    @test_int [F^(c*(a + b*x))*sech(d + e*x)^3, x, 2, (ℯ^(d + e*x)*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, (e + b*c*log(F))/(2*e), (1/2)*(3 + (b*c*log(F))/e), -ℯ^(2*(d + e*x)))*(e - b*c*log(F)))/e^2 + (b*c*F^(c*(a + b*x))*log(F)*sech(d + e*x))/(2*e^2) + (F^(c*(a + b*x))*sech(d + e*x)*tanh(d + e*x))/(2*e)]
    @test_int [F^(c*(a + b*x))*sech(d + e*x)^4, x, 2, (2*ℯ^(2*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, 1 + (b*c*log(F))/(2*e), 2 + (b*c*log(F))/(2*e), -ℯ^(2*(d + e*x)))*(2*e - b*c*log(F)))/(3*e^2) + (b*c*F^(c*(a + b*x))*log(F)*sech(d + e*x)^2)/(6*e^2) + (F^(c*(a + b*x))*sech(d + e*x)^2*tanh(d + e*x))/(3*e)]
    ...
    @test_int [f^(a + c*x^2)*cosh(d + e*x), x, 8, If(13>=8, -(ℯ^(-d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(4*sqrt(c)*sqrt(log(f))) + (ℯ^(d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(4*sqrt(c)*sqrt(log(f))), (ℯ^(-d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi(-((e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f))))))/(4*sqrt(c)*sqrt(log(f))) + (ℯ^(d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(4*sqrt(c)*sqrt(log(f))))]
    @test_int [f^(a + c*x^2)*cosh(d + e*x)^2, x, 9, If(13>=8, (f^a*sqrt(pi)*erfi(sqrt(c)*x*sqrt(log(f))))/(4*sqrt(c)*sqrt(log(f))) - (ℯ^(-2*d - e^2/(c*log(f)))*f^a*sqrt(pi)*erfi((e - c*x*log(f))/(sqrt(c)*sqrt(log(f)))))/(8*sqrt(c)*sqrt(log(f))) + (ℯ^(2*d - e^2/(c*log(f)))*f^a*sqrt(pi)*erfi((e + c*x*log(f))/(sqrt(c)*sqrt(log(f)))))/(8*sqrt(c)*sqrt(log(f))), (f^a*sqrt(pi)*erfi(sqrt(c)*x*sqrt(log(f))))/(4*sqrt(c)*sqrt(log(f))) + (ℯ^(-2*d - e^2/(c*log(f)))*f^a*sqrt(pi)*erfi(-((e - c*x*log(f))/(sqrt(c)*sqrt(log(f))))))/(8*sqrt(c)*sqrt(log(f))) + (ℯ^(2*d - e^2/(c*log(f)))*f^a*sqrt(pi)*erfi((e + c*x*log(f))/(sqrt(c)*sqrt(log(f)))))/(8*sqrt(c)*sqrt(log(f))))]
    @test_int [f^(a + c*x^2)*cosh(d + e*x)^3, x, 14, If(13>=8, (-3*ℯ^(-d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) - (ℯ^(-3*d - (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*erfi((3*e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) + (3*ℯ^(d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) + (ℯ^(3*d - (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*erfi((3*e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))), (3*ℯ^(-d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi(-((e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f))))))/(16*sqrt(c)*sqrt(log(f))) + (ℯ^(-3*d - (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*erfi(-((3*e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f))))))/(16*sqrt(c)*sqrt(log(f))) + (3*ℯ^(d - e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) + (ℯ^(3*d - (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*erfi((3*e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))))]
    ...
    @test_int [x^2/cosh(x)^(3/2) + x^2*sqrt(cosh(x)), x, 3, -8*x*sqrt(cosh(x)) - 16*im*Elliptic.E((im*x)/2, 2) + (2*x^2*sinh(x))/sqrt(cosh(x))]
