@testset "1.2.4.2 (d x)^m (a x^q+b x^n+c x^(2 n-q))^p" begin
    (a, b, c, d, e, m, n, q, x, ) = @variables a b c d e m n q x
    ...
    @test_int [x^(3/2)*sqrt(a*x + b*x^3 + c*x^5), x, 5, -((2*(b^2 - 3*a*c)*x^(3/2)*(a + b*x^2 + c*x^4))/(15*c^(3/2)*(sqrt(a) + sqrt(c)*x^2)*sqrt(a*x + b*x^3 + c*x^5))) + (sqrt(x)*(b + 3*c*x^2)*sqrt(a*x + b*x^3 + c*x^5))/(15*c) + (2*a^(1/4)*(b^2 - 3*a*c)*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.E(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(15*c^(7/4)*sqrt(a*x + b*x^3 + c*x^5)) - (a^(1/4)*(2*b^2 + sqrt(a)*b*sqrt(c) - 6*a*c)*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.F(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(30*c^(7/4)*sqrt(a*x + b*x^3 + c*x^5))]
    ...
    @test_int [sqrt(a*x + b*x^3 + c*x^5)/sqrt(x), x, 5, (b*x^(3/2)*(a + b*x^2 + c*x^4))/(3*sqrt(c)*(sqrt(a) + sqrt(c)*x^2)*sqrt(a*x + b*x^3 + c*x^5)) + (1/3)*sqrt(x)*sqrt(a*x + b*x^3 + c*x^5) - (a^(1/4)*b*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.E(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(3*c^(3/4)*sqrt(a*x + b*x^3 + c*x^5)) + (a^(1/4)*(b + 2*sqrt(a)*sqrt(c))*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.F(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(6*c^(3/4)*sqrt(a*x + b*x^3 + c*x^5))]
    ...
    @test_int [sqrt(x)*(a*x + b*x^3 + c*x^5)^(3/2), x, 6, ((8*b^4 - 57*a*b^2*c + 84*a^2*c^2)*x^(3/2)*(a + b*x^2 + c*x^4))/(315*c^(5/2)*(sqrt(a) + sqrt(c)*x^2)*sqrt(a*x + b*x^3 + c*x^5)) - (sqrt(x)*(b*(4*b^2 - 9*a*c) + 6*c*(2*b^2 - 7*a*c)*x^2)*sqrt(a*x + b*x^3 + c*x^5))/(315*c^2) + ((3*b + 7*c*x^2)*(a*x + b*x^3 + c*x^5)^(3/2))/(63*c*sqrt(x)) - (a^(1/4)*(8*b^4 - 57*a*b^2*c + 84*a^2*c^2)*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.E(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(315*c^(11/4)*sqrt(a*x + b*x^3 + c*x^5)) + (a^(1/4)*(8*b^4 - 57*a*b^2*c + 84*a^2*c^2 + 4*sqrt(a)*b*sqrt(c)*(b^2 - 6*a*c))*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.F(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(630*c^(11/4)*sqrt(a*x + b*x^3 + c*x^5))]
    ...
    @test_int [(a*x + b*x^3 + c*x^5)^(3/2)/x^(3/2), x, 6, -((2*b*(b^2 - 8*a*c)*x^(3/2)*(a + b*x^2 + c*x^4))/(35*c^(3/2)*(sqrt(a) + sqrt(c)*x^2)*sqrt(a*x + b*x^3 + c*x^5))) + (sqrt(x)*(b^2 + 10*a*c + 3*b*c*x^2)*sqrt(a*x + b*x^3 + c*x^5))/(35*c) + (a*x + b*x^3 + c*x^5)^(3/2)/(7*sqrt(x)) + (2*a^(1/4)*b*(b^2 - 8*a*c)*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.E(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(35*c^(7/4)*sqrt(a*x + b*x^3 + c*x^5)) - (a^(1/4)*(sqrt(a)*sqrt(c)*(b^2 - 20*a*c) + 2*b*(b^2 - 8*a*c))*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.F(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(70*c^(7/4)*sqrt(a*x + b*x^3 + c*x^5))]
    ...
    @test_int [sqrt(x)/sqrt(a*x + b*x^3 + c*x^5), x, 2, (sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.F(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(2*a^(1/4)*c^(1/4)*sqrt(a*x + b*x^3 + c*x^5))]
    @test_int [1/(sqrt(x)*sqrt(a*x + b*x^3 + c*x^5)), x, 2, -(atanh((sqrt(x)*(2*a + b*x^2))/(2*sqrt(a)*sqrt(a*x + b*x^3 + c*x^5)))/(2*sqrt(a)))]
    @test_int [1/(x^(3/2)*sqrt(a*x + b*x^3 + c*x^5)), x, 6, (sqrt(c)*x^(3/2)*(a + b*x^2 + c*x^4))/(a*(sqrt(a) + sqrt(c)*x^2)*sqrt(a*x + b*x^3 + c*x^5)) - sqrt(a*x + b*x^3 + c*x^5)/(a*x^(3/2)) - (c^(1/4)*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.E(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(a^(3/4)*sqrt(a*x + b*x^3 + c*x^5)) + (c^(1/4)*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.F(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(2*a^(3/4)*sqrt(a*x + b*x^3 + c*x^5))]


    @test_int [x^(3/2)/(a*x + b*x^3 + c*x^5)^(3/2), x, 5, (x^(3/2)*(b^2 - 2*a*c + b*c*x^2))/(a*(b^2 - 4*a*c)*sqrt(a*x + b*x^3 + c*x^5)) - (b*sqrt(c)*x^(3/2)*(a + b*x^2 + c*x^4))/(a*(b^2 - 4*a*c)*(sqrt(a) + sqrt(c)*x^2)*sqrt(a*x + b*x^3 + c*x^5)) + (b*c^(1/4)*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.E(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(a^(3/4)*(b^2 - 4*a*c)*sqrt(a*x + b*x^3 + c*x^5)) - (c^(1/4)*sqrt(x)*(sqrt(a) + sqrt(c)*x^2)*sqrt((a + b*x^2 + c*x^4)/(sqrt(a) + sqrt(c)*x^2)^2)*Elliptic.F(2*atan((c^(1/4)*x)/a^(1/4)), (1/4)*(2 - b/(sqrt(a)*sqrt(c)))))/(2*a^(3/4)*(b - 2*sqrt(a)*sqrt(c))*sqrt(a*x + b*x^3 + c*x^5))]
