@testset "1.2.3.5 P(x) (d x)^m (a+b x^n+c x^(2 n))^p" begin
    @variables A, B, C, D, a, b, c, d, e, f, g, h, j, k, l, m, n, p, x
    ...
    @test_int [1/(a + b*x^n + c*x^(2*n)), x, 3, -((2*c*x*Hypergeometric2F1(1, 1/n, 1 + 1/n, -((2*c*x^n)/(b - sqrt(b^2 - 4*a*c)))))/(b^2 - 4*a*c - b*sqrt(b^2 - 4*a*c))) - (2*c*x*Hypergeometric2F1(1, 1/n, 1 + 1/n, -((2*c*x^n)/(b + sqrt(b^2 - 4*a*c)))))/(b^2 - 4*a*c + b*sqrt(b^2 - 4*a*c))]
    ...
    @test_int [(A + B*x^n + C*x^(2*n) + D*x^(3*n))/(a + b*x^n + c*x^(2*n))^2, x, 4, (x*(A*c*(b^2 - 2*a*c) - a*(b*B*c - 2*a*c*C + a*b*D) + (b*c*(A*c + a*C) - a*b^2*D - 2*a*c*(B*c - a*D))*x^n))/(a*c*(b^2 - 4*a*c)*n*(a + b*x^n + c*x^(2*n))) + ((a*b^2*D - b*c*(A*c + a*C)*(1 - n) + 2*a*c*(B*c*(1 - n) - a*D*(1 + n)) + (A*c^2*(4*a*c*(1 - 2*n) - b^2*(1 - n)) - a*(4*a*c^2*C + b^3*D - b^2*c*C*(1 - n) - 2*b*c*(B*c*n + a*D*(2 + n))))/sqrt(b^2 - 4*a*c))*x*Hypergeometric2F1(1, 1/n, 1 + 1/n, -((2*c*x^n)/(b - sqrt(b^2 - 4*a*c)))))/(a*c*(b^2 - 4*a*c)*(b - sqrt(b^2 - 4*a*c))*n) + ((a*b^2*D - b*c*(A*c + a*C)*(1 - n) + 2*a*c*(B*c*(1 - n) - a*D*(1 + n)) - (A*c^2*(4*a*c*(1 - 2*n) - b^2*(1 - n)) - a*(4*a*c^2*C + b^3*D - b^2*c*C*(1 - n) - 2*b*c*(B*c*n + a*D*(2 + n))))/sqrt(b^2 - 4*a*c))*x*Hypergeometric2F1(1, 1/n, 1 + 1/n, -((2*c*x^n)/(b + sqrt(b^2 - 4*a*c)))))/(a*c*(b^2 - 4*a*c)*(b + sqrt(b^2 - 4*a*c))*n)]
    end
