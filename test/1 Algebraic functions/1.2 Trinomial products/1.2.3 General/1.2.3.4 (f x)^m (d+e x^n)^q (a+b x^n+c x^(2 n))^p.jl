@testset "1.2.3.4 (f x)^m (d+e x^n)^q (a+b x^n+c x^(2 n))^p" begin
    (a, b, c, d, e, f, m, n, p, q, x, ) = @variables a b c d e f m n p q x
    ...
    @test_int [(a + b*x^3 + c*x^6)*(d + e*x^3)^(5/2), x, 6, (54*d^2*(16*c*d^2 - 58*b*d*e + 667*a*e^2)*x*sqrt(d + e*x^3))/(124729*e^2) + (30*d*(16*c*d^2 - 58*b*d*e + 667*a*e^2)*x*(d + e*x^3)^(3/2))/(124729*e^2) + (2*(16*c*d^2 - 58*b*d*e + 667*a*e^2)*x*(d + e*x^3)^(5/2))/(11339*e^2) - (2*(8*c*d - 29*b*e)*x*(d + e*x^3)^(7/2))/(667*e^2) + (2*c*x^4*(d + e*x^3)^(7/2))/(29*e) + (54*3^(3/4)*sqrt(2 + sqrt(3))*d^3*(16*c*d^2 - 58*b*d*e + 667*a*e^2)*(d^(1/3) + e^(1/3)*x)*sqrt((d^(2/3) - d^(1/3)*e^(1/3)*x + e^(2/3)*x^2)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*Elliptic.F(asin(((1 - sqrt(3))*d^(1/3) + e^(1/3)*x)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)), -7 - 4*sqrt(3)))/(124729*e^(7/3)*sqrt((d^(1/3)*(d^(1/3) + e^(1/3)*x))/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*sqrt(d + e*x^3))]
    @test_int [(a + b*x^3 + c*x^6)*(d + e*x^3)^(3/2), x, 5, (18*d*(16*c*d^2 - 46*b*d*e + 391*a*e^2)*x*sqrt(d + e*x^3))/(21505*e^2) + (2*(16*c*d^2 - 46*b*d*e + 391*a*e^2)*x*(d + e*x^3)^(3/2))/(4301*e^2) - (2*(8*c*d - 23*b*e)*x*(d + e*x^3)^(5/2))/(391*e^2) + (2*c*x^4*(d + e*x^3)^(5/2))/(23*e) + (18*3^(3/4)*sqrt(2 + sqrt(3))*d^2*(16*c*d^2 - 46*b*d*e + 391*a*e^2)*(d^(1/3) + e^(1/3)*x)*sqrt((d^(2/3) - d^(1/3)*e^(1/3)*x + e^(2/3)*x^2)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*Elliptic.F(asin(((1 - sqrt(3))*d^(1/3) + e^(1/3)*x)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)), -7 - 4*sqrt(3)))/(21505*e^(7/3)*sqrt((d^(1/3)*(d^(1/3) + e^(1/3)*x))/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*sqrt(d + e*x^3))]
    @test_int [(a + b*x^3 + c*x^6)*(d + e*x^3)^(1/2), x, 4, (2*(16*c*d^2 - 34*b*d*e + 187*a*e^2)*x*sqrt(d + e*x^3))/(935*e^2) - (2*(8*c*d - 17*b*e)*x*(d + e*x^3)^(3/2))/(187*e^2) + (2*c*x^4*(d + e*x^3)^(3/2))/(17*e) + (2*3^(3/4)*sqrt(2 + sqrt(3))*d*(16*c*d^2 - 34*b*d*e + 187*a*e^2)*(d^(1/3) + e^(1/3)*x)*sqrt((d^(2/3) - d^(1/3)*e^(1/3)*x + e^(2/3)*x^2)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*Elliptic.F(asin(((1 - sqrt(3))*d^(1/3) + e^(1/3)*x)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)), -7 - 4*sqrt(3)))/(935*e^(7/3)*sqrt((d^(1/3)*(d^(1/3) + e^(1/3)*x))/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*sqrt(d + e*x^3))]
    @test_int [(a + b*x^3 + c*x^6)/(d + e*x^3)^(1/2), x, 3, -((2*(8*c*d - 11*b*e)*x*sqrt(d + e*x^3))/(55*e^2)) + (2*c*x^4*sqrt(d + e*x^3))/(11*e) + (2*sqrt(2 + sqrt(3))*(16*c*d^2 - 22*b*d*e + 55*a*e^2)*(d^(1/3) + e^(1/3)*x)*sqrt((d^(2/3) - d^(1/3)*e^(1/3)*x + e^(2/3)*x^2)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*Elliptic.F(asin(((1 - sqrt(3))*d^(1/3) + e^(1/3)*x)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)), -7 - 4*sqrt(3)))/(55*3^(1/4)*e^(7/3)*sqrt((d^(1/3)*(d^(1/3) + e^(1/3)*x))/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*sqrt(d + e*x^3))]
    @test_int [(a + b*x^3 + c*x^6)/(d + e*x^3)^(3/2), x, 3, (2*(c*d^2 - b*d*e + a*e^2)*x)/(3*d*e^2*sqrt(d + e*x^3)) + (2*c*x*sqrt(d + e*x^3))/(5*e^2) - (2*sqrt(2 + sqrt(3))*(16*c*d^2 - 5*e*(2*b*d + a*e))*(d^(1/3) + e^(1/3)*x)*sqrt((d^(2/3) - d^(1/3)*e^(1/3)*x + e^(2/3)*x^2)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*Elliptic.F(asin(((1 - sqrt(3))*d^(1/3) + e^(1/3)*x)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)), -7 - 4*sqrt(3)))/(15*3^(1/4)*d*e^(7/3)*sqrt((d^(1/3)*(d^(1/3) + e^(1/3)*x))/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*sqrt(d + e*x^3))]
    @test_int [(a + b*x^3 + c*x^6)/(d + e*x^3)^(5/2), x, 3, (2*(c*d^2 - b*d*e + a*e^2)*x)/(9*d*e^2*(d + e*x^3)^(3/2)) - (2*(11*c*d^2 - 2*b*d*e - 7*a*e^2)*x)/(27*d^2*e^2*sqrt(d + e*x^3)) + (2*sqrt(2 + sqrt(3))*(16*c*d^2 + e*(2*b*d + 7*a*e))*(d^(1/3) + e^(1/3)*x)*sqrt((d^(2/3) - d^(1/3)*e^(1/3)*x + e^(2/3)*x^2)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*Elliptic.F(asin(((1 - sqrt(3))*d^(1/3) + e^(1/3)*x)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)), -7 - 4*sqrt(3)))/(27*3^(1/4)*d^2*e^(7/3)*sqrt((d^(1/3)*(d^(1/3) + e^(1/3)*x))/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*sqrt(d + e*x^3))]
    @test_int [(a + b*x^3 + c*x^6)/(d + e*x^3)^(7/2), x, 4, (2*(c*d^2 - b*d*e + a*e^2)*x)/(15*d*e^2*(d + e*x^3)^(5/2)) - (2*(17*c*d^2 - 2*b*d*e - 13*a*e^2)*x)/(135*d^2*e^2*(d + e*x^3)^(3/2)) + (2*(16*c*d^2 + 14*b*d*e + 91*a*e^2)*x)/(405*d^3*e^2*sqrt(d + e*x^3)) + (2*sqrt(2 + sqrt(3))*(16*c*d^2 + 14*b*d*e + 91*a*e^2)*(d^(1/3) + e^(1/3)*x)*sqrt((d^(2/3) - d^(1/3)*e^(1/3)*x + e^(2/3)*x^2)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*Elliptic.F(asin(((1 - sqrt(3))*d^(1/3) + e^(1/3)*x)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)), -7 - 4*sqrt(3)))/(405*3^(1/4)*d^3*e^(7/3)*sqrt((d^(1/3)*(d^(1/3) + e^(1/3)*x))/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*sqrt(d + e*x^3))]
    @test_int [(a + b*x^3 + c*x^6)/(d + e*x^3)^(9/2), x, 5, (2*(c*d^2 - b*d*e + a*e^2)*x)/(21*d*e^2*(d + e*x^3)^(7/2)) - (2*(23*c*d^2 - 2*b*d*e - 19*a*e^2)*x)/(315*d^2*e^2*(d + e*x^3)^(5/2)) + (2*(16*c*d^2 + 26*b*d*e + 247*a*e^2)*x)/(2835*d^3*e^2*(d + e*x^3)^(3/2)) + (2*(16*c*d^2 + 26*b*d*e + 247*a*e^2)*x)/(1215*d^4*e^2*sqrt(d + e*x^3)) + (2*sqrt(2 + sqrt(3))*(16*c*d^2 + 26*b*d*e + 247*a*e^2)*(d^(1/3) + e^(1/3)*x)*sqrt((d^(2/3) - d^(1/3)*e^(1/3)*x + e^(2/3)*x^2)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*Elliptic.F(asin(((1 - sqrt(3))*d^(1/3) + e^(1/3)*x)/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)), -7 - 4*sqrt(3)))/(1215*3^(1/4)*d^4*e^(7/3)*sqrt((d^(1/3)*(d^(1/3) + e^(1/3)*x))/((1 + sqrt(3))*d^(1/3) + e^(1/3)*x)^2)*sqrt(d + e*x^3))]
    ...
    @test_int [(f*x)^m*(a + c*x^(2*n))^p*(d + e*x^n)^3, x, 13, (d^3*(f*x)^(1 + m)*(a + c*x^(2*n))^p*HypergeometricFunctions._₂F₁((1 + m)/(2*n), -p, 1 + (1 + m)/(2*n), -((c*x^(2*n))/a)))/((1 + (c*x^(2*n))/a)^p*(f*(1 + m))) + (3*d^2*e*x^(1 + n)*(f*x)^m*(a + c*x^(2*n))^p*HypergeometricFunctions._₂F₁((1 + m + n)/(2*n), -p, (1 + m + 3*n)/(2*n), -((c*x^(2*n))/a)))/((1 + (c*x^(2*n))/a)^p*(1 + m + n)) + (3*d*e^2*x^(1 + 2*n)*(f*x)^m*(a + c*x^(2*n))^p*HypergeometricFunctions._₂F₁((1 + m + 2*n)/(2*n), -p, (1 + m + 4*n)/(2*n), -((c*x^(2*n))/a)))/((1 + (c*x^(2*n))/a)^p*(1 + m + 2*n)) + (e^3*x^(1 + 3*n)*(f*x)^m*(a + c*x^(2*n))^p*HypergeometricFunctions._₂F₁((1 + m + 3*n)/(2*n), -p, (1 + m + 5*n)/(2*n), -((c*x^(2*n))/a)))/((1 + (c*x^(2*n))/a)^p*(1 + m + 3*n))]
    @test_int [(f*x)^m*(a + c*x^(2*n))^p*(d + e*x^n)^2, x, 10, (d^2*(f*x)^(1 + m)*(a + c*x^(2*n))^p*HypergeometricFunctions._₂F₁((1 + m)/(2*n), -p, 1 + (1 + m)/(2*n), -((c*x^(2*n))/a)))/((1 + (c*x^(2*n))/a)^p*(f*(1 + m))) + (2*d*e*x^(1 + n)*(f*x)^m*(a + c*x^(2*n))^p*HypergeometricFunctions._₂F₁((1 + m + n)/(2*n), -p, (1 + m + 3*n)/(2*n), -((c*x^(2*n))/a)))/((1 + (c*x^(2*n))/a)^p*(1 + m + n)) + (e^2*x^(1 + 2*n)*(f*x)^m*(a + c*x^(2*n))^p*HypergeometricFunctions._₂F₁((1 + m + 2*n)/(2*n), -p, (1 + m + 4*n)/(2*n), -((c*x^(2*n))/a)))/((1 + (c*x^(2*n))/a)^p*(1 + m + 2*n))]
    @test_int [(f*x)^m*(a + c*x^(2*n))^p*(d + e*x^n)^1, x, 7, (d*(f*x)^(1 + m)*(a + c*x^(2*n))^p*HypergeometricFunctions._₂F₁((1 + m)/(2*n), -p, 1 + (1 + m)/(2*n), -((c*x^(2*n))/a)))/((1 + (c*x^(2*n))/a)^p*(f*(1 + m))) + (e*x^(1 + n)*(f*x)^m*(a + c*x^(2*n))^p*HypergeometricFunctions._₂F₁((1 + m + n)/(2*n), -p, (1 + m + 3*n)/(2*n), -((c*x^(2*n))/a)))/((1 + (c*x^(2*n))/a)^p*(1 + m + n))]
    ...
    @test_int [(f*x)^m*(d + e*x^n)/(a + b*x^n + c*x^(2*n)), x, 4, ((e + (2*c*d - b*e)/sqrt(b^2 - 4*a*c))*(f*x)^(1 + m)*HypergeometricFunctions._₂F₁(1, (1 + m)/n, (1 + m + n)/n, -((2*c*x^n)/(b - sqrt(b^2 - 4*a*c)))))/((b - sqrt(b^2 - 4*a*c))*f*(1 + m)) + ((e - (2*c*d - b*e)/sqrt(b^2 - 4*a*c))*(f*x)^(1 + m)*HypergeometricFunctions._₂F₁(1, (1 + m)/n, (1 + m + n)/n, -((2*c*x^n)/(b + sqrt(b^2 - 4*a*c)))))/((b + sqrt(b^2 - 4*a*c))*f*(1 + m))]


    @test_int [(f*x)^m*(d + e*x^n)/(a + b*x^n + c*x^(2*n))^2, x, 5, ((f*x)^(1 + m)*(b^2*d - 2*a*c*d - a*b*e + c*(b*d - 2*a*e)*x^n))/(a*(b^2 - 4*a*c)*f*n*(a + b*x^n + c*x^(2*n))) - (c*((b*d - 2*a*e)*(1 + m - n) - (4*a*c*d*(1 + m - 2*n) - b^2*d*(1 + m - n) + 2*a*b*e*n)/sqrt(b^2 - 4*a*c))*(f*x)^(1 + m)*HypergeometricFunctions._₂F₁(1, (1 + m)/n, (1 + m + n)/n, -((2*c*x^n)/(b - sqrt(b^2 - 4*a*c)))))/(a*(b^2 - 4*a*c)*(b - sqrt(b^2 - 4*a*c))*f*(1 + m)*n) - (c*((b*d - 2*a*e)*(1 + m - n) + (4*a*c*d*(1 + m - 2*n) - b^2*d*(1 + m - n) + 2*a*b*e*n)/sqrt(b^2 - 4*a*c))*(f*x)^(1 + m)*HypergeometricFunctions._₂F₁(1, (1 + m)/n, (1 + m + n)/n, -((2*c*x^n)/(b + sqrt(b^2 - 4*a*c)))))/(a*(b^2 - 4*a*c)*(b + sqrt(b^2 - 4*a*c))*f*(1 + m)*n)]


    @test_int [(f*x)^m*(d + e*x^n)/(a + b*x^n + c*x^(2*n))^3, x, 6, ((f*x)^(1 + m)*(b^2*d - 2*a*c*d - a*b*e + c*(b*d - 2*a*e)*x^n))/(2*a*(b^2 - 4*a*c)*f*n*(a + b*x^n + c*x^(2*n))^2) + ((f*x)^(1 + m)*((b^2 - 2*a*c)*(a*b*e*(1 + m) + 2*a*c*d*(1 + m - 4*n) - b^2*d*(1 + m - 2*n)) + a*b*c*(b*d - 2*a*e)*(1 + m - 3*n) + c*(a*b^2*e*(1 + m) + 2*a*b*c*d*(2 + 2*m - 7*n) - 4*a^2*c*e*(1 + m - 3*n) - b^3*d*(1 + m - 2*n))*x^n))/(2*a^2*(b^2 - 4*a*c)^2*f*n^2*(a + b*x^n + c*x^(2*n))) - (1/(2*a^2*(b^2 - 4*a*c)^2*(b - sqrt(b^2 - 4*a*c))*f*(1 + m)*n^2))*(c*((a*b^2*e*(1 + m) + 2*a*b*c*d*(2 + 2*m - 7*n) - 4*a^2*c*e*(1 + m - 3*n) - b^3*d*(1 + m - 2*n))*(1 + m - n) + (a*b^3*e*(1 + m)*(1 + m - n) - 4*a^2*b*c*e*(1 + m^2 + m*(2 - n) - n - 3*n^2) - b^4*d*(1 + m^2 + m*(2 - 3*n) - 3*n + 2*n^2) + 6*a*b^2*c*d*(1 + m^2 + m*(2 - 4*n) - 4*n + 3*n^2) - 8*a^2*c^2*d*(1 + m^2 + m*(2 - 6*n) - 6*n + 8*n^2))/sqrt(b^2 - 4*a*c))*(f*x)^(1 + m)*HypergeometricFunctions._₂F₁(1, (1 + m)/n, (1 + m + n)/n, -((2*c*x^n)/(b - sqrt(b^2 - 4*a*c))))) - (1/(2*a^2*(b^2 - 4*a*c)^2*(b + sqrt(b^2 - 4*a*c))*f*(1 + m)*n^2))*(c*((a*b^2*e*(1 + m) + 2*a*b*c*d*(2 + 2*m - 7*n) - 4*a^2*c*e*(1 + m - 3*n) - b^3*d*(1 + m - 2*n))*(1 + m - n) - (a*b^3*e*(1 + m)*(1 + m - n) - 4*a^2*b*c*e*(1 + m^2 + m*(2 - n) - n - 3*n^2) - b^4*d*(1 + m^2 + m*(2 - 3*n) - 3*n + 2*n^2) + 6*a*b^2*c*d*(1 + m^2 + m*(2 - 4*n) - 4*n + 3*n^2) - 8*a^2*c^2*d*(1 + m^2 + m*(2 - 6*n) - 6*n + 8*n^2))/sqrt(b^2 - 4*a*c))*(f*x)^(1 + m)*HypergeometricFunctions._₂F₁(1, (1 + m)/n, (1 + m + n)/n, -((2*c*x^n)/(b + sqrt(b^2 - 4*a*c)))))]
