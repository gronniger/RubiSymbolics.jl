@testset "1.1.4.2 (c x)^m (a x^j+b x^n)^p" begin
    ...
    @test_int [x^3*sqrt(a*x + b*x^3), x, 6, -((20*a^2*sqrt(a*x + b*x^3))/(231*b^2)) + (4*a*x^2*sqrt(a*x + b*x^3))/(77*b) + (2/11)*x^4*sqrt(a*x + b*x^3) + (10*a^(11/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(231*b^(9/4)*sqrt(a*x + b*x^3))]
    @test_int [x^2*sqrt(a*x + b*x^3), x, 7, -((4*a^2*x*(a + b*x^2))/(15*b^(3/2)*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3))) + (4*a*x*sqrt(a*x + b*x^3))/(45*b) + (2/9)*x^3*sqrt(a*x + b*x^3) + (4*a^(9/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(15*b^(7/4)*sqrt(a*x + b*x^3)) - (2*a^(9/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(15*b^(7/4)*sqrt(a*x + b*x^3))]
    @test_int [x*sqrt(a*x + b*x^3), x, 5, (4*a*sqrt(a*x + b*x^3))/(21*b) + (2/7)*x^2*sqrt(a*x + b*x^3) - (2*a^(7/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(21*b^(5/4)*sqrt(a*x + b*x^3))]
    @test_int [sqrt(a*x + b*x^3), x, 6, (4*a*x*(a + b*x^2))/(5*sqrt(b)*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) + (2/5)*x*sqrt(a*x + b*x^3) - (4*a^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*b^(3/4)*sqrt(a*x + b*x^3)) + (2*a^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*b^(3/4)*sqrt(a*x + b*x^3))]
    @test_int [sqrt(a*x + b*x^3)/x, x, 4, (2/3)*sqrt(a*x + b*x^3) + (2*a^(3/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(3*b^(1/4)*sqrt(a*x + b*x^3))]
    @test_int [sqrt(a*x + b*x^3)/x^2, x, 6, (4*sqrt(b)*x*(a + b*x^2))/((sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) - (2*sqrt(a*x + b*x^3))/x - (4*a^(1/4)*b^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/sqrt(a*x + b*x^3) + (2*a^(1/4)*b^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/sqrt(a*x + b*x^3)]
    @test_int [sqrt(a*x + b*x^3)/x^3, x, 4, -((2*sqrt(a*x + b*x^3))/(3*x^2)) + (2*b^(3/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(3*a^(1/4)*sqrt(a*x + b*x^3))]
    @test_int [sqrt(a*x + b*x^3)/x^4, x, 7, (4*b^(3/2)*x*(a + b*x^2))/(5*a*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) - (2*sqrt(a*x + b*x^3))/(5*x^3) - (4*b*sqrt(a*x + b*x^3))/(5*a*x) - (4*b^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*a^(3/4)*sqrt(a*x + b*x^3)) + (2*b^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*a^(3/4)*sqrt(a*x + b*x^3))]


    @test_int [x^2*(a*x + b*x^3)^(3/2), x, 7, -((8*a^3*sqrt(a*x + b*x^3))/(231*b^2)) + (8*a^2*x^2*sqrt(a*x + b*x^3))/(385*b) + (4/55)*a*x^4*sqrt(a*x + b*x^3) + (2/15)*x^3*(a*x + b*x^3)^(3/2) + (4*a^(15/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(231*b^(9/4)*sqrt(a*x + b*x^3))]
    @test_int [x*(a*x + b*x^3)^(3/2), x, 8, -((8*a^3*x*(a + b*x^2))/(65*b^(3/2)*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3))) + (8*a^2*x*sqrt(a*x + b*x^3))/(195*b) + (4/39)*a*x^3*sqrt(a*x + b*x^3) + (2/13)*x^2*(a*x + b*x^3)^(3/2) + (8*a^(13/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(65*b^(7/4)*sqrt(a*x + b*x^3)) - (4*a^(13/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(65*b^(7/4)*sqrt(a*x + b*x^3))]
    @test_int [(a*x + b*x^3)^(3/2), x, 6, (8*a^2*sqrt(a*x + b*x^3))/(77*b) + (12/77)*a*x^2*sqrt(a*x + b*x^3) + (2/11)*x*(a*x + b*x^3)^(3/2) - (4*a^(11/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(77*b^(5/4)*sqrt(a*x + b*x^3))]
    @test_int [(a*x + b*x^3)^(3/2)/x, x, 7, (8*a^2*x*(a + b*x^2))/(15*sqrt(b)*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) + (4/15)*a*x*sqrt(a*x + b*x^3) + (2/9)*(a*x + b*x^3)^(3/2) - (8*a^(9/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(15*b^(3/4)*sqrt(a*x + b*x^3)) + (4*a^(9/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(15*b^(3/4)*sqrt(a*x + b*x^3))]
    @test_int [(a*x + b*x^3)^(3/2)/x^2, x, 5, (4/7)*a*sqrt(a*x + b*x^3) + (2*(a*x + b*x^3)^(3/2))/(7*x) + (4*a^(7/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(7*b^(1/4)*sqrt(a*x + b*x^3))]
    @test_int [(a*x + b*x^3)^(3/2)/x^3, x, 7, (24*a*sqrt(b)*x*(a + b*x^2))/(5*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) + (12/5)*b*x*sqrt(a*x + b*x^3) - (2*(a*x + b*x^3)^(3/2))/x^2 - (24*a^(5/4)*b^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*sqrt(a*x + b*x^3)) + (12*a^(5/4)*b^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*sqrt(a*x + b*x^3))]
    @test_int [(a*x + b*x^3)^(3/2)/x^4, x, 5, (4/3)*b*sqrt(a*x + b*x^3) - (2*(a*x + b*x^3)^(3/2))/(3*x^3) + (4*a^(3/4)*b^(3/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(3*sqrt(a*x + b*x^3))]
    @test_int [(a*x + b*x^3)^(3/2)/x^5, x, 7, (24*b^(3/2)*x*(a + b*x^2))/(5*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) - (12*b*sqrt(a*x + b*x^3))/(5*x) - (2*(a*x + b*x^3)^(3/2))/(5*x^4) - (24*a^(1/4)*b^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*sqrt(a*x + b*x^3)) + (12*a^(1/4)*b^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*sqrt(a*x + b*x^3))]
    @test_int [(a*x + b*x^3)^(3/2)/x^6, x, 5, -((4*b*sqrt(a*x + b*x^3))/(7*x^2)) - (2*(a*x + b*x^3)^(3/2))/(7*x^5) + (4*b^(7/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(7*a^(1/4)*sqrt(a*x + b*x^3))]
    @test_int [(a*x + b*x^3)^(3/2)/x^7, x, 8, (8*b^(5/2)*x*(a + b*x^2))/(15*a*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) - (4*b*sqrt(a*x + b*x^3))/(15*x^3) - (8*b^2*sqrt(a*x + b*x^3))/(15*a*x) - (2*(a*x + b*x^3)^(3/2))/(9*x^6) - (8*b^(9/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(15*a^(3/4)*sqrt(a*x + b*x^3)) + (4*b^(9/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(15*a^(3/4)*sqrt(a*x + b*x^3))]
    @test_int [(a*x + b*x^3)^(3/2)/x^8, x, 6, -((12*b*sqrt(a*x + b*x^3))/(77*x^4)) - (8*b^2*sqrt(a*x + b*x^3))/(77*a*x^2) - (2*(a*x + b*x^3)^(3/2))/(11*x^7) - (4*b^(11/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(77*a^(5/4)*sqrt(a*x + b*x^3))]
    ...
    @test_int [x^4/sqrt(a*x + b*x^3), x, 5, -((10*a*sqrt(a*x + b*x^3))/(21*b^2)) + (2*x^2*sqrt(a*x + b*x^3))/(7*b) + (5*a^(7/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(21*b^(9/4)*sqrt(a*x + b*x^3))]
    @test_int [x^3/sqrt(a*x + b*x^3), x, 6, -((6*a*x*(a + b*x^2))/(5*b^(3/2)*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3))) + (2*x*sqrt(a*x + b*x^3))/(5*b) + (6*a^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*b^(7/4)*sqrt(a*x + b*x^3)) - (3*a^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*b^(7/4)*sqrt(a*x + b*x^3))]
    @test_int [x^2/sqrt(a*x + b*x^3), x, 4, (2*sqrt(a*x + b*x^3))/(3*b) - (a^(3/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(3*b^(5/4)*sqrt(a*x + b*x^3))]
    @test_int [x/sqrt(a*x + b*x^3), x, 5, (2*x*(a + b*x^2))/(sqrt(b)*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) - (2*a^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(b^(3/4)*sqrt(a*x + b*x^3)) + (a^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(b^(3/4)*sqrt(a*x + b*x^3))]
    @test_int [1/sqrt(a*x + b*x^3), x, 3, (sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(a^(1/4)*b^(1/4)*sqrt(a*x + b*x^3))]
    @test_int [1/(x*sqrt(a*x + b*x^3)), x, 6, (2*sqrt(b)*x*(a + b*x^2))/(a*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) - (2*sqrt(a*x + b*x^3))/(a*x) - (2*b^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(a^(3/4)*sqrt(a*x + b*x^3)) + (b^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(a^(3/4)*sqrt(a*x + b*x^3))]
    @test_int [1/(x^2*sqrt(a*x + b*x^3)), x, 4, -((2*sqrt(a*x + b*x^3))/(3*a*x^2)) - (b^(3/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(3*a^(5/4)*sqrt(a*x + b*x^3))]
    @test_int [1/(x^3*sqrt(a*x + b*x^3)), x, 7, -((6*b^(3/2)*x*(a + b*x^2))/(5*a^2*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3))) - (2*sqrt(a*x + b*x^3))/(5*a*x^3) + (6*b*sqrt(a*x + b*x^3))/(5*a^2*x) + (6*b^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*a^(7/4)*sqrt(a*x + b*x^3)) - (3*b^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*a^(7/4)*sqrt(a*x + b*x^3))]


    @test_int [x^7/(a*x + b*x^3)^(3/2), x, 6, -(x^5/(b*sqrt(a*x + b*x^3))) - (15*a*sqrt(a*x + b*x^3))/(7*b^3) + (9*x^2*sqrt(a*x + b*x^3))/(7*b^2) + (15*a^(7/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(14*b^(13/4)*sqrt(a*x + b*x^3))]
    @test_int [x^6/(a*x + b*x^3)^(3/2), x, 7, -(x^4/(b*sqrt(a*x + b*x^3))) - (21*a*x*(a + b*x^2))/(5*b^(5/2)*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) + (7*x*sqrt(a*x + b*x^3))/(5*b^2) + (21*a^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*b^(11/4)*sqrt(a*x + b*x^3)) - (21*a^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(10*b^(11/4)*sqrt(a*x + b*x^3))]
    @test_int [x^5/(a*x + b*x^3)^(3/2), x, 5, -(x^3/(b*sqrt(a*x + b*x^3))) + (5*sqrt(a*x + b*x^3))/(3*b^2) - (5*a^(3/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(6*b^(9/4)*sqrt(a*x + b*x^3))]
    @test_int [x^4/(a*x + b*x^3)^(3/2), x, 6, -(x^2/(b*sqrt(a*x + b*x^3))) + (3*x*(a + b*x^2))/(b^(3/2)*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) - (3*a^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(b^(7/4)*sqrt(a*x + b*x^3)) + (3*a^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(2*b^(7/4)*sqrt(a*x + b*x^3))]
    @test_int [x^3/(a*x + b*x^3)^(3/2), x, 4, -(x/(b*sqrt(a*x + b*x^3))) + (sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(2*a^(1/4)*b^(5/4)*sqrt(a*x + b*x^3))]
    @test_int [x^2/(a*x + b*x^3)^(3/2), x, 6, x^2/(a*sqrt(a*x + b*x^3)) - (x*(a + b*x^2))/(a*sqrt(b)*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) + (sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(a^(3/4)*b^(3/4)*sqrt(a*x + b*x^3)) - (sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(2*a^(3/4)*b^(3/4)*sqrt(a*x + b*x^3))]
    @test_int [x/(a*x + b*x^3)^(3/2), x, 4, x/(a*sqrt(a*x + b*x^3)) + (sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(2*a^(5/4)*b^(1/4)*sqrt(a*x + b*x^3))]
    @test_int [1/(a*x + b*x^3)^(3/2), x, 7, 1/(a*sqrt(a*x + b*x^3)) + (3*sqrt(b)*x*(a + b*x^2))/(a^2*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) - (3*sqrt(a*x + b*x^3))/(a^2*x) - (3*b^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(a^(7/4)*sqrt(a*x + b*x^3)) + (3*b^(1/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(2*a^(7/4)*sqrt(a*x + b*x^3))]
    @test_int [1/(x*(a*x + b*x^3)^(3/2)), x, 5, 1/(a*x*sqrt(a*x + b*x^3)) - (5*sqrt(a*x + b*x^3))/(3*a^2*x^2) - (5*b^(3/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(6*a^(9/4)*sqrt(a*x + b*x^3))]
    @test_int [1/(x^2*(a*x + b*x^3)^(3/2)), x, 8, 1/(a*x^2*sqrt(a*x + b*x^3)) - (21*b^(3/2)*x*(a + b*x^2))/(5*a^3*(sqrt(a) + sqrt(b)*x)*sqrt(a*x + b*x^3)) - (7*sqrt(a*x + b*x^3))/(5*a^2*x^3) + (21*b*sqrt(a*x + b*x^3))/(5*a^3*x) + (21*b^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticE(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(5*a^(11/4)*sqrt(a*x + b*x^3)) - (21*b^(5/4)*sqrt(x)*(sqrt(a) + sqrt(b)*x)*sqrt((a + b*x^2)/(sqrt(a) + sqrt(b)*x)^2)*EllipticF(2*atan((b^(1/4)*sqrt(x))/a^(1/4)), 1/2))/(10*a^(11/4)*sqrt(a*x + b*x^3))]
    ...
    @test_int [x^3/sqrt(a*x + b*x^4), x, 4, sqrt(a*x + b*x^4)/(2*b) - (a^(2/3)*x*(a^(1/3) + b^(1/3)*x)*sqrt((a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*EllipticF(acos((a^(1/3) + (1 - sqrt(3))*b^(1/3)*x)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)), (1/4)*(2 + sqrt(3))))/(4*3^(1/4)*b*sqrt((b^(1/3)*x*(a^(1/3) + b^(1/3)*x))/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*sqrt(a*x + b*x^4))]
    @test_int [x^0/sqrt(a*x + b*x^4), x, 3, (x*(a^(1/3) + b^(1/3)*x)*sqrt((a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*EllipticF(acos((a^(1/3) + (1 - sqrt(3))*b^(1/3)*x)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)), (1/4)*(2 + sqrt(3))))/(3^(1/4)*a^(1/3)*sqrt((b^(1/3)*x*(a^(1/3) + b^(1/3)*x))/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*sqrt(a*x + b*x^4))]
    @test_int [1/(x^3*sqrt(a*x + b*x^4)), x, 4, -((2*sqrt(a*x + b*x^4))/(5*a*x^3)) - (2*b*x*(a^(1/3) + b^(1/3)*x)*sqrt((a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*EllipticF(acos((a^(1/3) + (1 - sqrt(3))*b^(1/3)*x)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)), (1/4)*(2 + sqrt(3))))/(5*3^(1/4)*a^(4/3)*sqrt((b^(1/3)*x*(a^(1/3) + b^(1/3)*x))/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*sqrt(a*x + b*x^4))]

    @test_int [x^5/sqrt(a*x + b*x^4), x, 6, -((5*(1 + sqrt(3))*a*x*(a + b*x^3))/(8*b^(5/3)*(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)*sqrt(a*x + b*x^4))) + (x^2*sqrt(a*x + b*x^4))/(4*b) + (5*3^(1/4)*a^(4/3)*x*(a^(1/3) + b^(1/3)*x)*sqrt((a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*EllipticE(acos((a^(1/3) + (1 - sqrt(3))*b^(1/3)*x)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)), (1/4)*(2 + sqrt(3))))/(8*b^(5/3)*sqrt((b^(1/3)*x*(a^(1/3) + b^(1/3)*x))/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*sqrt(a*x + b*x^4)) + (5*(1 - sqrt(3))*a^(4/3)*x*(a^(1/3) + b^(1/3)*x)*sqrt((a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*EllipticF(acos((a^(1/3) + (1 - sqrt(3))*b^(1/3)*x)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)), (1/4)*(2 + sqrt(3))))/(16*3^(1/4)*b^(5/3)*sqrt((b^(1/3)*x*(a^(1/3) + b^(1/3)*x))/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*sqrt(a*x + b*x^4))]
    ...
    @test_int [x^3*sqrt(b*x^(1/3) + a*x), x, 11, -((884*b^6*sqrt(b*x^(1/3) + a*x))/(14421*a^6)) + (884*b^5*x^(2/3)*sqrt(b*x^(1/3) + a*x))/(24035*a^5) - (6188*b^4*x^(4/3)*sqrt(b*x^(1/3) + a*x))/(216315*a^4) + (476*b^3*x^2*sqrt(b*x^(1/3) + a*x))/(19665*a^3) - (28*b^2*x^(8/3)*sqrt(b*x^(1/3) + a*x))/(1311*a^2) + (4*b*x^(10/3)*sqrt(b*x^(1/3) + a*x))/(207*a) + (2/9)*x^4*sqrt(b*x^(1/3) + a*x) + (442*b^(27/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(14421*a^(25/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^2*sqrt(b*x^(1/3) + a*x), x, 11, (44*b^5*(b + a*x^(2/3))*x^(1/3))/(221*a^(9/2)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x)) - (44*b^4*x^(1/3)*sqrt(b*x^(1/3) + a*x))/(663*a^4) + (220*b^3*x*sqrt(b*x^(1/3) + a*x))/(4641*a^3) - (60*b^2*x^(5/3)*sqrt(b*x^(1/3) + a*x))/(1547*a^2) + (4*b*x^(7/3)*sqrt(b*x^(1/3) + a*x))/(119*a) + (2/7)*x^3*sqrt(b*x^(1/3) + a*x) - (44*b^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(221*a^(19/4)*sqrt(b*x^(1/3) + a*x)) + (22*b^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(221*a^(19/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^1*sqrt(b*x^(1/3) + a*x), x, 8, (12*b^3*sqrt(b*x^(1/3) + a*x))/(77*a^3) - (36*b^2*x^(2/3)*sqrt(b*x^(1/3) + a*x))/(385*a^2) + (4*b*x^(4/3)*sqrt(b*x^(1/3) + a*x))/(55*a) + (2/5)*x^2*sqrt(b*x^(1/3) + a*x) - (6*b^(15/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(77*a^(13/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^0*sqrt(b*x^(1/3) + a*x), x, 8, -((4*b^2*(b + a*x^(2/3))*x^(1/3))/(5*a^(3/2)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x))) + (4*b*x^(1/3)*sqrt(b*x^(1/3) + a*x))/(15*a) + (2/3)*x*sqrt(b*x^(1/3) + a*x) + (4*b^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*a^(7/4)*sqrt(b*x^(1/3) + a*x)) - (2*b^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*a^(7/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [sqrt(b*x^(1/3) + a*x)/x^1, x, 5, 2*sqrt(b*x^(1/3) + a*x) + (2*b^(3/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(a^(1/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [sqrt(b*x^(1/3) + a*x)/x^2, x, 8, (12*a^(3/2)*(b + a*x^(2/3))*x^(1/3))/(5*b*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x)) - (6*sqrt(b*x^(1/3) + a*x))/(5*x) - (12*a*sqrt(b*x^(1/3) + a*x))/(5*b*x^(1/3)) - (12*a^(5/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*b^(3/4)*sqrt(b*x^(1/3) + a*x)) + (6*a^(5/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*b^(3/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [sqrt(b*x^(1/3) + a*x)/x^3, x, 7, -((6*sqrt(b*x^(1/3) + a*x))/(11*x^2)) - (12*a*sqrt(b*x^(1/3) + a*x))/(77*b*x^(4/3)) + (20*a^2*sqrt(b*x^(1/3) + a*x))/(77*b^2*x^(2/3)) + (10*a^(11/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(77*b^(9/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [sqrt(b*x^(1/3) + a*x)/x^4, x, 11, -((308*a^(9/2)*(b + a*x^(2/3))*x^(1/3))/(1105*b^4*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x))) - (6*sqrt(b*x^(1/3) + a*x))/(17*x^3) - (12*a*sqrt(b*x^(1/3) + a*x))/(221*b*x^(7/3)) + (44*a^2*sqrt(b*x^(1/3) + a*x))/(663*b^2*x^(5/3)) - (308*a^3*sqrt(b*x^(1/3) + a*x))/(3315*b^3*x) + (308*a^4*sqrt(b*x^(1/3) + a*x))/(1105*b^4*x^(1/3)) + (308*a^(17/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(1105*b^(15/4)*sqrt(b*x^(1/3) + a*x)) - (154*a^(17/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(1105*b^(15/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [sqrt(b*x^(1/3) + a*x)/x^5, x, 10, -((6*sqrt(b*x^(1/3) + a*x))/(23*x^4)) - (12*a*sqrt(b*x^(1/3) + a*x))/(437*b*x^(10/3)) + (68*a^2*sqrt(b*x^(1/3) + a*x))/(2185*b^2*x^(8/3)) - (884*a^3*sqrt(b*x^(1/3) + a*x))/(24035*b^3*x^2) + (7956*a^4*sqrt(b*x^(1/3) + a*x))/(168245*b^4*x^(4/3)) - (2652*a^5*sqrt(b*x^(1/3) + a*x))/(33649*b^5*x^(2/3)) - (1326*a^(23/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(33649*b^(21/4)*sqrt(b*x^(1/3) + a*x))]


    @test_int [x^2*(b*x^(1/3) + a*x)^(3/2), x, 11, (1768*b^6*sqrt(b*x^(1/3) + a*x))/(100947*a^5) - (1768*b^5*x^(2/3)*sqrt(b*x^(1/3) + a*x))/(168245*a^4) + (1768*b^4*x^(4/3)*sqrt(b*x^(1/3) + a*x))/(216315*a^3) - (136*b^3*x^2*sqrt(b*x^(1/3) + a*x))/(19665*a^2) + (8*b^2*x^(8/3)*sqrt(b*x^(1/3) + a*x))/(1311*a) + (4/69)*b*x^(10/3)*sqrt(b*x^(1/3) + a*x) + (2/9)*x^3*(b*x^(1/3) + a*x)^(3/2) - (884*b^(27/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(100947*a^(21/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^1*(b*x^(1/3) + a*x)^(3/2), x, 11, -((88*b^5*(b + a*x^(2/3))*x^(1/3))/(1105*a^(7/2)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x))) + (88*b^4*x^(1/3)*sqrt(b*x^(1/3) + a*x))/(3315*a^3) - (88*b^3*x*sqrt(b*x^(1/3) + a*x))/(4641*a^2) + (24*b^2*x^(5/3)*sqrt(b*x^(1/3) + a*x))/(1547*a) + (12/119)*b*x^(7/3)*sqrt(b*x^(1/3) + a*x) + (2/7)*x^2*(b*x^(1/3) + a*x)^(3/2) + (88*b^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(1105*a^(15/4)*sqrt(b*x^(1/3) + a*x)) - (44*b^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(1105*a^(15/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^0*(b*x^(1/3) + a*x)^(3/2), x, 8, -((8*b^3*sqrt(b*x^(1/3) + a*x))/(77*a^2)) + (24*b^2*x^(2/3)*sqrt(b*x^(1/3) + a*x))/(385*a) + (12/55)*b*x^(4/3)*sqrt(b*x^(1/3) + a*x) + (2/5)*x*(b*x^(1/3) + a*x)^(3/2) + (4*b^(15/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(77*a^(9/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [(b*x^(1/3) + a*x)^(3/2)/x^1, x, 8, (8*b^2*(b + a*x^(2/3))*x^(1/3))/(5*sqrt(a)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x)) + (4/5)*b*x^(1/3)*sqrt(b*x^(1/3) + a*x) + (2/3)*(b*x^(1/3) + a*x)^(3/2) - (8*b^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*a^(3/4)*sqrt(b*x^(1/3) + a*x)) + (4*b^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*a^(3/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [(b*x^(1/3) + a*x)^(3/2)/x^2, x, 6, 4*a*sqrt(b*x^(1/3) + a*x) - (2*(b*x^(1/3) + a*x)^(3/2))/x + (4*a^(3/4)*b^(3/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/sqrt(b*x^(1/3) + a*x)]
    @test_int [(b*x^(1/3) + a*x)^(3/2)/x^3, x, 9, (8*a^(5/2)*(b + a*x^(2/3))*x^(1/3))/(5*b*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x)) - (4*a*sqrt(b*x^(1/3) + a*x))/(5*x) - (8*a^2*sqrt(b*x^(1/3) + a*x))/(5*b*x^(1/3)) - (2*(b*x^(1/3) + a*x)^(3/2))/(3*x^2) - (8*a^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*b^(3/4)*sqrt(b*x^(1/3) + a*x)) + (4*a^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*b^(3/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [(b*x^(1/3) + a*x)^(3/2)/x^4, x, 8, -((12*a*sqrt(b*x^(1/3) + a*x))/(55*x^2)) - (24*a^2*sqrt(b*x^(1/3) + a*x))/(385*b*x^(4/3)) + (8*a^3*sqrt(b*x^(1/3) + a*x))/(77*b^2*x^(2/3)) - (2*(b*x^(1/3) + a*x)^(3/2))/(5*x^3) + (4*a^(15/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(77*b^(9/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [(b*x^(1/3) + a*x)^(3/2)/x^5, x, 12, -((88*a^(11/2)*(b + a*x^(2/3))*x^(1/3))/(1105*b^4*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x))) - (12*a*sqrt(b*x^(1/3) + a*x))/(119*x^3) - (24*a^2*sqrt(b*x^(1/3) + a*x))/(1547*b*x^(7/3)) + (88*a^3*sqrt(b*x^(1/3) + a*x))/(4641*b^2*x^(5/3)) - (88*a^4*sqrt(b*x^(1/3) + a*x))/(3315*b^3*x) + (88*a^5*sqrt(b*x^(1/3) + a*x))/(1105*b^4*x^(1/3)) - (2*(b*x^(1/3) + a*x)^(3/2))/(7*x^4) + (88*a^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(1105*b^(15/4)*sqrt(b*x^(1/3) + a*x)) - (44*a^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(1105*b^(15/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [(b*x^(1/3) + a*x)^(3/2)/x^6, x, 11, -((4*a*sqrt(b*x^(1/3) + a*x))/(69*x^4)) - (8*a^2*sqrt(b*x^(1/3) + a*x))/(1311*b*x^(10/3)) + (136*a^3*sqrt(b*x^(1/3) + a*x))/(19665*b^2*x^(8/3)) - (1768*a^4*sqrt(b*x^(1/3) + a*x))/(216315*b^3*x^2) + (1768*a^5*sqrt(b*x^(1/3) + a*x))/(168245*b^4*x^(4/3)) - (1768*a^6*sqrt(b*x^(1/3) + a*x))/(100947*b^5*x^(2/3)) - (2*(b*x^(1/3) + a*x)^(3/2))/(9*x^5) - (884*a^(27/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(100947*b^(21/4)*sqrt(b*x^(1/3) + a*x))]
    ...
    @test_int [x^4/sqrt(b*x^(1/3) + a*x), x, 11, (11050*b^6*sqrt(b*x^(1/3) + a*x))/(14421*a^7) - (2210*b^5*x^(2/3)*sqrt(b*x^(1/3) + a*x))/(4807*a^6) + (15470*b^4*x^(4/3)*sqrt(b*x^(1/3) + a*x))/(43263*a^5) - (1190*b^3*x^2*sqrt(b*x^(1/3) + a*x))/(3933*a^4) + (350*b^2*x^(8/3)*sqrt(b*x^(1/3) + a*x))/(1311*a^3) - (50*b*x^(10/3)*sqrt(b*x^(1/3) + a*x))/(207*a^2) + (2*x^4*sqrt(b*x^(1/3) + a*x))/(9*a) - (5525*b^(27/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(14421*a^(29/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^3/sqrt(b*x^(1/3) + a*x), x, 11, -((418*b^5*(b + a*x^(2/3))*x^(1/3))/(221*a^(11/2)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x))) + (418*b^4*x^(1/3)*sqrt(b*x^(1/3) + a*x))/(663*a^5) - (2090*b^3*x*sqrt(b*x^(1/3) + a*x))/(4641*a^4) + (570*b^2*x^(5/3)*sqrt(b*x^(1/3) + a*x))/(1547*a^3) - (38*b*x^(7/3)*sqrt(b*x^(1/3) + a*x))/(119*a^2) + (2*x^3*sqrt(b*x^(1/3) + a*x))/(7*a) + (418*b^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(221*a^(23/4)*sqrt(b*x^(1/3) + a*x)) - (209*b^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(221*a^(23/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^2/sqrt(b*x^(1/3) + a*x), x, 8, -((78*b^3*sqrt(b*x^(1/3) + a*x))/(77*a^4)) + (234*b^2*x^(2/3)*sqrt(b*x^(1/3) + a*x))/(385*a^3) - (26*b*x^(4/3)*sqrt(b*x^(1/3) + a*x))/(55*a^2) + (2*x^2*sqrt(b*x^(1/3) + a*x))/(5*a) + (39*b^(15/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(77*a^(17/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^1/sqrt(b*x^(1/3) + a*x), x, 8, (14*b^2*(b + a*x^(2/3))*x^(1/3))/(5*a^(5/2)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x)) - (14*b*x^(1/3)*sqrt(b*x^(1/3) + a*x))/(15*a^2) + (2*x*sqrt(b*x^(1/3) + a*x))/(3*a) - (14*b^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*a^(11/4)*sqrt(b*x^(1/3) + a*x)) + (7*b^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*a^(11/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^0/sqrt(b*x^(1/3) + a*x), x, 5, (2*sqrt(b*x^(1/3) + a*x))/a - (b^(3/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(a^(5/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [1/(x^1*sqrt(b*x^(1/3) + a*x)), x, 7, (6*sqrt(a)*(b + a*x^(2/3))*x^(1/3))/(b*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x)) - (6*sqrt(b*x^(1/3) + a*x))/(b*x^(1/3)) - (6*a^(1/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(b^(3/4)*sqrt(b*x^(1/3) + a*x)) + (3*a^(1/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(b^(3/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [1/(x^2*sqrt(b*x^(1/3) + a*x)), x, 6, -((6*sqrt(b*x^(1/3) + a*x))/(7*b*x^(4/3))) + (10*a*sqrt(b*x^(1/3) + a*x))/(7*b^2*x^(2/3)) + (5*a^(7/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(7*b^(9/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [1/(x^3*sqrt(b*x^(1/3) + a*x)), x, 10, -((154*a^(7/2)*(b + a*x^(2/3))*x^(1/3))/(65*b^4*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x))) - (6*sqrt(b*x^(1/3) + a*x))/(13*b*x^(7/3)) + (22*a*sqrt(b*x^(1/3) + a*x))/(39*b^2*x^(5/3)) - (154*a^2*sqrt(b*x^(1/3) + a*x))/(195*b^3*x) + (154*a^3*sqrt(b*x^(1/3) + a*x))/(65*b^4*x^(1/3)) + (154*a^(13/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(65*b^(15/4)*sqrt(b*x^(1/3) + a*x)) - (77*a^(13/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(65*b^(15/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [1/(x^4*sqrt(b*x^(1/3) + a*x)), x, 9, -((6*sqrt(b*x^(1/3) + a*x))/(19*b*x^(10/3))) + (34*a*sqrt(b*x^(1/3) + a*x))/(95*b^2*x^(8/3)) - (442*a^2*sqrt(b*x^(1/3) + a*x))/(1045*b^3*x^2) + (3978*a^3*sqrt(b*x^(1/3) + a*x))/(7315*b^4*x^(4/3)) - (1326*a^4*sqrt(b*x^(1/3) + a*x))/(1463*b^5*x^(2/3)) - (663*a^(19/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(1463*b^(21/4)*sqrt(b*x^(1/3) + a*x))]


    @test_int [x^4/(b*x^(1/3) + a*x)^(3/2), x, 12, -((4807*b^5*(b + a*x^(2/3))*x^(1/3))/(221*a^(13/2)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x))) - (3*x^4)/(a*sqrt(b*x^(1/3) + a*x)) + (4807*b^4*x^(1/3)*sqrt(b*x^(1/3) + a*x))/(663*a^6) - (24035*b^3*x*sqrt(b*x^(1/3) + a*x))/(4641*a^5) + (6555*b^2*x^(5/3)*sqrt(b*x^(1/3) + a*x))/(1547*a^4) - (437*b*x^(7/3)*sqrt(b*x^(1/3) + a*x))/(119*a^3) + (23*x^3*sqrt(b*x^(1/3) + a*x))/(7*a^2) + (4807*b^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(221*a^(27/4)*sqrt(b*x^(1/3) + a*x)) - (4807*b^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(442*a^(27/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^3/(b*x^(1/3) + a*x)^(3/2), x, 9, -((3*x^3)/(a*sqrt(b*x^(1/3) + a*x))) - (663*b^3*sqrt(b*x^(1/3) + a*x))/(77*a^5) + (1989*b^2*x^(2/3)*sqrt(b*x^(1/3) + a*x))/(385*a^4) - (221*b*x^(4/3)*sqrt(b*x^(1/3) + a*x))/(55*a^3) + (17*x^2*sqrt(b*x^(1/3) + a*x))/(5*a^2) + (663*b^(15/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(154*a^(21/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^2/(b*x^(1/3) + a*x)^(3/2), x, 9, (77*b^2*(b + a*x^(2/3))*x^(1/3))/(5*a^(7/2)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x)) - (3*x^2)/(a*sqrt(b*x^(1/3) + a*x)) - (77*b*x^(1/3)*sqrt(b*x^(1/3) + a*x))/(15*a^3) + (11*x*sqrt(b*x^(1/3) + a*x))/(3*a^2) - (77*b^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*a^(15/4)*sqrt(b*x^(1/3) + a*x)) + (77*b^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(10*a^(15/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^1/(b*x^(1/3) + a*x)^(3/2), x, 6, -((3*x)/(a*sqrt(b*x^(1/3) + a*x))) + (5*sqrt(b*x^(1/3) + a*x))/a^2 - (5*b^(3/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(2*a^(9/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [x^0/(b*x^(1/3) + a*x)^(3/2), x, 7, -((3*(b + a*x^(2/3))*x^(1/3))/(sqrt(a)*b*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x))) + (3*x^(2/3))/(b*sqrt(b*x^(1/3) + a*x)) + (3*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(a^(3/4)*b^(3/4)*sqrt(b*x^(1/3) + a*x)) - (3*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(2*a^(3/4)*b^(3/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [1/(x^1*(b*x^(1/3) + a*x)^(3/2)), x, 6, 3/(b*x^(1/3)*sqrt(b*x^(1/3) + a*x)) - (5*sqrt(b*x^(1/3) + a*x))/(b^2*x^(2/3)) - (5*a^(3/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(2*b^(9/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [1/(x^2*(b*x^(1/3) + a*x)^(3/2)), x, 10, 3/(b*x^(4/3)*sqrt(b*x^(1/3) + a*x)) + (77*a^(5/2)*(b + a*x^(2/3))*x^(1/3))/(5*b^4*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x)) - (11*sqrt(b*x^(1/3) + a*x))/(3*b^2*x^(5/3)) + (77*a*sqrt(b*x^(1/3) + a*x))/(15*b^3*x) - (77*a^2*sqrt(b*x^(1/3) + a*x))/(5*b^4*x^(1/3)) - (77*a^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(5*b^(15/4)*sqrt(b*x^(1/3) + a*x)) + (77*a^(9/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(10*b^(15/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [1/(x^3*(b*x^(1/3) + a*x)^(3/2)), x, 9, 3/(b*x^(7/3)*sqrt(b*x^(1/3) + a*x)) - (17*sqrt(b*x^(1/3) + a*x))/(5*b^2*x^(8/3)) + (221*a*sqrt(b*x^(1/3) + a*x))/(55*b^3*x^2) - (1989*a^2*sqrt(b*x^(1/3) + a*x))/(385*b^4*x^(4/3)) + (663*a^3*sqrt(b*x^(1/3) + a*x))/(77*b^5*x^(2/3)) + (663*a^(15/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(154*b^(21/4)*sqrt(b*x^(1/3) + a*x))]
    @test_int [1/(x^4*(b*x^(1/3) + a*x)^(3/2)), x, 13, 3/(b*x^(10/3)*sqrt(b*x^(1/3) + a*x)) - (4807*a^(11/2)*(b + a*x^(2/3))*x^(1/3))/(221*b^7*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt(b*x^(1/3) + a*x)) - (23*sqrt(b*x^(1/3) + a*x))/(7*b^2*x^(11/3)) + (437*a*sqrt(b*x^(1/3) + a*x))/(119*b^3*x^3) - (6555*a^2*sqrt(b*x^(1/3) + a*x))/(1547*b^4*x^(7/3)) + (24035*a^3*sqrt(b*x^(1/3) + a*x))/(4641*b^5*x^(5/3)) - (4807*a^4*sqrt(b*x^(1/3) + a*x))/(663*b^6*x) + (4807*a^5*sqrt(b*x^(1/3) + a*x))/(221*b^7*x^(1/3)) + (4807*a^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticE(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(221*b^(27/4)*sqrt(b*x^(1/3) + a*x)) - (4807*a^(21/4)*(sqrt(b) + sqrt(a)*x^(1/3))*sqrt((b + a*x^(2/3))/(sqrt(b) + sqrt(a)*x^(1/3))^2)*x^(1/6)*EllipticF(2*atan((a^(1/4)*x^(1/6))/b^(1/4)), 1/2))/(442*b^(27/4)*sqrt(b*x^(1/3) + a*x))]
    ...
    @test_int [(a*x^2 + b*x^3)^n/x^(3*n - 1), x, 3, (x^(2 - 3*n)*(a*x^2 + b*x^3)^n*Hypergeometric2F1(2 - n, -n, 3 - n, -((b*x)/a)))/((1 + (b*x)/a)^n*(2 - n))]
    @test_int [(a*x^2 + b*x^3)^n/x^(3*n + 0), x, 3, (x^(-1 - 3*n)*(a*x^2 + b*x^3)^(1 + n)*Hypergeometric2F1(1, 2, 2 - n, -((b*x)/a)))/(a*(1 - n)), (x^(1 - 3*n)*(a*x^2 + b*x^3)^n*Hypergeometric2F1(1 - n, -n, 2 - n, -((b*x)/a)))/((1 + (b*x)/a)^n*(1 - n))]
    @test_int [(a*x^2 + b*x^3)^n/x^(3*n + 1), x, 3, -(((a*x^2 + b*x^3)^n*Hypergeometric2F1(-n, -n, 1 - n, -((b*x)/a)))/(x^(3*n)*(1 + (b*x)/a)^n*n))]
    ...
    @test_int [(a*x^2 + b*x^3)^n/x^(3*n + 4), x, 3, If($VersionNumber>=8, -((x^(-5 - 3*n)*(a*x^2 + b*x^3)^(1 + n))/(a*(3 + n))) + (2*b*x^(-4 - 3*n)*(a*x^2 + b*x^3)^(1 + n))/(a^2*(2 + n)*(3 + n)) - (2*b^2*(a*x^2 + b*x^3)^(1 + n))/(x^(3*(1 + n))*(a^3*(1 + n)*(2 + n)*(3 + n))), -((x^(-5 - 3*n)*(a*x^2 + b*x^3)^(1 + n))/(a*(3 + n))) + (2*b*x^(-4 - 3*n)*(a*x^2 + b*x^3)^(1 + n))/(a^2*(2 + n)*(3 + n)) - (2*b^2*(a*x^2 + b*x^3)^(1 + n))/(x^(3*(1 + n))*(a^3*(2 + n)*(3 + 4*n + n^2))))]
    ...
    @test_int [x^1/sqrt(a*x^2 + b*x^5), x, 2, (2*sqrt(2 + sqrt(3))*x*(a^(1/3) + b^(1/3)*x)*sqrt((a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2)/((1 + sqrt(3))*a^(1/3) + b^(1/3)*x)^2)*EllipticF(asin(((1 - sqrt(3))*a^(1/3) + b^(1/3)*x)/((1 + sqrt(3))*a^(1/3) + b^(1/3)*x)), -7 - 4*sqrt(3)))/(3^(1/4)*b^(1/3)*sqrt((a^(1/3)*(a^(1/3) + b^(1/3)*x))/((1 + sqrt(3))*a^(1/3) + b^(1/3)*x)^2)*sqrt(a*x^2 + b*x^5))]
    ...
    @test_int [x^(1/2)/(a*x^2 + b*x^5)^(1/2), x, 3, (x^(3/2)*(a^(1/3) + b^(1/3)*x)*sqrt((a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*EllipticF(acos((a^(1/3) + (1 - sqrt(3))*b^(1/3)*x)/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)), (1/4)*(2 + sqrt(3))))/(3^(1/4)*a^(1/3)*sqrt((b^(1/3)*x*(a^(1/3) + b^(1/3)*x))/(a^(1/3) + (1 + sqrt(3))*b^(1/3)*x)^2)*sqrt(a*x^2 + b*x^5))]
    ...
    @test_int [(c*x)^m*(a*x^j + b*x^n)^(3/2), x, 3, (2*b*x^(1 + n)*(c*x)^m*sqrt(a*x^j + b*x^n)*Hypergeometric2F1(-(3/2), (1 + m + (3*n)/2)/(j - n), 1 + (1 + m + (3*n)/2)/(j - n), -((a*x^(j - n))/b)))/((2 + 2*m + 3*n)*sqrt(1 + (a*x^(j - n))/b))]
    @test_int [(c*x)^m*(a*x^j + b*x^n)^(1/2), x, 3, (2*x*(c*x)^m*sqrt(a*x^j + b*x^n)*Hypergeometric2F1(-(1/2), (1 + m + n/2)/(j - n), 1 + (2 + 2*m + n)/(2*j - 2*n), -((a*x^(j - n))/b)))/((2 + 2*m + n)*sqrt(1 + (a*x^(j - n))/b))]
    @test_int [(c*x)^m/(a*x^j + b*x^n)^(1/2), x, 3, (2*x*(c*x)^m*sqrt(1 + (a*x^(j - n))/b)*Hypergeometric2F1(1/2, (1 + m - n/2)/(j - n), 1 + (1 + m - n/2)/(j - n), -((a*x^(j - n))/b)))/((2 + 2*m - n)*sqrt(a*x^j + b*x^n))]
    @test_int [(c*x)^m/(a*x^j + b*x^n)^(3/2), x, 3, (2*x^(1 - n)*(c*x)^m*sqrt(1 + (a*x^(j - n))/b)*Hypergeometric2F1(3/2, (1 + m - (3*n)/2)/(j - n), 1 + (1 + m - (3*n)/2)/(j - n), -((a*x^(j - n))/b)))/(b*(2 + 2*m - 3*n)*sqrt(a*x^j + b*x^n))]
    @test_int [(c*x)^m/(a*x^j + b*x^n)^(5/2), x, 3, (2*x^(1 - 2*n)*(c*x)^m*sqrt(1 + (a*x^(j - n))/b)*Hypergeometric2F1(5/2, (1 + m - (5*n)/2)/(j - n), 1 + (1 + m - (5*n)/2)/(j - n), -((a*x^(j - n))/b)))/(b^2*(2 + 2*m - 5*n)*sqrt(a*x^j + b*x^n))]


    @test_int [(a*x^j + b*x^n)^(3/2), x, 3, (2*b*x^(1 + n)*sqrt(a*x^j + b*x^n)*Hypergeometric2F1(-(3/2), (1 + (3*n)/2)/(j - n), (2 + 2*j + n)/(2*(j - n)), -((a*x^(j - n))/b)))/((2 + 3*n)*sqrt(1 + (a*x^(j - n))/b))]
    @test_int [(a*x^j + b*x^n)^(1/2), x, 3, (2*x*sqrt(a*x^j + b*x^n)*Hypergeometric2F1(-(1/2), (2 + n)/(2*(j - n)), 1 + (2 + n)/(2*j - 2*n), -((a*x^(j - n))/b)))/((2 + n)*sqrt(1 + (a*x^(j - n))/b))]
    @test_int [1/(a*x^j + b*x^n)^(1/2), x, 3, If($VersionNumber<11, (2*x*sqrt(1 + (a*x^(j - n))/b)*Hypergeometric2F1(1/2, (2 - n)/(2*(j - n)), (1/2)*(2 + (2 - n)/(j - n)), -((a*x^(j - n))/b)))/((2 - n)*sqrt(a*x^j + b*x^n)), (2*x*sqrt(1 + (a*x^(j - n))/b)*Hypergeometric2F1(1/2, (2 - n)/(2*(j - n)), 1 + (1 - n/2)/(j - n), -((a*x^(j - n))/b)))/((2 - n)*sqrt(a*x^j + b*x^n)))]
    @test_int [1/(a*x^j + b*x^n)^(3/2), x, 3, If($VersionNumber<11, (2*x^(1 - n)*sqrt(1 + (a*x^(j - n))/b)*Hypergeometric2F1(3/2, (1 - (3*n)/2)/(j - n), 1 + (2 - 3*n)/(2*j - 2*n), -((a*x^(j - n))/b)))/(b*(2 - 3*n)*sqrt(a*x^j + b*x^n)), (2*x^(1 - n)*sqrt(1 + (a*x^(j - n))/b)*Hypergeometric2F1(3/2, (1 - (3*n)/2)/(j - n), 1 + (1 - (3*n)/2)/(j - n), -((a*x^(j - n))/b)))/(b*(2 - 3*n)*sqrt(a*x^j + b*x^n)))]
    @test_int [1/(a*x^j + b*x^n)^(5/2), x, 3, If($VersionNumber<11, (2*x^(1 - 2*n)*sqrt(1 + (a*x^(j - n))/b)*Hypergeometric2F1(5/2, (1 - (5*n)/2)/(j - n), 1 + (2 - 5*n)/(2*j - 2*n), -((a*x^(j - n))/b)))/(b^2*(2 - 5*n)*sqrt(a*x^j + b*x^n)), (2*x^(1 - 2*n)*sqrt(1 + (a*x^(j - n))/b)*Hypergeometric2F1(5/2, (1 - (5*n)/2)/(j - n), 1 + (1 - (5*n)/2)/(j - n), -((a*x^(j - n))/b)))/(b^2*(2 - 5*n)*sqrt(a*x^j + b*x^n)))]
    ...
    @test_int [x^m*(a*x^j + b*x^n)^p, x, 3, (x^(1 + m)*(a + b*x^(n - j))*(b*x^n + a*x^j)^p*Hypergeometric2F1(1, 1 + p + (1 + m + p*j)/(n - j), 1 + (1 + m + p*j)/(n - j), -((b*x^(n - j))/a)))/(a*(1 + m + p*j)), (x^(1 + m)*(a*x^j + b*x^n)^p*Hypergeometric2F1(-p, (1 + m + n*p)/(j - n), 1 + (1 + m + n*p)/(j - n), -((a*x^(j - n))/b)))/((1 + (a*x^(j - n))/b)^p*(1 + m + n*p))]


    @test_int [(a*x^q + b*x^n)^p/x^(p*q + 1), x, 3, -(((a + b*x^(n - q))*(b*x^n + a*x^q)^p*Hypergeometric2F1(1, 1 + p, 2 + p, 1 + (b*x^(n - q))/a))/(x^(p*q)*(a*(1 + p)*(n - q))))]
    @test_int [(a*x^q + b*x^n)^p/x^(p*n + 1), x, 3, -(((a + b*x^(n - q))*(b*x^n + a*x^q)^p*Hypergeometric2F1(1, 1, 1 - p, -((b*x^(n - q))/a)))/(x^(n*p)*(a*p*(n - q)))), -(((b*x^n + a*x^q)^p*Hypergeometric2F1(-p, -p, 1 - p, -((b*x^(n - q))/a)))/(x^(n*p)*(1 + (b*x^(n - q))/a)^p*(p*(n - q))))]
    @test_int [(a*x^q + b*x^n)^p/x^(n + (p - 1)*q + 1), x, 3, (b*(a + b*x^(n - q))*(b*x^n + a*x^q)^p*Hypergeometric2F1(2, 1 + p, 2 + p, 1 + (b*x^(n - q))/a))/(x^(p*q)*(a^2*(1 + p)*(n - q)))]
    @test_int [(a*x^q + b*x^n)^p/x^(q + (p - 1)*n + 1), x, 3, (x^(n - n*p - q)*(b*x^n + a*x^q)^p*Hypergeometric2F1(1 - p, -p, 2 - p, -((b*x^(n - q))/a)))/((1 + (b*x^(n - q))/a)^p*((1 - p)*(n - q)))]
