@testset "7.3.7 Inverse hyperbolic tangent functions" begin
    ...
    @test_int [x^(9/2)*atanh(sqrt(e)*x/sqrt(d + e*x^2)), x, 6, -((60*d^2*sqrt(x)*sqrt(d + e*x^2))/(847*e^(5/2))) + (36*d*x^(5/2)*sqrt(d + e*x^2))/(847*e^(3/2)) - (4*x^(9/2)*sqrt(d + e*x^2))/(121*sqrt(e)) + (2/11)*x^(11/2)*atanh((sqrt(e)*x)/sqrt(d + e*x^2)) + (30*d^(11/4)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*Elliptic.F(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(847*e^(11/4)*sqrt(d + e*x^2))]
    @test_int [x^(5/2)*atanh(sqrt(e)*x/sqrt(d + e*x^2)), x, 5, (20*d*sqrt(x)*sqrt(d + e*x^2))/(147*e^(3/2)) - (4*x^(5/2)*sqrt(d + e*x^2))/(49*sqrt(e)) + (2/7)*x^(7/2)*atanh((sqrt(e)*x)/sqrt(d + e*x^2)) - (10*d^(7/4)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*Elliptic.F(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(147*e^(7/4)*sqrt(d + e*x^2))]
    @test_int [x^(1/2)*atanh(sqrt(e)*x/sqrt(d + e*x^2)), x, 4, -((4*sqrt(x)*sqrt(d + e*x^2))/(9*sqrt(e))) + (2/3)*x^(3/2)*atanh((sqrt(e)*x)/sqrt(d + e*x^2)) + (2*d^(3/4)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*Elliptic.F(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(9*e^(3/4)*sqrt(d + e*x^2))]
    @test_int [atanh(sqrt(e)*x/sqrt(d + e*x^2))/x^(3/2), x, 3, -((2*atanh((sqrt(e)*x)/sqrt(d + e*x^2)))/sqrt(x)) + (2*e^(1/4)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*Elliptic.F(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(d^(1/4)*sqrt(d + e*x^2))]
    @test_int [atanh(sqrt(e)*x/sqrt(d + e*x^2))/x^(7/2), x, 4, -((4*sqrt(e)*sqrt(d + e*x^2))/(15*d*x^(3/2))) - (2*atanh((sqrt(e)*x)/sqrt(d + e*x^2)))/(5*x^(5/2)) - (2*e^(5/4)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*Elliptic.F(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(15*d^(5/4)*sqrt(d + e*x^2))]
    @test_int [atanh(sqrt(e)*x/sqrt(d + e*x^2))/x^(11/2), x, 5, -((4*sqrt(e)*sqrt(d + e*x^2))/(63*d*x^(7/2))) + (20*e^(3/2)*sqrt(d + e*x^2))/(189*d^2*x^(3/2)) - (2*atanh((sqrt(e)*x)/sqrt(d + e*x^2)))/(9*x^(9/2)) + (10*e^(9/4)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*Elliptic.F(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(189*d^(9/4)*sqrt(d + e*x^2))]
    ...
    @test_int [1/atanh(tanh(a + b*x))*x^m, x, 1, -((x^(1 + m)*HypergeometricFunctions._₂F₁(1, 1 + m, 2 + m, (b*x)/(b*x - atanh(tanh(a + b*x)))))/((1 + m)*(b*x - atanh(tanh(a + b*x)))))]
    ...
    @test_int [1/atanh(tanh(a + b*x))^2*x^m, x, 2, -(x^m/(b*atanh(tanh(a + b*x)))) - (x^m*HypergeometricFunctions._₂F₁(1, m, 1 + m, (b*x)/(b*x - atanh(tanh(a + b*x)))))/(b*(b*x - atanh(tanh(a + b*x))))]
    ...
    @test_int [1/atanh(tanh(a + b*x))^3*x^m, x, 3, -(x^m/(2*b*atanh(tanh(a + b*x))^2)) - (m*x^(-1 + m))/(2*b^2*atanh(tanh(a + b*x))) - (m*x^(-1 + m)*HypergeometricFunctions._₂F₁(1, -1 + m, m, (b*x)/(b*x - atanh(tanh(a + b*x)))))/(2*b^2*(b*x - atanh(tanh(a + b*x))))]
    ...
    @test_int [atanh(tanh(a + b*x))^n*x^m, x, 1, (1/(b*(1 + n)))*((x^m*atanh(tanh(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(-m, 1 + n, 2 + n, -(atanh(tanh(a + b*x))/(b*x - atanh(tanh(a + b*x))))))/((b*x)/(b*x - atanh(tanh(a + b*x))))^m)]

    @test_int [atanh(tanh(a + b*x))^n*x^4, x, 6, If(13>=8, (x^4*atanh(tanh(a + b*x))^(1 + n))/(b*(1 + n)) - (4*x^3*atanh(tanh(a + b*x))^(2 + n))/(b^2*(1 + n)*(2 + n)) + (12*x^2*atanh(tanh(a + b*x))^(3 + n))/(b^3*(1 + n)*(2 + n)*(3 + n)) - (24*x*atanh(tanh(a + b*x))^(4 + n))/(b^4*(1 + n)*(2 + n)*(3 + n)*(4 + n)) + (24*atanh(tanh(a + b*x))^(5 + n))/(b^5*(1 + n)*(2 + n)*(3 + n)*(4 + n)*(5 + n)), (x^4*atanh(tanh(a + b*x))^(1 + n))/(b*(1 + n)) - (4*x^3*atanh(tanh(a + b*x))^(2 + n))/(b^2*(1 + n)*(2 + n)) + (12*x^2*atanh(tanh(a + b*x))^(3 + n))/(b^3*(3 + n)*(2 + 3*n + n^2)) - (24*x*atanh(tanh(a + b*x))^(4 + n))/(b^4*(4 + 5*n + n^2)*(6 + 5*n + n^2)) + (24*atanh(tanh(a + b*x))^(5 + n))/(b^5*(12 + 7*n + n^2)*(10 + 17*n + 8*n^2 + n^3)))]
    @test_int [atanh(tanh(a + b*x))^n*x^3, x, 5, If(13>=8, (x^3*atanh(tanh(a + b*x))^(1 + n))/(b*(1 + n)) - (3*x^2*atanh(tanh(a + b*x))^(2 + n))/(b^2*(1 + n)*(2 + n)) + (6*x*atanh(tanh(a + b*x))^(3 + n))/(b^3*(1 + n)*(2 + n)*(3 + n)) - (6*atanh(tanh(a + b*x))^(4 + n))/(b^4*(1 + n)*(2 + n)*(3 + n)*(4 + n)), (x^3*atanh(tanh(a + b*x))^(1 + n))/(b*(1 + n)) - (3*x^2*atanh(tanh(a + b*x))^(2 + n))/(b^2*(1 + n)*(2 + n)) + (6*x*atanh(tanh(a + b*x))^(3 + n))/(b^3*(3 + n)*(2 + 3*n + n^2)) - (6*atanh(tanh(a + b*x))^(4 + n))/(b^4*(4 + 5*n + n^2)*(6 + 5*n + n^2)))]
    @test_int [atanh(tanh(a + b*x))^n*x^2, x, 4, If(13>=8, (x^2*atanh(tanh(a + b*x))^(1 + n))/(b*(1 + n)) - (2*x*atanh(tanh(a + b*x))^(2 + n))/(b^2*(1 + n)*(2 + n)) + (2*atanh(tanh(a + b*x))^(3 + n))/(b^3*(1 + n)*(2 + n)*(3 + n)), (x^2*atanh(tanh(a + b*x))^(1 + n))/(b*(1 + n)) - (2*x*atanh(tanh(a + b*x))^(2 + n))/(b^2*(1 + n)*(2 + n)) + (2*atanh(tanh(a + b*x))^(3 + n))/(b^3*(3 + n)*(2 + 3*n + n^2)))]
    ...
    @test_int [atanh(tanh(a + b*x))^n/x^1, x, 1, (atanh(tanh(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(1, 1 + n, 2 + n, -(atanh(tanh(a + b*x))/(b*x - atanh(tanh(a + b*x))))))/((1 + n)*(b*x - atanh(tanh(a + b*x))))]
    @test_int [atanh(tanh(a + b*x))^n/x^2, x, 2, -(atanh(tanh(a + b*x))^n/x) + (b*atanh(tanh(a + b*x))^n*HypergeometricFunctions._₂F₁(1, n, 1 + n, -(atanh(tanh(a + b*x))/(b*x - atanh(tanh(a + b*x))))))/(b*x - atanh(tanh(a + b*x)))]
    @test_int [atanh(tanh(a + b*x))^n/x^3, x, 3, -((b*n*atanh(tanh(a + b*x))^(-1 + n))/(2*x)) - atanh(tanh(a + b*x))^n/(2*x^2) + (b^2*n*atanh(tanh(a + b*x))^(-1 + n)*HypergeometricFunctions._₂F₁(1, -1 + n, n, -(atanh(tanh(a + b*x))/(b*x - atanh(tanh(a + b*x))))))/(2*(b*x - atanh(tanh(a + b*x))))]
