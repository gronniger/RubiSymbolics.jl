@testset "7.2.2 (d x)^m (a+b arccosh(c x))^n" begin
    ...
    @test_int [x^m*acosh(a*x)^2, x, 2, (x^(1 + m)*acosh(a*x)^2)/(1 + m) - (2*a*x^(2 + m)*sqrt(1 - a*x)*acosh(a*x)*Hypergeometric2F1(1/2, (2 + m)/2, (4 + m)/2, a^2*x^2))/((2 + 3*m + m^2)*sqrt(-1 + a*x)) - (2*a^2*x^(3 + m)*HypergeometricPFQ([1, 3/2 + m/2, 3/2 + m/2], [2 + m/2, 5/2 + m/2], a^2*x^2))/(6 + 11*m + 6*m^2 + m^3)]
    @test_int [x^m*acosh(a*x)^1, x, 4, (x^(1 + m)*acosh(a*x))/(1 + m) - (a*x^(2 + m)*sqrt(1 - a^2*x^2)*Hypergeometric2F1(1/2, (2 + m)/2, (4 + m)/2, a^2*x^2))/((2 + 3*m + m^2)*sqrt(-1 + a*x)*sqrt(1 + a*x))]
    ...
    @test_int [sqrt(f*x)*(a + b*acosh(c*x))^2, x, 2, (2*(f*x)^(3/2)*(a + b*acosh(c*x))^2)/(3*f) - (8*b*c*(f*x)^(5/2)*sqrt(1 - c*x)*(a + b*acosh(c*x))*Hypergeometric2F1(1/2, 5/4, 9/4, c^2*x^2))/(15*f^2*sqrt(-1 + c*x)) - (16*b^2*c^2*(f*x)^(7/2)*HypergeometricPFQ([1, 7/4, 7/4], [9/4, 11/4], c^2*x^2))/(105*f^3)]
    ...
    @test_int [(d*x)^m*(a + b*acosh(c*x))^2, x, 2, If($VersionNumber>=8, ((d*x)^(1 + m)*(a + b*acosh(c*x))^2)/(d*(1 + m)) - (2*b*c*(d*x)^(2 + m)*sqrt(1 - c*x)*(a + b*acosh(c*x))*Hypergeometric2F1(1/2, (2 + m)/2, (4 + m)/2, c^2*x^2))/(d^2*(1 + m)*(2 + m)*sqrt(-1 + c*x)) - (2*b^2*c^2*(d*x)^(3 + m)*HypergeometricPFQ([1, 3/2 + m/2, 3/2 + m/2], [2 + m/2, 5/2 + m/2], c^2*x^2))/(d^3*(1 + m)*(2 + m)*(3 + m)), ((d*x)^(1 + m)*(a + b*acosh(c*x))^2)/(d*(1 + m)) - (2*b*c*(d*x)^(2 + m)*sqrt(1 - c*x)*(a + b*acosh(c*x))*Hypergeometric2F1(1/2, (2 + m)/2, (4 + m)/2, c^2*x^2))/(d^2*(1 + m)*(2 + m)*sqrt(-1 + c*x)) - (2*b^2*c^2*(d*x)^(3 + m)*HypergeometricPFQ([1, 3/2 + m/2, 3/2 + m/2], [2 + m/2, 5/2 + m/2], c^2*x^2))/(d^3*(3 + m)*(2 + 3*m + m^2)))]
    @test_int [(d*x)^m*(a + b*acosh(c*x))^1, x, 4, ((d*x)^(1 + m)*(a + b*acosh(c*x)))/(d*(1 + m)) - (b*c*(d*x)^(2 + m)*sqrt(1 - c^2*x^2)*Hypergeometric2F1(1/2, (2 + m)/2, (4 + m)/2, c^2*x^2))/(d^2*(1 + m)*(2 + m)*sqrt(-1 + c*x)*sqrt(1 + c*x))]
