@testset "Hearn Problems" begin
    @variables a, alpha, b, c, d, e, eps, epsilon, h, k, m, mc, p, q, r, x, y, z
    ...
    @test_int [sin(x)^p, x, 1, (cos(x)*Hypergeometric2F1(1/2, (1 + p)/2, (3 + p)/2, sin(x)^2)*sin(x)^(1 + p))/((1 + p)*sqrt(cos(x)^2))]
