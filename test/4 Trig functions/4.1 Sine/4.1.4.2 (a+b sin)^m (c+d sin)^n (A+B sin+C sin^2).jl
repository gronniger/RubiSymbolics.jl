@testset "4.1.4.2 (a+b sin)^m (c+d sin)^n (A+B sin+C sin^2)" begin
    ...
    @test_int [(a + a*sin(e + f*x))^m/(c - c*sin(e + f*x))^(1/2)*(A + C*sin(e + f*x)^2), x, 4, ((A + C)*cos(e + f*x)*Hypergeometric2F1(1, 1/2 + m, 3/2 + m, (1/2)*(1 + sin(e + f*x)))*(a + a*sin(e + f*x))^m)/(f*(1 + 2*m)*sqrt(c - c*sin(e + f*x))) - (2*C*cos(e + f*x)*(a + a*sin(e + f*x))^(1 + m))/(a*f*(3 + 2*m)*sqrt(c - c*sin(e + f*x)))]
    ...
    @test_int [(a + a*sin(e + f*x))^m/(c - c*sin(e + f*x))^(1/2)*(A + B*sin(e + f*x) + C*sin(e + f*x)^2), x, 5, -((2*B*cos(e + f*x)*(a + a*sin(e + f*x))^m)/(f*(1 + 2*m)*sqrt(c - c*sin(e + f*x)))) + ((A + B + C)*cos(e + f*x)*Hypergeometric2F1(1, 1/2 + m, 3/2 + m, (1/2)*(1 + sin(e + f*x)))*(a + a*sin(e + f*x))^m)/(f*(1 + 2*m)*sqrt(c - c*sin(e + f*x))) - (2*C*cos(e + f*x)*(a + a*sin(e + f*x))^(1 + m))/(a*f*(3 + 2*m)*sqrt(c - c*sin(e + f*x)))]
    ...
    @test_int [((a + b*sin(e + f*x))*(A + B*sin(e + f*x) + C*sin(e + f*x)^2))/sin(e + f*x)^(3/2), x, 5, (2*(b*B - a*(A - C))*EllipticE((1/2)*(e - pi/2 + f*x), 2))/f + (2*(3*A*b + 3*a*B + b*C)*EllipticF((1/2)*(e - pi/2 + f*x), 2))/(3*f) - (2*a*A*cos(e + f*x))/(f*sqrt(sin(e + f*x))) - (2*b*C*cos(e + f*x)*sqrt(sin(e + f*x)))/(3*f)]
