@testset "4.1.7 (d trig)^m (a+b (c sin)^n)^p" begin
    ...
    @test_int [(a*sin(x)^3)^(5/2), x, 6, (-(26/77))*a^2*cot(x)*sqrt(a*sin(x)^3) - (26*a^2*Elliptic.F(pi/4 - x/2, 2)*sqrt(a*sin(x)^3))/(77*sin(x)^(3/2)) - (78/385)*a^2*cos(x)*sin(x)*sqrt(a*sin(x)^3) - (26/165)*a^2*cos(x)*sin(x)^3*sqrt(a*sin(x)^3) - (2/15)*a^2*cos(x)*sin(x)^5*sqrt(a*sin(x)^3)]
    @test_int [(a*sin(x)^3)^(3/2), x, 4, (-(14/45))*a*cos(x)*sqrt(a*sin(x)^3) - (14*a*Elliptic.E(pi/4 - x/2, 2)*sqrt(a*sin(x)^3))/(15*sin(x)^(3/2)) - (2/9)*a*cos(x)*sin(x)^2*sqrt(a*sin(x)^3)]
    @test_int [(a*sin(x)^3)^(1/2), x, 3, (-(2/3))*cot(x)*sqrt(a*sin(x)^3) - (2*Elliptic.F(pi/4 - x/2, 2)*sqrt(a*sin(x)^3))/(3*sin(x)^(3/2))]
    @test_int [1/(a*sin(x)^3)^(1/2), x, 3, -((2*cos(x)*sin(x))/sqrt(a*sin(x)^3)) + (2*Elliptic.E(pi/4 - x/2, 2)*sin(x)^(3/2))/sqrt(a*sin(x)^3)]
    @test_int [1/(a*sin(x)^3)^(3/2), x, 4, -((10*cos(x))/(21*a*sqrt(a*sin(x)^3))) - (2*cot(x)*csc(x))/(7*a*sqrt(a*sin(x)^3)) - (10*Elliptic.F(pi/4 - x/2, 2)*sin(x)^(3/2))/(21*a*sqrt(a*sin(x)^3))]
    @test_int [1/(a*sin(x)^3)^(5/2), x, 6, -((154*cot(x))/(585*a^2*sqrt(a*sin(x)^3))) - (22*cot(x)*csc(x)^2)/(117*a^2*sqrt(a*sin(x)^3)) - (2*cot(x)*csc(x)^4)/(13*a^2*sqrt(a*sin(x)^3)) - (154*cos(x)*sin(x))/(195*a^2*sqrt(a*sin(x)^3)) + (154*Elliptic.E(pi/4 - x/2, 2)*sin(x)^(3/2))/(195*a^2*sqrt(a*sin(x)^3))]
    ...
    @test_int [(c*sin(a + b*x)^m)^(5/2), x, 2, (2*c^2*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (1/4)*(2 + 5*m), (1/4)*(6 + 5*m), sin(a + b*x)^2)*sin(a + b*x)^(1 + 2*m)*sqrt(c*sin(a + b*x)^m))/(b*(2 + 5*m)*sqrt(cos(a + b*x)^2))]
    @test_int [(c*sin(a + b*x)^m)^(3/2), x, 2, (2*c*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (1/4)*(2 + 3*m), (3*(2 + m))/4, sin(a + b*x)^2)*sin(a + b*x)^(1 + m)*sqrt(c*sin(a + b*x)^m))/(b*(2 + 3*m)*sqrt(cos(a + b*x)^2))]
    @test_int [(c*sin(a + b*x)^m)^(1/2), x, 2, (2*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (2 + m)/4, (6 + m)/4, sin(a + b*x)^2)*sin(a + b*x)*sqrt(c*sin(a + b*x)^m))/(b*(2 + m)*sqrt(cos(a + b*x)^2))]
    @test_int [1/(c*sin(a + b*x)^m)^(1/2), x, 2, (2*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (2 - m)/4, (6 - m)/4, sin(a + b*x)^2)*sin(a + b*x))/(b*(2 - m)*sqrt(cos(a + b*x)^2)*sqrt(c*sin(a + b*x)^m))]
    @test_int [1/(c*sin(a + b*x)^m)^(3/2), x, 2, (2*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (1/4)*(2 - 3*m), (3*(2 - m))/4, sin(a + b*x)^2)*sin(a + b*x)^(1 - m))/(b*c*(2 - 3*m)*sqrt(cos(a + b*x)^2)*sqrt(c*sin(a + b*x)^m))]
    @test_int [1/(c*sin(a + b*x)^m)^(5/2), x, 2, (2*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (1/4)*(2 - 5*m), (1/4)*(6 - 5*m), sin(a + b*x)^2)*sin(a + b*x)^(1 - 2*m))/(b*c^2*(2 - 5*m)*sqrt(cos(a + b*x)^2)*sqrt(c*sin(a + b*x)^m))]
    ...
    @test_int [(b*sin(c + d*x)^n)^p, x, 2, (cos(c + d*x)*HypergeometricFunctions._₂F₁(1/2, (1/2)*(1 + n*p), (1/2)*(3 + n*p), sin(c + d*x)^2)*sin(c + d*x)*(b*sin(c + d*x)^n)^p)/(d*(1 + n*p)*sqrt(cos(c + d*x)^2))]


    @test_int [(c*sin(a + b*x)^2)^p, x, 2, (cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (1/2)*(1 + 2*p), (1/2)*(3 + 2*p), sin(a + b*x)^2)*sin(a + b*x)*(c*sin(a + b*x)^2)^p)/(b*(1 + 2*p)*sqrt(cos(a + b*x)^2))]
    @test_int [(c*sin(a + b*x)^3)^p, x, 2, (cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (1/2)*(1 + 3*p), (3*(1 + p))/2, sin(a + b*x)^2)*sin(a + b*x)*(c*sin(a + b*x)^3)^p)/(b*(1 + 3*p)*sqrt(cos(a + b*x)^2))]
    @test_int [(c*sin(a + b*x)^4)^p, x, 2, (cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (1/2)*(1 + 4*p), (1/2)*(3 + 4*p), sin(a + b*x)^2)*sin(a + b*x)*(c*sin(a + b*x)^4)^p)/(b*(1 + 4*p)*sqrt(cos(a + b*x)^2))]
    ...
    @test_int [(a*(b*sin(c + d*x))^p)^n, x, 2, (cos(c + d*x)*HypergeometricFunctions._₂F₁(1/2, (1/2)*(1 + n*p), (1/2)*(3 + n*p), sin(c + d*x)^2)*sin(c + d*x)*(a*(b*sin(c + d*x))^p)^n)/(d*(1 + n*p)*sqrt(cos(c + d*x)^2))]
    ...
    @test_int [sin(e + f*x)^4*sqrt(a + b*sin(e + f*x)^2), x, 8, -(((a + 4*b)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(15*b*f)) - (cos(e + f*x)*sin(e + f*x)^3*sqrt(a + b*sin(e + f*x)^2))/(5*f) - ((2*a^2 - 3*a*b - 8*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(15*b^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (2*a*(a - 2*b)*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(15*b^2*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2), x, 6, -((cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f)) + ((a + 2*b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*b*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (a*(a + b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^0*sqrt(a + b*sin(e + f*x)^2), x, 2, (Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(f*sqrt(1 + (b*sin(e + f*x)^2)/a))]
    @test_int [csc(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2), x, 8, -((cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/f) - (sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [csc(e + f*x)^4*sqrt(a + b*sin(e + f*x)^2), x, 8, -(((2*a + b)*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a*f)) - (cot(e + f*x)*csc(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2))/(3*f) - ((2*a + b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (2*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2))]
    ...
    @test_int [sin(e + f*x)^4*(a + b*sin(e + f*x)^2)^(3/2), x, 9, -((a^2 + 11*a*b + 8*b^2)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(35*b*f) - (2*(4*a + 3*b)*cos(e + f*x)*sin(e + f*x)^3*sqrt(a + b*sin(e + f*x)^2))/(35*f) - (b*cos(e + f*x)*sin(e + f*x)^5*sqrt(a + b*sin(e + f*x)^2))/(7*f) - (2*(a + 2*b)*(a^2 - 4*a*b - 4*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(35*b^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (a*(a + b)*(2*a^2 - 5*a*b - 8*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(35*b^2*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^2*(a + b*sin(e + f*x)^2)^(3/2), x, 7, -((3*a + 4*b)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(15*f) - (cos(e + f*x)*sin(e + f*x)*(a + b*sin(e + f*x)^2)^(3/2))/(5*f) + ((3*a^2 + 13*a*b + 8*b^2)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(15*b*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (a*(a + b)*(3*a + 4*b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(15*b*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^0*(a + b*sin(e + f*x)^2)^(3/2), x, 6, -(b*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f) + (2*(2*a + b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (a*(a + b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [csc(e + f*x)^2*(a + b*sin(e + f*x)^2)^(3/2), x, 7, -((a*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/f) - ((a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (a*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [csc(e + f*x)^4*(a + b*sin(e + f*x)^2)^(3/2), x, 8, (-2*(a + 2*b)*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f) - (a*cot(e + f*x)*csc(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2))/(3*f) - (2*(a + 2*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((a + b)*(2*a + 3*b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2))]


    @test_int [(a + b*sin(c + d*x)^2)^(5/2), x, 7, -((4*b*(2*a + b)*cos(c + d*x)*sin(c + d*x)*sqrt(a + b*sin(c + d*x)^2))/(15*d)) - (b*cos(c + d*x)*sin(c + d*x)*(a + b*sin(c + d*x)^2)^(3/2))/(5*d) + ((23*a^2 + 23*a*b + 8*b^2)*Elliptic.E(c + d*x, -(b/a))*sqrt(a + b*sin(c + d*x)^2))/(15*d*sqrt(1 + (b*sin(c + d*x)^2)/a)) - (4*a*(a + b)*(2*a + b)*Elliptic.F(c + d*x, -(b/a))*sqrt(1 + (b*sin(c + d*x)^2)/a))/(15*d*sqrt(a + b*sin(c + d*x)^2))]
    ...
    @test_int [sin(e + f*x)^4/sqrt(a + b*sin(e + f*x)^2), x, 7, -((cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*b*f)) - (2*(a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*b^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (a*(2*a - b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b^2*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^2/sqrt(a + b*sin(e + f*x)^2), x, 5, (Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(b*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (a*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(b*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^0/sqrt(a + b*sin(e + f*x)^2), x, 2, (Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [csc(e + f*x)^2/sqrt(a + b*sin(e + f*x)^2), x, 8, -((cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a*f)) - (sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [csc(e + f*x)^4/sqrt(a + b*sin(e + f*x)^2), x, 8, -((2*(a - b)*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*f)) - (cot(e + f*x)*csc(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2))/(3*a*f) - (2*(a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((2*a - b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*f*sqrt(a + b*sin(e + f*x)^2))]
    ...
    @test_int [sin(e + f*x)^6/(a + b*sin(e + f*x)^2)^(3/2), x, 8, (a*cos(e + f*x)*sin(e + f*x)^3)/(b*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) - ((4*a + b)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*b^2*(a + b)*f) - ((8*a^2 + 3*a*b - 2*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*b^3*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (a*(8*a - b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b^3*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^4/(a + b*sin(e + f*x)^2)^(3/2), x, 7, (a*cos(e + f*x)*sin(e + f*x))/(b*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) + ((2*a + b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(b^2*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (2*a*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(b^2*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^2/(a + b*sin(e + f*x)^2)^(3/2), x, 6, -((cos(e + f*x)*sin(e + f*x))/((a + b)*f*sqrt(a + b*sin(e + f*x)^2))) - (Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(b*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(b*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^0/(a + b*sin(e + f*x)^2)^(3/2), x, 4, (b*cos(e + f*x)*sin(e + f*x))/(a*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) + (Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(a*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a))]
    @test_int [csc(e + f*x)^2/(a + b*sin(e + f*x)^2)^(3/2), x, 8, (b*cot(e + f*x))/(a*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) - ((a + 2*b)*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a^2*(a + b)*f) - ((a + 2*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a^2*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(a*f*sqrt(a + b*sin(e + f*x)^2))]
    ...
    @test_int [sin(e + f*x)^6/(a + b*sin(e + f*x)^2)^(5/2), x, 8, (a*cos(e + f*x)*sin(e + f*x)^3)/(3*b*(a + b)*f*(a + b*sin(e + f*x)^2)^(3/2)) + (2*a*(2*a + 3*b)*cos(e + f*x)*sin(e + f*x))/(3*b^2*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2)) + ((8*a^2 + 13*a*b + 3*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*b^3*(a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (a*(8*a + 9*b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b^3*(a + b)*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^4/(a + b*sin(e + f*x)^2)^(5/2), x, 8, (a*cos(e + f*x)*sin(e + f*x))/(3*b*(a + b)*f*(a + b*sin(e + f*x)^2)^(3/2)) - (2*(a + 2*b)*cos(e + f*x)*sin(e + f*x))/(3*b*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2)) - (2*(a + 2*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*b^2*(a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((2*a + 3*b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b^2*(a + b)*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^2/(a + b*sin(e + f*x)^2)^(5/2), x, 7, -((cos(e + f*x)*sin(e + f*x))/(3*(a + b)*f*(a + b*sin(e + f*x)^2)^(3/2))) - ((a - b)*cos(e + f*x)*sin(e + f*x))/(3*a*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2)) - ((a - b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*a*b*(a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b*(a + b)*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sin(e + f*x)^0/(a + b*sin(e + f*x)^2)^(5/2), x, 7, (b*cos(e + f*x)*sin(e + f*x))/(3*a*(a + b)*f*(a + b*sin(e + f*x)^2)^(3/2)) + (2*b*(2*a + b)*cos(e + f*x)*sin(e + f*x))/(3*a^2*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2)) + (2*(2*a + b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*(a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*(a + b)*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [csc(e + f*x)^2/(a + b*sin(e + f*x)^2)^(5/2), x, 9, (b*cot(e + f*x))/(3*a*(a + b)*f*(a + b*sin(e + f*x)^2)^(3/2)) + (2*b*(3*a + 2*b)*cot(e + f*x))/(3*a^2*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2)) - ((3*a^2 + 13*a*b + 8*b^2)*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^3*(a + b)^2*f) - ((3*a^2 + 13*a*b + 8*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^3*(a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((3*a + 4*b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a^2*(a + b)*f*sqrt(a + b*sin(e + f*x)^2))]
    ...
    @test_int [sin(e + f*x)^5*(a + b*sin(e + f*x)^2)^p, x, 5, If(13>=8, ((3*a - 2*b*(2 + p))*cos(e + f*x)*(a + b - b*cos(e + f*x)^2)^(1 + p))/(b^2*f*(3 + 2*p)*(5 + 2*p)) - ((3*a^2 - 4*a*b*(1 + p) + 4*b^2*(2 + 3*p + p^2))*cos(e + f*x)*(a + b - b*cos(e + f*x)^2)^p*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, (b*cos(e + f*x)^2)/(a + b)))/((1 - (b*cos(e + f*x)^2)/(a + b))^p*(b^2*f*(3 + 2*p)*(5 + 2*p))) - (cos(e + f*x)*(a + b - b*cos(e + f*x)^2)^(1 + p)*sin(e + f*x)^2)/(b*f*(5 + 2*p)), ((3*a - 2*b*(2 + p))*cos(e + f*x)*(a + b - b*cos(e + f*x)^2)^(1 + p))/(b^2*f*(15 + 16*p + 4*p^2)) - ((3*a^2 - 4*a*b*(1 + p) + 4*b^2*(2 + 3*p + p^2))*cos(e + f*x)*(a + b - b*cos(e + f*x)^2)^p*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, (b*cos(e + f*x)^2)/(a + b)))/((1 - (b*cos(e + f*x)^2)/(a + b))^p*(b^2*f*(15 + 16*p + 4*p^2))) - (cos(e + f*x)*(a + b - b*cos(e + f*x)^2)^(1 + p)*sin(e + f*x)^2)/(b*f*(5 + 2*p)))]
    @test_int [sin(e + f*x)^3*(a + b*sin(e + f*x)^2)^p, x, 4, -((cos(e + f*x)*(a + b - b*cos(e + f*x)^2)^(1 + p))/(b*f*(3 + 2*p))) + ((a - 2*b*(1 + p))*cos(e + f*x)*(a + b - b*cos(e + f*x)^2)^p*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, (b*cos(e + f*x)^2)/(a + b)))/((1 - (b*cos(e + f*x)^2)/(a + b))^p*(b*f*(3 + 2*p)))]
    @test_int [sin(e + f*x)^1*(a + b*sin(e + f*x)^2)^p, x, 3, -((cos(e + f*x)*(a + b - b*cos(e + f*x)^2)^p*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, (b*cos(e + f*x)^2)/(a + b)))/((1 - (b*cos(e + f*x)^2)/(a + b))^p*f))]
    ...
    @test_int [sin(c + d*x)^1/sqrt(a + b*sin(c + d*x)^4), x, 2, -(((a + b)^(1/4)*(1 + (sqrt(b)*cos(c + d*x)^2)/sqrt(a + b))*sqrt((a + b - 2*b*cos(c + d*x)^2 + b*cos(c + d*x)^4)/((a + b)*(1 + (sqrt(b)*cos(c + d*x)^2)/sqrt(a + b))^2))*Elliptic.F(2*atan((b^(1/4)*cos(c + d*x))/(a + b)^(1/4)), (1/2)*(1 + sqrt(b)/sqrt(a + b))))/(2*b^(1/4)*d*sqrt(a + b - 2*b*cos(c + d*x)^2 + b*cos(c + d*x)^4)))]
    ...
    @test_int [cos(e + f*x)^4*sqrt(a + b*sin(e + f*x)^2), x, 8, (2*(a + 3*b)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(15*b*f) - (cos(e + f*x)*sin(e + f*x)*(a + b*sin(e + f*x)^2)^(3/2))/(5*b*f) - ((2*a^2 + 7*a*b - 3*b^2)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(15*b^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (2*a*(a + b)*(a + 3*b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(15*b^2*f*sqrt(a + b*sin(e + f*x)^2)), (2*(a + 3*b)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(15*b*f) - (cos(e + f*x)*sin(e + f*x)*(a + b*sin(e + f*x)^2)^(3/2))/(5*b*f) - ((2*a^2 + 7*a*b - 3*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(15*b^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (2*a*(a + b)*(a + 3*b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(15*b^2*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2), x, 7, (cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f) - ((a - b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*b*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (a*(a + b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b*f*sqrt(a + b*sin(e + f*x)^2)), (cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f) - ((a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*b*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (a*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^0*sqrt(a + b*sin(e + f*x)^2), x, 2, (Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(f*sqrt(1 + (b*sin(e + f*x)^2)/a))]
    @test_int [sec(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2), x, 8, -((Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + (a*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2)) + (sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/f, -((sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + (a*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2)) + (sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/f]
    @test_int [sec(e + f*x)^4*sqrt(a + b*sin(e + f*x)^2), x, 8, -(((2*a + b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + (2*a*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2)) + ((2*a + b)*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*(a + b)*f) + (sec(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*f), -(((2*a + b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + (2*a*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2)) + ((2*a + b)*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*(a + b)*f) + (sec(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*f)]
    ...
    @test_int [cos(e + f*x)^4*(a + b*sin(e + f*x)^2)^(3/2), x, 9, -(((a^2 - 9*a*b - 2*b^2)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(35*b*f)) + (2*(4*a + b)*cos(e + f*x)^3*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(35*f) - (b*cos(e + f*x)^5*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(7*f) - (2*(a - b)*(a^2 + 6*a*b + b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(35*b^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (a*(a + b)*(2*a^2 + 9*a*b - b^2)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(35*b^2*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^2*(a + b*sin(e + f*x)^2)^(3/2), x, 8, (2*(3*a + b)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(15*f) - (b*cos(e + f*x)^3*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(5*f) - ((3*a^2 - 7*a*b - 2*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(15*b*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (a*(3*a - b)*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(15*b*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^0*(a + b*sin(e + f*x)^2)^(3/2), x, 6, -((b*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f)) + (2*(2*a + b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (a*(a + b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sec(e + f*x)^2*(a + b*sin(e + f*x)^2)^(3/2), x, 7, -(((a + 2*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + (a*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2)) + ((a + b)*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/f]
    @test_int [sec(e + f*x)^4*(a + b*sin(e + f*x)^2)^(3/2), x, 8, -((2*(a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + (a*(2*a - b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2)) + (2*(a - b)*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*f) + ((a + b)*sec(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*f)]
    ...
    @test_int [cos(e + f*x)^4/sqrt(a + b*sin(e + f*x)^2), x, 7, -((cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*b*f)) - (2*(a + 2*b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*b^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((a + b)*(2*a + 3*b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b^2*f*sqrt(a + b*sin(e + f*x)^2)), -((cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*b*f)) - (2*(a + 2*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*b^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((a + b)*(2*a + 3*b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b^2*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^2/sqrt(a + b*sin(e + f*x)^2), x, 6, -((a*Elliptic.E(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(b*f*sqrt(a + b*sin(e + f*x)^2))) + ((a + b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(b*f*sqrt(a + b*sin(e + f*x)^2)), -((sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(b*f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + ((a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(b*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^0/sqrt(a + b*sin(e + f*x)^2), x, 2, (Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sec(e + f*x)^2/sqrt(a + b*sin(e + f*x)^2), x, 8, -((Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/((a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + (Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2)) + (sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/((a + b)*f), -((sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/((a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + (sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2)) + (sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/((a + b)*f)]
    @test_int [sec(e + f*x)^4/sqrt(a + b*sin(e + f*x)^2), x, 8, -((2*(a + 2*b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*(a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + ((2*a + 3*b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) + (2*(a + 2*b)*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*(a + b)^2*f) + (sec(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*(a + b)*f), -((2*(a + 2*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*(a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + ((2*a + 3*b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) + (2*(a + 2*b)*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*(a + b)^2*f) + (sec(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*(a + b)*f)]
    ...
    @test_int [cos(e + f*x)^6/(a + b*sin(e + f*x)^2)^(3/2), x, 8, ((a + b)*cos(e + f*x)^3*sin(e + f*x))/(a*b*f*sqrt(a + b*sin(e + f*x)^2)) + ((4*a + 3*b)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a*b^2*f) + ((8*a^2 + 13*a*b + 3*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a*b^3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - ((a + b)*(8*a + 9*b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*b^3*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^4/(a + b*sin(e + f*x)^2)^(3/2), x, 7, ((a + b)*cos(e + f*x)*sin(e + f*x))/(a*b*f*sqrt(a + b*sin(e + f*x)^2)) + ((2*a + b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a*b^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (2*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(b^2*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^2/(a + b*sin(e + f*x)^2)^(3/2), x, 7, (cos(e + f*x)*sin(e + f*x))/(a*f*sqrt(a + b*sin(e + f*x)^2)) + (sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a*b*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(b*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^0/(a + b*sin(e + f*x)^2)^(3/2), x, 4, (b*cos(e + f*x)*sin(e + f*x))/(a*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) + (Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(a*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a))]
    @test_int [sec(e + f*x)^2/(a + b*sin(e + f*x)^2)^(3/2), x, 8, -(((a - b)*b*cos(e + f*x)*sin(e + f*x))/(a*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2))) - ((a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a*(a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/((a + b)*f*sqrt(a + b*sin(e + f*x)^2)) + tan(e + f*x)/((a + b)*f*sqrt(a + b*sin(e + f*x)^2))]
    ...
    @test_int [cos(e + f*x)^6/(a + b*sin(e + f*x)^2)^(5/2), x, 8, ((a + b)*cos(e + f*x)^3*sin(e + f*x))/(3*a*b*f*(a + b*sin(e + f*x)^2)^(3/2)) - (2*(2*a - b)*(a + b)*cos(e + f*x)*sin(e + f*x))/(3*a^2*b^2*f*sqrt(a + b*sin(e + f*x)^2)) - ((8*a^2 + 3*a*b - 2*b^2)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*b^3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((8*a - b)*(a + b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*b^3*f*sqrt(a + b*sin(e + f*x)^2)), ((a + b)*cos(e + f*x)^3*sin(e + f*x))/(3*a*b*f*(a + b*sin(e + f*x)^2)^(3/2)) - (2*(2*a - b)*(a + b)*cos(e + f*x)*sin(e + f*x))/(3*a^2*b^2*f*sqrt(a + b*sin(e + f*x)^2)) - ((8*a^2 + 3*a*b - 2*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*b^3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((8*a - b)*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*b^3*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^4/(a + b*sin(e + f*x)^2)^(5/2), x, 8, ((a + b)*cos(e + f*x)*sin(e + f*x))/(3*a*b*f*(a + b*sin(e + f*x)^2)^(3/2)) - (2*(a - b)*cos(e + f*x)*sin(e + f*x))/(3*a^2*b*f*sqrt(a + b*sin(e + f*x)^2)) - (2*(a - b)*Elliptic.E(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*b^2*f*sqrt(a + b*sin(e + f*x)^2)) + ((2*a - b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*b^2*f*sqrt(a + b*sin(e + f*x)^2)), ((a + b)*cos(e + f*x)*sin(e + f*x))/(3*a*b*f*(a + b*sin(e + f*x)^2)^(3/2)) - (2*(a - b)*cos(e + f*x)*sin(e + f*x))/(3*a^2*b*f*sqrt(a + b*sin(e + f*x)^2)) - (2*(a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*b^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((2*a - b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*b^2*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^2/(a + b*sin(e + f*x)^2)^(5/2), x, 8, (cos(e + f*x)*sin(e + f*x))/(3*a*f*(a + b*sin(e + f*x)^2)^(3/2)) + ((a + 2*b)*cos(e + f*x)*sin(e + f*x))/(3*a^2*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) + ((a + 2*b)*Elliptic.E(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*b*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) - (Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*b*f*sqrt(a + b*sin(e + f*x)^2)), (cos(e + f*x)*sin(e + f*x))/(3*a*f*(a + b*sin(e + f*x)^2)^(3/2)) + ((a + 2*b)*cos(e + f*x)*sin(e + f*x))/(3*a^2*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) + ((a + 2*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*b*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*b*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cos(e + f*x)^0/(a + b*sin(e + f*x)^2)^(5/2), x, 7, (b*cos(e + f*x)*sin(e + f*x))/(3*a*(a + b)*f*(a + b*sin(e + f*x)^2)^(3/2)) + (2*b*(2*a + b)*cos(e + f*x)*sin(e + f*x))/(3*a^2*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2)) + (2*(2*a + b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*(a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*(a + b)*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [sec(e + f*x)^2/(a + b*sin(e + f*x)^2)^(5/2), x, 9, -(((3*a - b)*b*cos(e + f*x)*sin(e + f*x))/(3*a*(a + b)^2*f*(a + b*sin(e + f*x)^2)^(3/2))) - (b*(3*a^2 - 7*a*b - 2*b^2)*cos(e + f*x)*sin(e + f*x))/(3*a^2*(a + b)^3*f*sqrt(a + b*sin(e + f*x)^2)) - ((3*a^2 - 7*a*b - 2*b^2)*Elliptic.E(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*(a + b)^3*f*sqrt(a + b*sin(e + f*x)^2)) + ((3*a - b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2)) + tan(e + f*x)/((a + b)*f*(a + b*sin(e + f*x)^2)^(3/2)), -(((3*a - b)*b*cos(e + f*x)*sin(e + f*x))/(3*a*(a + b)^2*f*(a + b*sin(e + f*x)^2)^(3/2))) - (b*(3*a^2 - 7*a*b - 2*b^2)*cos(e + f*x)*sin(e + f*x))/(3*a^2*(a + b)^3*f*sqrt(a + b*sin(e + f*x)^2)) - ((3*a^2 - 7*a*b - 2*b^2)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*(a + b)^3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((3*a - b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2)) + tan(e + f*x)/((a + b)*f*(a + b*sin(e + f*x)^2)^(3/2))]
    ...
    @test_int [cos(e + f*x)^5*(a + b*sin(e + f*x)^2)^p, x, 5, If(13>=8, -(((3*a + b*(7 + 2*p))*sin(e + f*x)*(a + b*sin(e + f*x)^2)^(1 + p))/(b^2*f*(3 + 2*p)*(5 + 2*p))) - (cos(e + f*x)^2*sin(e + f*x)*(a + b*sin(e + f*x)^2)^(1 + p))/(b*f*(5 + 2*p)) + ((3*a^2 + 2*a*b*(5 + 2*p) + b^2*(15 + 16*p + 4*p^2))*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*sin(e + f*x)^2)/a))*sin(e + f*x)*(a + b*sin(e + f*x)^2)^p)/((1 + (b*sin(e + f*x)^2)/a)^p*(b^2*f*(3 + 2*p)*(5 + 2*p))), -(((3*a + b*(7 + 2*p))*sin(e + f*x)*(a + b*sin(e + f*x)^2)^(1 + p))/(b^2*f*(15 + 16*p + 4*p^2))) - (cos(e + f*x)^2*sin(e + f*x)*(a + b*sin(e + f*x)^2)^(1 + p))/(b*f*(5 + 2*p)) + ((3*a^2 + 2*a*b*(5 + 2*p) + b^2*(15 + 16*p + 4*p^2))*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*sin(e + f*x)^2)/a))*sin(e + f*x)*(a + b*sin(e + f*x)^2)^p)/((1 + (b*sin(e + f*x)^2)/a)^p*(b^2*f*(15 + 16*p + 4*p^2))))]
    @test_int [cos(e + f*x)^3*(a + b*sin(e + f*x)^2)^p, x, 4, -((sin(e + f*x)*(a + b*sin(e + f*x)^2)^(1 + p))/(b*f*(3 + 2*p))) + ((a + b*(3 + 2*p))*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*sin(e + f*x)^2)/a))*sin(e + f*x)*(a + b*sin(e + f*x)^2)^p)/((1 + (b*sin(e + f*x)^2)/a)^p*(b*f*(3 + 2*p)))]
    @test_int [cos(e + f*x)^1*(a + b*sin(e + f*x)^2)^p, x, 3, (HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*sin(e + f*x)^2)/a))*sin(e + f*x)*(a + b*sin(e + f*x)^2)^p)/((1 + (b*sin(e + f*x)^2)/a)^p*f)]
    ...
    @test_int [cos(e + f*x)^5*(a + b*sin(e + f*x)^4)^p, x, 8, (sin(e + f*x)*(a + b*sin(e + f*x)^4)^(1 + p))/(b*f*(5 + 4*p)) - ((a - b*(5 + 4*p))*HypergeometricFunctions._₂F₁(1/4, -p, 5/4, -((b*sin(e + f*x)^4)/a))*sin(e + f*x)*(a + b*sin(e + f*x)^4)^p)/((1 + (b*sin(e + f*x)^4)/a)^p*(b*f*(5 + 4*p))) - (2*HypergeometricFunctions._₂F₁(3/4, -p, 7/4, -((b*sin(e + f*x)^4)/a))*sin(e + f*x)^3*(a + b*sin(e + f*x)^4)^p)/((1 + (b*sin(e + f*x)^4)/a)^p*(3*f))]
    @test_int [cos(e + f*x)^3*(a + b*sin(e + f*x)^4)^p, x, 7, (HypergeometricFunctions._₂F₁(1/4, -p, 5/4, -((b*sin(e + f*x)^4)/a))*sin(e + f*x)*(a + b*sin(e + f*x)^4)^p)/((1 + (b*sin(e + f*x)^4)/a)^p*f) - (HypergeometricFunctions._₂F₁(3/4, -p, 7/4, -((b*sin(e + f*x)^4)/a))*sin(e + f*x)^3*(a + b*sin(e + f*x)^4)^p)/((1 + (b*sin(e + f*x)^4)/a)^p*(3*f))]
    @test_int [cos(e + f*x)^1*(a + b*sin(e + f*x)^4)^p, x, 3, (HypergeometricFunctions._₂F₁(1/4, -p, 5/4, -((b*sin(e + f*x)^4)/a))*sin(e + f*x)*(a + b*sin(e + f*x)^4)^p)/((1 + (b*sin(e + f*x)^4)/a)^p*f)]
    ...
    @test_int [cos(e + f*x)^5*(a + b*sin(e + f*x)^n)^p, x, 9, (HypergeometricFunctions._₂F₁(1/n, -p, 1 + 1/n, -((b*sin(e + f*x)^n)/a))*sin(e + f*x)*(a + b*sin(e + f*x)^n)^p)/((1 + (b*sin(e + f*x)^n)/a)^p*f) - (2*HypergeometricFunctions._₂F₁(3/n, -p, (3 + n)/n, -((b*sin(e + f*x)^n)/a))*sin(e + f*x)^3*(a + b*sin(e + f*x)^n)^p)/((1 + (b*sin(e + f*x)^n)/a)^p*(3*f)) + (HypergeometricFunctions._₂F₁(5/n, -p, (5 + n)/n, -((b*sin(e + f*x)^n)/a))*sin(e + f*x)^5*(a + b*sin(e + f*x)^n)^p)/((1 + (b*sin(e + f*x)^n)/a)^p*(5*f))]
    @test_int [cos(e + f*x)^3*(a + b*sin(e + f*x)^n)^p, x, 7, (HypergeometricFunctions._₂F₁(1/n, -p, 1 + 1/n, -((b*sin(e + f*x)^n)/a))*sin(e + f*x)*(a + b*sin(e + f*x)^n)^p)/((1 + (b*sin(e + f*x)^n)/a)^p*f) - (HypergeometricFunctions._₂F₁(3/n, -p, (3 + n)/n, -((b*sin(e + f*x)^n)/a))*sin(e + f*x)^3*(a + b*sin(e + f*x)^n)^p)/((1 + (b*sin(e + f*x)^n)/a)^p*(3*f))]
    @test_int [cos(e + f*x)^1*(a + b*sin(e + f*x)^n)^p, x, 3, (HypergeometricFunctions._₂F₁(1/n, -p, 1 + 1/n, -((b*sin(e + f*x)^n)/a))*sin(e + f*x)*(a + b*sin(e + f*x)^n)^p)/((1 + (b*sin(e + f*x)^n)/a)^p*f)]
    ...
    @test_int [sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x)^4, x, 8, ((7*a + 8*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (4*a*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2)) - ((3*a + 4*b)*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*(a + b)*f) + (sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x)^3)/(3*f)]
    @test_int [sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x)^2, x, 7, -((2*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + (a*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2)) + (sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/f]
    @test_int [sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x)^0, x, 2, (Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(f*sqrt(1 + (b*sin(e + f*x)^2)/a))]
    @test_int [cot(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2), x, 7, -((cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/f) - (2*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + ((a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cot(e + f*x)^4*sqrt(a + b*sin(e + f*x)^2), x, 8, ((3*a - b)*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a*f) - (cot(e + f*x)^3*sqrt(a + b*sin(e + f*x)^2))/(3*f) + ((7*a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (4*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2))]
    ...
    @test_int [(a + b*sin(e + f*x)^2)^(3/2)*tan(e + f*x)^4, x, 9, -(((3*a + 8*b)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f)) + (8*(a + 2*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (a*(5*a + 8*b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2)) - ((a + 2*b)*sin(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/f + ((a + b*sin(e + f*x)^2)^(3/2)*tan(e + f*x)^3)/(3*f)]
    @test_int [(a + b*sin(e + f*x)^2)^(3/2)*tan(e + f*x)^2, x, 8, (4*b*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f) - ((7*a + 8*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (4*a*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2)) + ((a + b*sin(e + f*x)^2)^(3/2)*tan(e + f*x))/f]
    @test_int [(a + b*sin(e + f*x)^2)^(3/2)*tan(e + f*x)^0, x, 6, -((b*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f)) + (2*(2*a + b)*Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (a*(a + b)*Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cot(e + f*x)^2*(a + b*sin(e + f*x)^2)^(3/2), x, 8, (4*b*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f) - (cot(e + f*x)*(a + b*sin(e + f*x)^2)^(3/2))/f - ((7*a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (4*a*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cot(e + f*x)^4*(a + b*sin(e + f*x)^2)^(3/2), x, 9, ((a - b)*cos(e + f*x)^2*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/f + ((3*a - 5*b)*cos(e + f*x)*sin(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f) - (cot(e + f*x)^3*(a + b*sin(e + f*x)^2)^(3/2))/(3*f) + (8*(a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - ((5*a - 3*b)*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*f*sqrt(a + b*sin(e + f*x)^2))]
    ...
    @test_int [tan(e + f*x)^4/sqrt(a + b*sin(e + f*x)^2), x, 8, (2*(2*a + b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*(a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (a*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) - (2*(2*a + b)*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*(a + b)^2*f) + (sec(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/(3*(a + b)*f)]
    @test_int [tan(e + f*x)^2/sqrt(a + b*sin(e + f*x)^2), x, 4, -((sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/((a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a))) + (sqrt(a + b*sin(e + f*x)^2)*tan(e + f*x))/((a + b)*f)]
    @test_int [tan(e + f*x)^0/sqrt(a + b*sin(e + f*x)^2), x, 2, (Elliptic.F(e + f*x, -(b/a))*sqrt(1 + (b*sin(e + f*x)^2)/a))/(f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cot(e + f*x)^2/sqrt(a + b*sin(e + f*x)^2), x, 5, -((cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a*f)) - (sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a*f*sqrt(1 + (b*sin(e + f*x)^2)/a))]
    @test_int [cot(e + f*x)^4/sqrt(a + b*sin(e + f*x)^2), x, 8, (2*(2*a + b)*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*f) - (cot(e + f*x)*csc(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2))/(3*a*f) + (2*(2*a + b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - ((a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a*f*sqrt(a + b*sin(e + f*x)^2))]
    ...
    @test_int [tan(e + f*x)^4/(a + b*sin(e + f*x)^2)^(3/2), x, 9, ((7*a - b)*b*cos(e + f*x)*sin(e + f*x))/(3*(a + b)^3*f*sqrt(a + b*sin(e + f*x)^2)) + ((7*a - b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*(a + b)^3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (4*a*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2)) - (4*a*tan(e + f*x))/(3*(a + b)^2*f*sqrt(a + b*sin(e + f*x)^2)) + (sec(e + f*x)^2*tan(e + f*x))/(3*(a + b)*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [tan(e + f*x)^2/(a + b*sin(e + f*x)^2)^(3/2), x, 8, -((2*b*cos(e + f*x)*sin(e + f*x))/((a + b)^2*f*sqrt(a + b*sin(e + f*x)^2))) - (2*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/((a + b)^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/((a + b)*f*sqrt(a + b*sin(e + f*x)^2)) + tan(e + f*x)/((a + b)*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [tan(e + f*x)^0/(a + b*sin(e + f*x)^2)^(3/2), x, 4, (b*cos(e + f*x)*sin(e + f*x))/(a*(a + b)*f*sqrt(a + b*sin(e + f*x)^2)) + (Elliptic.E(e + f*x, -(b/a))*sqrt(a + b*sin(e + f*x)^2))/(a*(a + b)*f*sqrt(1 + (b*sin(e + f*x)^2)/a))]
    @test_int [cot(e + f*x)^2/(a + b*sin(e + f*x)^2)^(3/2), x, 8, cot(e + f*x)/(a*f*sqrt(a + b*sin(e + f*x)^2)) - (2*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a^2*f) - (2*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(a^2*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) + (sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(a*f*sqrt(a + b*sin(e + f*x)^2))]
    @test_int [cot(e + f*x)^4/(a + b*sin(e + f*x)^2)^(3/2), x, 9, ((a + b)*cot(e + f*x)*csc(e + f*x)^2)/(a*b*f*sqrt(a + b*sin(e + f*x)^2)) + ((7*a + 8*b)*cot(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^3*f) - ((3*a + 4*b)*cot(e + f*x)*csc(e + f*x)^2*sqrt(a + b*sin(e + f*x)^2))/(3*a^2*b*f) + ((7*a + 8*b)*sqrt(cos(e + f*x)^2)*Elliptic.E(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(a + b*sin(e + f*x)^2))/(3*a^3*f*sqrt(1 + (b*sin(e + f*x)^2)/a)) - (4*(a + b)*sqrt(cos(e + f*x)^2)*Elliptic.F(asin(sin(e + f*x)), -(b/a))*sec(e + f*x)*sqrt(1 + (b*sin(e + f*x)^2)/a))/(3*a^2*f*sqrt(a + b*sin(e + f*x)^2))]
    ...
    @test_int [tan(c + d*x)^3*(a + b*sin(c + d*x)^2)^p, x, 3, -(((a + b + b*p)*HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, (a + b*sin(c + d*x)^2)/(a + b))*(a + b*sin(c + d*x)^2)^(1 + p))/(2*(a + b)^2*d*(1 + p))) + (sec(c + d*x)^2*(a + b*sin(c + d*x)^2)^(1 + p))/(2*(a + b)*d)]
    @test_int [tan(c + d*x)^1*(a + b*sin(c + d*x)^2)^p, x, 2, (HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, (a + b*sin(c + d*x)^2)/(a + b))*(a + b*sin(c + d*x)^2)^(1 + p))/(2*(a + b)*d*(1 + p))]
    @test_int [cot(c + d*x)^1*(a + b*sin(c + d*x)^2)^p, x, 2, -((HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, 1 + (b*sin(c + d*x)^2)/a)*(a + b*sin(c + d*x)^2)^(1 + p))/(2*a*d*(1 + p)))]
    @test_int [cot(c + d*x)^3*(a + b*sin(c + d*x)^2)^p, x, 3, -((csc(c + d*x)^2*(a + b*sin(c + d*x)^2)^(1 + p))/(2*a*d)) + ((a - b*p)*HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, 1 + (b*sin(c + d*x)^2)/a)*(a + b*sin(c + d*x)^2)^(1 + p))/(2*a^2*d*(1 + p))]
    ...
    @test_int [tan(c + d*x)^0/sqrt(a + b*sin(c + d*x)^4), x, 2, (cos(c + d*x)^2*Elliptic.F(2*atan(((a + b)^(1/4)*tan(c + d*x))/a^(1/4)), (1/2)*(1 - sqrt(a)/sqrt(a + b)))*(sqrt(a) + sqrt(a + b)*tan(c + d*x)^2)*sqrt((a + 2*a*tan(c + d*x)^2 + (a + b)*tan(c + d*x)^4)/(sqrt(a) + sqrt(a + b)*tan(c + d*x)^2)^2))/(2*a^(1/4)*(a + b)^(1/4)*d*sqrt(a + b*sin(c + d*x)^4))]
    ...
    @test_int [tan(c + d*x)^3*(a + b*sin(c + d*x)^4)^p, x, 11, -(((a + b + 2*b*p)*HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, (a + b*sin(c + d*x)^4)/(a + b))*(a + b*sin(c + d*x)^4)^(1 + p))/(4*(a + b)^2*d*(1 + p))) + (sec(c + d*x)^2*(a + b*sin(c + d*x)^4)^(1 + p))/(2*(a + b)*d) - ((a + b + 2*b*p)*AppellF1(1/2, 1, -p, 3/2, sin(c + d*x)^4, -((b*sin(c + d*x)^4)/a))*sin(c + d*x)^2*(a + b*sin(c + d*x)^4)^p)/((1 + (b*sin(c + d*x)^4)/a)^p*(2*(a + b)*d)) + (b*(1 + 2*p)*HypergeometricFunctions._₂F₁(1/2, -p, 3/2, -((b*sin(c + d*x)^4)/a))*sin(c + d*x)^2*(a + b*sin(c + d*x)^4)^p)/((1 + (b*sin(c + d*x)^4)/a)^p*(2*(a + b)*d))]
    @test_int [tan(c + d*x)^1*(a + b*sin(c + d*x)^4)^p, x, 7, (HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, (a + b*sin(c + d*x)^4)/(a + b))*(a + b*sin(c + d*x)^4)^(1 + p))/(4*(a + b)*d*(1 + p)) + (AppellF1(1/2, 1, -p, 3/2, sin(c + d*x)^4, -((b*sin(c + d*x)^4)/a))*sin(c + d*x)^2*(a + b*sin(c + d*x)^4)^p)/((1 + (b*sin(c + d*x)^4)/a)^p*(2*d))]
    @test_int [cot(c + d*x)^1*(a + b*sin(c + d*x)^4)^p, x, 3, -((HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, 1 + (b*sin(c + d*x)^4)/a)*(a + b*sin(c + d*x)^4)^(1 + p))/(4*a*d*(1 + p)))]
    @test_int [cot(c + d*x)^3*(a + b*sin(c + d*x)^4)^p, x, 6, (HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, 1 + (b*sin(c + d*x)^4)/a)*(a + b*sin(c + d*x)^4)^(1 + p))/(4*a*d*(1 + p)) - (csc(c + d*x)^2*HypergeometricFunctions._₂F₁(-(1/2), -p, 1/2, -((b*sin(c + d*x)^4)/a))*(a + b*sin(c + d*x)^4)^p)/((1 + (b*sin(c + d*x)^4)/a)^p*(2*d))]
    ...
    @test_int [tan(c + d*x)^m*(a + b*sin(c + d*x)^n)^3, x, 10, (a^3*HypergeometricFunctions._₂F₁(1, (1 + m)/2, (3 + m)/2, -tan(c + d*x)^2)*tan(c + d*x)^(1 + m))/(d*(1 + m)) + (3*a^2*b*(cos(c + d*x)^2)^((1 + m)/2)*HypergeometricFunctions._₂F₁((1 + m)/2, (1/2)*(1 + m + n), (1/2)*(3 + m + n), sin(c + d*x)^2)*sin(c + d*x)^n*tan(c + d*x)^(1 + m))/(d*(1 + m + n)) + (3*a*b^2*(cos(c + d*x)^2)^((1 + m)/2)*HypergeometricFunctions._₂F₁((1 + m)/2, (1/2)*(1 + m + 2*n), (1/2)*(3 + m + 2*n), sin(c + d*x)^2)*sin(c + d*x)^(2*n)*tan(c + d*x)^(1 + m))/(d*(1 + m + 2*n)) + (b^3*(cos(c + d*x)^2)^((1 + m)/2)*HypergeometricFunctions._₂F₁((1 + m)/2, (1/2)*(1 + m + 3*n), (1/2)*(3 + m + 3*n), sin(c + d*x)^2)*sin(c + d*x)^(3*n)*tan(c + d*x)^(1 + m))/(d*(1 + m + 3*n))]
    @test_int [tan(c + d*x)^m*(a + b*sin(c + d*x)^n)^2, x, 8, (a^2*HypergeometricFunctions._₂F₁(1, (1 + m)/2, (3 + m)/2, -tan(c + d*x)^2)*tan(c + d*x)^(1 + m))/(d*(1 + m)) + (2*a*b*(cos(c + d*x)^2)^((1 + m)/2)*HypergeometricFunctions._₂F₁((1 + m)/2, (1/2)*(1 + m + n), (1/2)*(3 + m + n), sin(c + d*x)^2)*sin(c + d*x)^n*tan(c + d*x)^(1 + m))/(d*(1 + m + n)) + (b^2*(cos(c + d*x)^2)^((1 + m)/2)*HypergeometricFunctions._₂F₁((1 + m)/2, (1/2)*(1 + m + 2*n), (1/2)*(3 + m + 2*n), sin(c + d*x)^2)*sin(c + d*x)^(2*n)*tan(c + d*x)^(1 + m))/(d*(1 + m + 2*n))]
    @test_int [tan(c + d*x)^m*(a + b*sin(c + d*x)^n)^1, x, 6, (a*HypergeometricFunctions._₂F₁(1, (1 + m)/2, (3 + m)/2, -tan(c + d*x)^2)*tan(c + d*x)^(1 + m))/(d*(1 + m)) + (b*(cos(c + d*x)^2)^((1 + m)/2)*HypergeometricFunctions._₂F₁((1 + m)/2, (1/2)*(1 + m + n), (1/2)*(3 + m + n), sin(c + d*x)^2)*sin(c + d*x)^n*tan(c + d*x)^(1 + m))/(d*(1 + m + n))]
    ...
    @test_int [cot(c + d*x)^1*(a + b*sin(c + d*x)^n)^p, x, 3, -((HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, 1 + (b*sin(c + d*x)^n)/a)*(a + b*sin(c + d*x)^n)^(1 + p))/(a*d*n*(1 + p)))]
    @test_int [cot(c + d*x)^3*(a + b*sin(c + d*x)^n)^p, x, 7, (HypergeometricFunctions._₂F₁(1, 1 + p, 2 + p, 1 + (b*sin(c + d*x)^n)/a)*(a + b*sin(c + d*x)^n)^(1 + p))/(a*d*n*(1 + p)) - (csc(c + d*x)^2*HypergeometricFunctions._₂F₁(-(2/n), -p, -((2 - n)/n), -((b*sin(c + d*x)^n)/a))*(a + b*sin(c + d*x)^n)^p)/((1 + (b*sin(c + d*x)^n)/a)^p*(2*d))]
    ...
    @test_int [(a + b*sin(e + f*x)^2)/((g*cos(e + f*x))^(5/2)*sqrt(d*sin(e + f*x))), x, 7, (2*(a + b)*sqrt(d*sin(e + f*x)))/(3*d*f*g*(g*cos(e + f*x))^(3/2)) + ((2*a - b)*Elliptic.F(e - pi/4 + f*x, 2)*sqrt(sin(2*e + 2*f*x)))/(3*f*g^2*sqrt(g*cos(e + f*x))*sqrt(d*sin(e + f*x))), (2*(a + b)*sqrt(d*sin(e + f*x)))/(3*d*f*g*(g*cos(e + f*x))^(3/2)) - (2*(2*a - b)*(1 - csc(e + f*x)^2)^(3/4)*Elliptic.F((1/2)*acsc(sin(e + f*x)), 2)*(d*sin(e + f*x))^(3/2))/(3*d^2*f*g*(g*cos(e + f*x))^(3/2))]
    ...
    @test_int [sqrt(a + (b*sin(e+f*x) + c*cos(e+f*x))^2), x, 3, (Elliptic.E(e + f*x + atan(b, c), -((b^2 + c^2)/a))*sqrt(a + (c*cos(e + f*x) + b*sin(e + f*x))^2))/(f*sqrt(1 + (c*cos(e + f*x) + b*sin(e + f*x))^2/a))]


    @test_int [1/sqrt(a + (b*sin(e+f*x) + c*cos(e+f*x))^2), x, 3, (Elliptic.F(e + f*x + atan(b, c), -((b^2 + c^2)/a))*sqrt(1 + (c*cos(e + f*x) + b*sin(e + f*x))^2/a))/(f*sqrt(a + (c*cos(e + f*x) + b*sin(e + f*x))^2))]
    end
