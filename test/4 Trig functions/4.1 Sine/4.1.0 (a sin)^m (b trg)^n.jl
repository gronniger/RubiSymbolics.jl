@testset "4.1.0 (a sin)^m (b trg)^n" begin
    ...
    @test_int [sin(b*x)^(7/2), x, 3, -((10*Elliptic.F(pi/4 - (b*x)/2, 2))/(21*b)) - (10*cos(b*x)*sqrt(sin(b*x)))/(21*b) - (2*cos(b*x)*sin(b*x)^(5/2))/(7*b)]
    @test_int [sin(b*x)^(5/2), x, 2, -((6*Elliptic.E(pi/4 - (b*x)/2, 2))/(5*b)) - (2*cos(b*x)*sin(b*x)^(3/2))/(5*b)]
    @test_int [sin(b*x)^(3/2), x, 2, -((2*Elliptic.F(pi/4 - (b*x)/2, 2))/(3*b)) - (2*cos(b*x)*sqrt(sin(b*x)))/(3*b)]
    @test_int [sin(b*x)^(1/2), x, 1, -((2*Elliptic.E(pi/4 - (b*x)/2, 2))/b)]
    @test_int [1/sin(b*x)^(1/2), x, 1, -((2*Elliptic.F(pi/4 - (b*x)/2, 2))/b)]
    @test_int [1/sin(b*x)^(3/2), x, 2, (2*Elliptic.E(pi/4 - (b*x)/2, 2))/b - (2*cos(b*x))/(b*sqrt(sin(b*x)))]
    @test_int [1/sin(b*x)^(5/2), x, 2, -((2*Elliptic.F(pi/4 - (b*x)/2, 2))/(3*b)) - (2*cos(b*x))/(3*b*sin(b*x)^(3/2))]
    @test_int [1/sin(b*x)^(7/2), x, 3, (6*Elliptic.E(pi/4 - (b*x)/2, 2))/(5*b) - (2*cos(b*x))/(5*b*sin(b*x)^(5/2)) - (6*cos(b*x))/(5*b*sqrt(sin(b*x)))]


    @test_int [sin(a + b*x)^(7/2), x, 3, (10*Elliptic.F((1/2)*(a - pi/2 + b*x), 2))/(21*b) - (10*cos(a + b*x)*sqrt(sin(a + b*x)))/(21*b) - (2*cos(a + b*x)*sin(a + b*x)^(5/2))/(7*b)]
    @test_int [sin(a + b*x)^(5/2), x, 2, (6*Elliptic.E((1/2)*(a - pi/2 + b*x), 2))/(5*b) - (2*cos(a + b*x)*sin(a + b*x)^(3/2))/(5*b)]
    @test_int [sin(a + b*x)^(3/2), x, 2, (2*Elliptic.F((1/2)*(a - pi/2 + b*x), 2))/(3*b) - (2*cos(a + b*x)*sqrt(sin(a + b*x)))/(3*b)]
    @test_int [sin(a + b*x)^(1/2), x, 1, (2*Elliptic.E((1/2)*(a - pi/2 + b*x), 2))/b]
    @test_int [1/sin(a + b*x)^(1/2), x, 1, (2*Elliptic.F((1/2)*(a - pi/2 + b*x), 2))/b]
    @test_int [1/sin(a + b*x)^(3/2), x, 2, -((2*Elliptic.E((1/2)*(a - pi/2 + b*x), 2))/b) - (2*cos(a + b*x))/(b*sqrt(sin(a + b*x)))]
    @test_int [1/sin(a + b*x)^(5/2), x, 2, (2*Elliptic.F((1/2)*(a - pi/2 + b*x), 2))/(3*b) - (2*cos(a + b*x))/(3*b*sin(a + b*x)^(3/2))]
    @test_int [1/sin(a + b*x)^(7/2), x, 3, -((6*Elliptic.E((1/2)*(a - pi/2 + b*x), 2))/(5*b)) - (2*cos(a + b*x))/(5*b*sin(a + b*x)^(5/2)) - (6*cos(a + b*x))/(5*b*sqrt(sin(a + b*x)))]


    @test_int [(c*sin(a + b*x))^(7/2), x, 4, (10*c^4*Elliptic.F((1/2)*(a - pi/2 + b*x), 2)*sqrt(sin(a + b*x)))/(21*b*sqrt(c*sin(a + b*x))) - (10*c^3*cos(a + b*x)*sqrt(c*sin(a + b*x)))/(21*b) - (2*c*cos(a + b*x)*(c*sin(a + b*x))^(5/2))/(7*b)]
    @test_int [(c*sin(a + b*x))^(5/2), x, 3, (6*c^2*Elliptic.E((1/2)*(a - pi/2 + b*x), 2)*sqrt(c*sin(a + b*x)))/(5*b*sqrt(sin(a + b*x))) - (2*c*cos(a + b*x)*(c*sin(a + b*x))^(3/2))/(5*b)]
    @test_int [(c*sin(a + b*x))^(3/2), x, 3, (2*c^2*Elliptic.F((1/2)*(a - pi/2 + b*x), 2)*sqrt(sin(a + b*x)))/(3*b*sqrt(c*sin(a + b*x))) - (2*c*cos(a + b*x)*sqrt(c*sin(a + b*x)))/(3*b)]
    @test_int [(c*sin(a + b*x))^(1/2), x, 2, (2*Elliptic.E((1/2)*(a - pi/2 + b*x), 2)*sqrt(c*sin(a + b*x)))/(b*sqrt(sin(a + b*x)))]
    @test_int [1/(c*sin(a + b*x))^(1/2), x, 2, (2*Elliptic.F((1/2)*(a - pi/2 + b*x), 2)*sqrt(sin(a + b*x)))/(b*sqrt(c*sin(a + b*x)))]
    @test_int [1/(c*sin(a + b*x))^(3/2), x, 3, -((2*cos(a + b*x))/(b*c*sqrt(c*sin(a + b*x)))) - (2*Elliptic.E((1/2)*(a - pi/2 + b*x), 2)*sqrt(c*sin(a + b*x)))/(b*c^2*sqrt(sin(a + b*x)))]
    @test_int [1/(c*sin(a + b*x))^(5/2), x, 3, -((2*cos(a + b*x))/(3*b*c*(c*sin(a + b*x))^(3/2))) + (2*Elliptic.F((1/2)*(a - pi/2 + b*x), 2)*sqrt(sin(a + b*x)))/(3*b*c^2*sqrt(c*sin(a + b*x)))]
    @test_int [1/(c*sin(a + b*x))^(7/2), x, 4, -((2*cos(a + b*x))/(5*b*c*(c*sin(a + b*x))^(5/2))) - (6*cos(a + b*x))/(5*b*c^3*sqrt(c*sin(a + b*x))) - (6*Elliptic.E((1/2)*(a - pi/2 + b*x), 2)*sqrt(c*sin(a + b*x)))/(5*b*c^4*sqrt(sin(a + b*x)))]
    ...
    @test_int [(c*sin(a + b*x))^(4/3), x, 1, (3*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, 7/6, 13/6, sin(a + b*x)^2)*(c*sin(a + b*x))^(7/3))/(7*b*c*sqrt(cos(a + b*x)^2))]
    @test_int [(c*sin(a + b*x))^(2/3), x, 1, (3*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, 5/6, 11/6, sin(a + b*x)^2)*(c*sin(a + b*x))^(5/3))/(5*b*c*sqrt(cos(a + b*x)^2))]
    @test_int [(c*sin(a + b*x))^(1/3), x, 1, -((3*sqrt((3/2)*(3 - im*sqrt(3)))*c^(1/3)*Elliptic.E(asin((sqrt(2)*sqrt(1 - (c*sin(a + b*x))^(2/3)/c^(2/3)))/sqrt(3 + im*sqrt(3))), (3*im - sqrt(3))/(3*im + sqrt(3)))*sec(a + b*x)*sqrt(1 - (c*sin(a + b*x))^(2/3)/c^(2/3))*sqrt((im + sqrt(3))/(3*im + sqrt(3)) + (2*(c*sin(a + b*x))^(2/3))/((3 - im*sqrt(3))*c^(2/3)))*sqrt((im - sqrt(3))/(3*im - sqrt(3)) + (2*(c*sin(a + b*x))^(2/3))/((3 + im*sqrt(3))*c^(2/3))))/b) + (3*(1 - im*sqrt(3))*sqrt(3 - im*sqrt(3))*c^(1/3)*Elliptic.F(asin((sqrt(2)*sqrt(1 - (c*sin(a + b*x))^(2/3)/c^(2/3)))/sqrt(3 - im*sqrt(3))), (3*im + sqrt(3))/(3*im - sqrt(3)))*sec(a + b*x)*sqrt(1 - (c*sin(a + b*x))^(2/3)/c^(2/3))*sqrt((im + sqrt(3))/(3*im + sqrt(3)) + (2*(c*sin(a + b*x))^(2/3))/((3 - im*sqrt(3))*c^(2/3)))*sqrt((im - sqrt(3))/(3*im - sqrt(3)) + (2*(c*sin(a + b*x))^(2/3))/((3 + im*sqrt(3))*c^(2/3))))/(2*sqrt(2)*b), (3*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, 2/3, 5/3, sin(a + b*x)^2)*(c*sin(a + b*x))^(4/3))/(4*b*c*sqrt(cos(a + b*x)^2))]
    @test_int [1/(c*sin(a + b*x))^(1/3), x, 1, -((3*sqrt(3 - im*sqrt(3))*Elliptic.F(asin((sqrt(2)*sqrt(1 - (c*sin(a + b*x))^(2/3)/c^(2/3)))/sqrt(3 - im*sqrt(3))), (3*im + sqrt(3))/(3*im - sqrt(3)))*sec(a + b*x)*sqrt(1 - (c*sin(a + b*x))^(2/3)/c^(2/3))*sqrt((im + sqrt(3))/(3*im + sqrt(3)) + (2*(c*sin(a + b*x))^(2/3))/((3 - im*sqrt(3))*c^(2/3)))*sqrt((im - sqrt(3))/(3*im - sqrt(3)) + (2*(c*sin(a + b*x))^(2/3))/((3 + im*sqrt(3))*c^(2/3))))/(sqrt(2)*b*c^(1/3))), (3*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/3, 1/2, 4/3, sin(a + b*x)^2)*(c*sin(a + b*x))^(2/3))/(2*b*c*sqrt(cos(a + b*x)^2))]
    @test_int [1/(c*sin(a + b*x))^(2/3), x, 1, (3^(3/4)*Elliptic.F(acos((c^(2/3) - (1 - sqrt(3))*(c*sin(a + b*x))^(2/3))/(c^(2/3) - (1 + sqrt(3))*(c*sin(a + b*x))^(2/3))), (1/4)*(2 + sqrt(3)))*sec(a + b*x)*(c*sin(a + b*x))^(1/3)*(c^(2/3) - (c*sin(a + b*x))^(2/3))*sqrt((c^(4/3)*(1 + (c*sin(a + b*x))^(2/3)/c^(2/3) + (c*sin(a + b*x))^(4/3)/c^(4/3)))/(c^(2/3) - (1 + sqrt(3))*(c*sin(a + b*x))^(2/3))^2))/(2*b*c^(5/3)*sqrt(-(((c*sin(a + b*x))^(2/3)*(c^(2/3) - (c*sin(a + b*x))^(2/3)))/(c^(2/3) - (1 + sqrt(3))*(c*sin(a + b*x))^(2/3))^2))), (3*cos(a + b*x)*HypergeometricFunctions._₂F₁(1/6, 1/2, 7/6, sin(a + b*x)^2)*(c*sin(a + b*x))^(1/3))/(b*c*sqrt(cos(a + b*x)^2))]
    @test_int [1/(c*sin(a + b*x))^(4/3), x, 1, -((3*cos(a + b*x)*HypergeometricFunctions._₂F₁(-(1/6), 1/2, 5/6, sin(a + b*x)^2))/(b*c*sqrt(cos(a + b*x)^2)*(c*sin(a + b*x))^(1/3)))]
    ...
    @test_int [sin(a + b*x)^n, x, 1, (cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (1 + n)/2, (3 + n)/2, sin(a + b*x)^2)*sin(a + b*x)^(1 + n))/(b*(1 + n)*sqrt(cos(a + b*x)^2))]
    @test_int [(c*sin(a + b*x))^n, x, 1, (cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (1 + n)/2, (3 + n)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + n))/(b*c*(1 + n)*sqrt(cos(a + b*x)^2))]
    ...
    @test_int [(a*sin(e + f*x))^m*(b*sin(e + f*x))^n, x, 2, (cos(e + f*x)*HypergeometricFunctions._₂F₁(1/2, (1/2)*(1 + m + n), (1/2)*(3 + m + n), sin(e + f*x)^2)*(a*sin(e + f*x))^(1 + m)*(b*sin(e + f*x))^n)/(a*f*(1 + m + n)*sqrt(cos(e + f*x)^2))]
    ...
    @test_int [sin(a + b*x)^2*(d*cos(a + b*x))^(9/2), x, 5, (28*d^4*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(195*b*sqrt(cos(a + b*x))) + (28*d^3*(d*cos(a + b*x))^(3/2)*sin(a + b*x))/(585*b) + (4*d*(d*cos(a + b*x))^(7/2)*sin(a + b*x))/(117*b) - (2*(d*cos(a + b*x))^(11/2)*sin(a + b*x))/(13*b*d)]
    @test_int [sin(a + b*x)^2*(d*cos(a + b*x))^(7/2), x, 5, (20*d^4*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(231*b*sqrt(d*cos(a + b*x))) + (20*d^3*sqrt(d*cos(a + b*x))*sin(a + b*x))/(231*b) + (4*d*(d*cos(a + b*x))^(5/2)*sin(a + b*x))/(77*b) - (2*(d*cos(a + b*x))^(9/2)*sin(a + b*x))/(11*b*d)]
    @test_int [sin(a + b*x)^2*(d*cos(a + b*x))^(5/2), x, 4, (4*d^2*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(15*b*sqrt(cos(a + b*x))) + (4*d*(d*cos(a + b*x))^(3/2)*sin(a + b*x))/(45*b) - (2*(d*cos(a + b*x))^(7/2)*sin(a + b*x))/(9*b*d)]
    @test_int [sin(a + b*x)^2*(d*cos(a + b*x))^(3/2), x, 4, (4*d^2*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(21*b*sqrt(d*cos(a + b*x))) + (4*d*sqrt(d*cos(a + b*x))*sin(a + b*x))/(21*b) - (2*(d*cos(a + b*x))^(5/2)*sin(a + b*x))/(7*b*d)]
    @test_int [sin(a + b*x)^2*(d*cos(a + b*x))^(1/2), x, 3, (4*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(5*b*sqrt(cos(a + b*x))) - (2*(d*cos(a + b*x))^(3/2)*sin(a + b*x))/(5*b*d)]
    @test_int [sin(a + b*x)^2/(d*cos(a + b*x))^(1/2), x, 3, (4*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(3*b*sqrt(d*cos(a + b*x))) - (2*sqrt(d*cos(a + b*x))*sin(a + b*x))/(3*b*d)]
    @test_int [sin(a + b*x)^2/(d*cos(a + b*x))^(3/2), x, 3, -((4*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(b*d^2*sqrt(cos(a + b*x)))) + (2*sin(a + b*x))/(b*d*sqrt(d*cos(a + b*x)))]
    @test_int [sin(a + b*x)^2/(d*cos(a + b*x))^(5/2), x, 3, -((4*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(3*b*d^2*sqrt(d*cos(a + b*x)))) + (2*sin(a + b*x))/(3*b*d*(d*cos(a + b*x))^(3/2))]
    @test_int [sin(a + b*x)^2/(d*cos(a + b*x))^(7/2), x, 4, (4*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(5*b*d^4*sqrt(cos(a + b*x))) + (2*sin(a + b*x))/(5*b*d*(d*cos(a + b*x))^(5/2)) - (4*sin(a + b*x))/(5*b*d^3*sqrt(d*cos(a + b*x)))]
    @test_int [sin(a + b*x)^2/(d*cos(a + b*x))^(9/2), x, 4, -((4*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(21*b*d^4*sqrt(d*cos(a + b*x)))) + (2*sin(a + b*x))/(7*b*d*(d*cos(a + b*x))^(7/2)) - (4*sin(a + b*x))/(21*b*d^3*(d*cos(a + b*x))^(3/2))]
    ...
    @test_int [sin(a + b*x)^4*(d*cos(a + b*x))^(9/2), x, 6, (56*d^4*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(1105*b*sqrt(cos(a + b*x))) + (56*d^3*(d*cos(a + b*x))^(3/2)*sin(a + b*x))/(3315*b) + (8*d*(d*cos(a + b*x))^(7/2)*sin(a + b*x))/(663*b) - (12*(d*cos(a + b*x))^(11/2)*sin(a + b*x))/(221*b*d) - (2*(d*cos(a + b*x))^(11/2)*sin(a + b*x)^3)/(17*b*d)]
    @test_int [sin(a + b*x)^4*(d*cos(a + b*x))^(7/2), x, 6, (8*d^4*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(231*b*sqrt(d*cos(a + b*x))) + (8*d^3*sqrt(d*cos(a + b*x))*sin(a + b*x))/(231*b) + (8*d*(d*cos(a + b*x))^(5/2)*sin(a + b*x))/(385*b) - (4*(d*cos(a + b*x))^(9/2)*sin(a + b*x))/(55*b*d) - (2*(d*cos(a + b*x))^(9/2)*sin(a + b*x)^3)/(15*b*d)]
    @test_int [sin(a + b*x)^4*(d*cos(a + b*x))^(5/2), x, 5, (8*d^2*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(65*b*sqrt(cos(a + b*x))) + (8*d*(d*cos(a + b*x))^(3/2)*sin(a + b*x))/(195*b) - (4*(d*cos(a + b*x))^(7/2)*sin(a + b*x))/(39*b*d) - (2*(d*cos(a + b*x))^(7/2)*sin(a + b*x)^3)/(13*b*d)]
    @test_int [sin(a + b*x)^4*(d*cos(a + b*x))^(3/2), x, 5, (8*d^2*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(77*b*sqrt(d*cos(a + b*x))) + (8*d*sqrt(d*cos(a + b*x))*sin(a + b*x))/(77*b) - (12*(d*cos(a + b*x))^(5/2)*sin(a + b*x))/(77*b*d) - (2*(d*cos(a + b*x))^(5/2)*sin(a + b*x)^3)/(11*b*d)]
    @test_int [sin(a + b*x)^4*(d*cos(a + b*x))^(1/2), x, 4, (8*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(15*b*sqrt(cos(a + b*x))) - (4*(d*cos(a + b*x))^(3/2)*sin(a + b*x))/(15*b*d) - (2*(d*cos(a + b*x))^(3/2)*sin(a + b*x)^3)/(9*b*d)]
    @test_int [sin(a + b*x)^4/(d*cos(a + b*x))^(1/2), x, 4, (8*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(7*b*sqrt(d*cos(a + b*x))) - (4*sqrt(d*cos(a + b*x))*sin(a + b*x))/(7*b*d) - (2*sqrt(d*cos(a + b*x))*sin(a + b*x)^3)/(7*b*d)]
    @test_int [sin(a + b*x)^4/(d*cos(a + b*x))^(3/2), x, 4, -((24*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(5*b*d^2*sqrt(cos(a + b*x)))) + (12*(d*cos(a + b*x))^(3/2)*sin(a + b*x))/(5*b*d^3) + (2*sin(a + b*x)^3)/(b*d*sqrt(d*cos(a + b*x)))]
    @test_int [sin(a + b*x)^4/(d*cos(a + b*x))^(5/2), x, 4, -((8*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(3*b*d^2*sqrt(d*cos(a + b*x)))) + (4*sqrt(d*cos(a + b*x))*sin(a + b*x))/(3*b*d^3) + (2*sin(a + b*x)^3)/(3*b*d*(d*cos(a + b*x))^(3/2))]
    @test_int [sin(a + b*x)^4/(d*cos(a + b*x))^(7/2), x, 4, (24*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(5*b*d^4*sqrt(cos(a + b*x))) - (12*sin(a + b*x))/(5*b*d^3*sqrt(d*cos(a + b*x))) + (2*sin(a + b*x)^3)/(5*b*d*(d*cos(a + b*x))^(5/2))]
    @test_int [sin(a + b*x)^4/(d*cos(a + b*x))^(9/2), x, 4, (8*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(7*b*d^4*sqrt(d*cos(a + b*x))) - (4*sin(a + b*x))/(7*b*d^3*(d*cos(a + b*x))^(3/2)) + (2*sin(a + b*x)^3)/(7*b*d*(d*cos(a + b*x))^(7/2))]
    ...
    @test_int [csc(a + b*x)^2*(d*cos(a + b*x))^(11/2), x, 5, -((d*(d*cos(a + b*x))^(9/2)*csc(a + b*x))/b) - (15*d^6*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(7*b*sqrt(d*cos(a + b*x))) - (15*d^5*sqrt(d*cos(a + b*x))*sin(a + b*x))/(7*b) - (9*d^3*(d*cos(a + b*x))^(5/2)*sin(a + b*x))/(7*b)]
    @test_int [csc(a + b*x)^2*(d*cos(a + b*x))^(9/2), x, 4, -((d*(d*cos(a + b*x))^(7/2)*csc(a + b*x))/b) - (21*d^4*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(5*b*sqrt(cos(a + b*x))) - (7*d^3*(d*cos(a + b*x))^(3/2)*sin(a + b*x))/(5*b)]
    @test_int [csc(a + b*x)^2*(d*cos(a + b*x))^(7/2), x, 4, -((d*(d*cos(a + b*x))^(5/2)*csc(a + b*x))/b) - (5*d^4*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(3*b*sqrt(d*cos(a + b*x))) - (5*d^3*sqrt(d*cos(a + b*x))*sin(a + b*x))/(3*b)]
    @test_int [csc(a + b*x)^2*(d*cos(a + b*x))^(5/2), x, 3, -((d*(d*cos(a + b*x))^(3/2)*csc(a + b*x))/b) - (3*d^2*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(b*sqrt(cos(a + b*x)))]
    @test_int [csc(a + b*x)^2*(d*cos(a + b*x))^(3/2), x, 3, -((d*sqrt(d*cos(a + b*x))*csc(a + b*x))/b) - (d^2*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(b*sqrt(d*cos(a + b*x)))]
    @test_int [csc(a + b*x)^2*(d*cos(a + b*x))^(1/2), x, 3, -(((d*cos(a + b*x))^(3/2)*csc(a + b*x))/(b*d)) - (sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(b*sqrt(cos(a + b*x)))]
    @test_int [csc(a + b*x)^2/(d*cos(a + b*x))^(1/2), x, 3, -((sqrt(d*cos(a + b*x))*csc(a + b*x))/(b*d)) + (sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(b*sqrt(d*cos(a + b*x)))]
    @test_int [csc(a + b*x)^2/(d*cos(a + b*x))^(3/2), x, 4, -(csc(a + b*x)/(b*d*sqrt(d*cos(a + b*x)))) - (3*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(b*d^2*sqrt(cos(a + b*x))) + (3*sin(a + b*x))/(b*d*sqrt(d*cos(a + b*x)))]
    @test_int [csc(a + b*x)^2/(d*cos(a + b*x))^(5/2), x, 4, -(csc(a + b*x)/(b*d*(d*cos(a + b*x))^(3/2))) + (5*sqrt(cos(a + b*x))*Elliptic.F((1/2)*(a + b*x), 2))/(3*b*d^2*sqrt(d*cos(a + b*x))) + (5*sin(a + b*x))/(3*b*d*(d*cos(a + b*x))^(3/2))]
    @test_int [csc(a + b*x)^2/(d*cos(a + b*x))^(7/2), x, 5, -(csc(a + b*x)/(b*d*(d*cos(a + b*x))^(5/2))) - (21*sqrt(d*cos(a + b*x))*Elliptic.E((1/2)*(a + b*x), 2))/(5*b*d^4*sqrt(cos(a + b*x))) + (7*sin(a + b*x))/(5*b*d*(d*cos(a + b*x))^(5/2)) + (21*sin(a + b*x))/(5*b*d^3*sqrt(d*cos(a + b*x)))]
    ...
    @test_int [(c*sin(a + b*x))^(1/2)*(d*cos(a + b*x))^(9/2), x, 4, (7*d^3*(d*cos(a + b*x))^(3/2)*(c*sin(a + b*x))^(3/2))/(30*b*c) + (d*(d*cos(a + b*x))^(7/2)*(c*sin(a + b*x))^(3/2))/(5*b*c) + (7*d^4*sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(20*b*sqrt(sin(2*a + 2*b*x)))]
    @test_int [(c*sin(a + b*x))^(1/2)*(d*cos(a + b*x))^(5/2), x, 3, (d*(d*cos(a + b*x))^(3/2)*(c*sin(a + b*x))^(3/2))/(3*b*c) + (d^2*sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(2*b*sqrt(sin(2*a + 2*b*x)))]
    @test_int [(c*sin(a + b*x))^(1/2)*(d*cos(a + b*x))^(1/2), x, 2, (sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(b*sqrt(sin(2*a + 2*b*x)))]
    @test_int [(c*sin(a + b*x))^(1/2)/(d*cos(a + b*x))^(3/2), x, 3, (2*(c*sin(a + b*x))^(3/2))/(b*c*d*sqrt(d*cos(a + b*x))) - (2*sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(b*d^2*sqrt(sin(2*a + 2*b*x)))]
    @test_int [(c*sin(a + b*x))^(1/2)/(d*cos(a + b*x))^(7/2), x, 4, (2*(c*sin(a + b*x))^(3/2))/(5*b*c*d*(d*cos(a + b*x))^(5/2)) + (4*(c*sin(a + b*x))^(3/2))/(5*b*c*d^3*sqrt(d*cos(a + b*x))) - (4*sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(5*b*d^4*sqrt(sin(2*a + 2*b*x)))]
    ...
    @test_int [(c*sin(a + b*x))^(3/2)*(d*cos(a + b*x))^(3/2), x, 4, (c*d*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))/(6*b) - (c*(d*cos(a + b*x))^(5/2)*sqrt(c*sin(a + b*x)))/(3*b*d) + (c^2*d^2*Elliptic.F(a - pi/4 + b*x, 2)*sqrt(sin(2*a + 2*b*x)))/(12*b*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))]
    @test_int [(c*sin(a + b*x))^(3/2)/(d*cos(a + b*x))^(1/2), x, 3, -((c*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))/(b*d)) + (c^2*Elliptic.F(a - pi/4 + b*x, 2)*sqrt(sin(2*a + 2*b*x)))/(2*b*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))]
    @test_int [(c*sin(a + b*x))^(3/2)/(d*cos(a + b*x))^(5/2), x, 3, (2*c*sqrt(c*sin(a + b*x)))/(3*b*d*(d*cos(a + b*x))^(3/2)) - (c^2*Elliptic.F(a - pi/4 + b*x, 2)*sqrt(sin(2*a + 2*b*x)))/(3*b*d^2*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))]
    @test_int [(c*sin(a + b*x))^(3/2)/(d*cos(a + b*x))^(9/2), x, 4, (2*c*sqrt(c*sin(a + b*x)))/(7*b*d*(d*cos(a + b*x))^(7/2)) - (2*c*sqrt(c*sin(a + b*x)))/(21*b*d^3*(d*cos(a + b*x))^(3/2)) - (2*c^2*Elliptic.F(a - pi/4 + b*x, 2)*sqrt(sin(2*a + 2*b*x)))/(21*b*d^4*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))]
    ...
    @test_int [(c*sin(a + b*x))^(5/2)*(d*cos(a + b*x))^(9/2), x, 5, (c*d^3*(d*cos(a + b*x))^(3/2)*(c*sin(a + b*x))^(3/2))/(20*b) + (3*c*d*(d*cos(a + b*x))^(7/2)*(c*sin(a + b*x))^(3/2))/(70*b) - (c*(d*cos(a + b*x))^(11/2)*(c*sin(a + b*x))^(3/2))/(7*b*d) + (3*c^2*d^4*sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(40*b*sqrt(sin(2*a + 2*b*x)))]
    @test_int [(c*sin(a + b*x))^(5/2)*(d*cos(a + b*x))^(5/2), x, 4, (c*d*(d*cos(a + b*x))^(3/2)*(c*sin(a + b*x))^(3/2))/(10*b) - (c*(d*cos(a + b*x))^(7/2)*(c*sin(a + b*x))^(3/2))/(5*b*d) + (3*c^2*d^2*sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(20*b*sqrt(sin(2*a + 2*b*x)))]
    @test_int [(c*sin(a + b*x))^(5/2)*(d*cos(a + b*x))^(1/2), x, 3, -((c*(d*cos(a + b*x))^(3/2)*(c*sin(a + b*x))^(3/2))/(3*b*d)) + (c^2*sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(2*b*sqrt(sin(2*a + 2*b*x)))]
    @test_int [(c*sin(a + b*x))^(5/2)/(d*cos(a + b*x))^(3/2), x, 3, (2*c*(c*sin(a + b*x))^(3/2))/(b*d*sqrt(d*cos(a + b*x))) - (3*c^2*sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(b*d^2*sqrt(sin(2*a + 2*b*x)))]
    @test_int [(c*sin(a + b*x))^(5/2)/(d*cos(a + b*x))^(7/2), x, 4, (2*c*(c*sin(a + b*x))^(3/2))/(5*b*d*(d*cos(a + b*x))^(5/2)) - (6*c*(c*sin(a + b*x))^(3/2))/(5*b*d^3*sqrt(d*cos(a + b*x))) + (6*c^2*sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(5*b*d^4*sqrt(sin(2*a + 2*b*x)))]
    @test_int [(c*sin(a + b*x))^(5/2)/(d*cos(a + b*x))^(11/2), x, 5, (2*c*(c*sin(a + b*x))^(3/2))/(9*b*d*(d*cos(a + b*x))^(9/2)) - (2*c*(c*sin(a + b*x))^(3/2))/(15*b*d^3*(d*cos(a + b*x))^(5/2)) - (4*c*(c*sin(a + b*x))^(3/2))/(15*b*d^5*sqrt(d*cos(a + b*x))) + (4*c^2*sqrt(d*cos(a + b*x))*Elliptic.E(a - pi/4 + b*x, 2)*sqrt(c*sin(a + b*x)))/(15*b*d^6*sqrt(sin(2*a + 2*b*x)))]
    ...
    @test_int [1/(c*sin(a + b*x))^(1/2)*(d*cos(a + b*x))^(7/2), x, 4, (5*d^3*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))/(6*b*c) + (d*(d*cos(a + b*x))^(5/2)*sqrt(c*sin(a + b*x)))/(3*b*c) + (5*d^4*Elliptic.F(a - pi/4 + b*x, 2)*sqrt(sin(2*a + 2*b*x)))/(12*b*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))]
    @test_int [1/(c*sin(a + b*x))^(1/2)*(d*cos(a + b*x))^(3/2), x, 3, (d*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))/(b*c) + (d^2*Elliptic.F(a - pi/4 + b*x, 2)*sqrt(sin(2*a + 2*b*x)))/(2*b*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))]
    @test_int [1/(c*sin(a + b*x))^(1/2)/(d*cos(a + b*x))^(1/2), x, 2, (Elliptic.F(a - pi/4 + b*x, 2)*sqrt(sin(2*a + 2*b*x)))/(b*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))]
    @test_int [1/(c*sin(a + b*x))^(1/2)/(d*cos(a + b*x))^(5/2), x, 3, (2*sqrt(c*sin(a + b*x)))/(3*b*c*d*(d*cos(a + b*x))^(3/2)) + (2*Elliptic.F(a - pi/4 + b*x, 2)*sqrt(sin(2*a + 2*b*x)))/(3*b*d^2*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))]
    @test_int [1/(c*sin(a + b*x))^(1/2)/(d*cos(a + b*x))^(9/2), x, 4, (2*sqrt(c*sin(a + b*x)))/(7*b*c*d*(d*cos(a + b*x))^(7/2)) + (4*sqrt(c*sin(a + b*x)))/(7*b*c*d^3*(d*cos(a + b*x))^(3/2)) + (4*Elliptic.F(a - pi/4 + b*x, 2)*sqrt(sin(2*a + 2*b*x)))/(7*b*d^4*sqrt(d*cos(a + b*x))*sqrt(c*sin(a + b*x)))]
    ...
    @test_int [cos(e + f*x)^4*(b*sin(e + f*x))^(1/3), x, 1, (3*cos(e + f*x)*HypergeometricFunctions._₂F₁(-3/2, 2/3, 5/3, sin(e + f*x)^2)*(b*sin(e + f*x))^(4/3))/(4*b*f*sqrt(cos(e + f*x)^2))]
    @test_int [cos(e + f*x)^2*(b*sin(e + f*x))^(1/3), x, 1, (3*cos(e + f*x)*HypergeometricFunctions._₂F₁(-1/2, 2/3, 5/3, sin(e + f*x)^2)*(b*sin(e + f*x))^(4/3))/(4*b*f*sqrt(cos(e + f*x)^2))]
    @test_int [cos(e + f*x)^0*(b*sin(e + f*x))^(1/3), x, 1, (3*cos(e + f*x)*HypergeometricFunctions._₂F₁(1/2, 2/3, 5/3, sin(e + f*x)^2)*(b*sin(e + f*x))^(4/3))/(4*b*f*sqrt(cos(e + f*x)^2))]
    @test_int [sec(e + f*x)^2*(b*sin(e + f*x))^(1/3), x, 1, (3*sqrt(cos(e + f*x)^2)*HypergeometricFunctions._₂F₁(2/3, 3/2, 5/3, sin(e + f*x)^2)*sec(e + f*x)*(b*sin(e + f*x))^(4/3))/(4*b*f)]
    @test_int [sec(e + f*x)^4*(b*sin(e + f*x))^(1/3), x, 1, (3*sqrt(cos(e + f*x)^2)*HypergeometricFunctions._₂F₁(2/3, 5/2, 5/3, sin(e + f*x)^2)*sec(e + f*x)*(b*sin(e + f*x))^(4/3))/(4*b*f)]


    @test_int [cos(e + f*x)^4*(b*sin(e + f*x))^(5/3), x, 1, (3*cos(e + f*x)*HypergeometricFunctions._₂F₁(-3/2, 4/3, 7/3, sin(e + f*x)^2)*(b*sin(e + f*x))^(8/3))/(8*b*f*sqrt(cos(e + f*x)^2))]
    @test_int [cos(e + f*x)^2*(b*sin(e + f*x))^(5/3), x, 1, (3*cos(e + f*x)*HypergeometricFunctions._₂F₁(-1/2, 4/3, 7/3, sin(e + f*x)^2)*(b*sin(e + f*x))^(8/3))/(8*b*f*sqrt(cos(e + f*x)^2))]
    @test_int [cos(e + f*x)^0*(b*sin(e + f*x))^(5/3), x, 1, (3*cos(e + f*x)*HypergeometricFunctions._₂F₁(1/2, 4/3, 7/3, sin(e + f*x)^2)*(b*sin(e + f*x))^(8/3))/(8*b*f*sqrt(cos(e + f*x)^2))]
    @test_int [sec(e + f*x)^2*(b*sin(e + f*x))^(5/3), x, 1, (3*sqrt(cos(e + f*x)^2)*HypergeometricFunctions._₂F₁(4/3, 3/2, 7/3, sin(e + f*x)^2)*sec(e + f*x)*(b*sin(e + f*x))^(8/3))/(8*b*f)]
    @test_int [sec(e + f*x)^4*(b*sin(e + f*x))^(5/3), x, 1, (3*sqrt(cos(e + f*x)^2)*HypergeometricFunctions._₂F₁(4/3, 5/2, 7/3, sin(e + f*x)^2)*sec(e + f*x)*(b*sin(e + f*x))^(8/3))/(8*b*f)]
    ...
    @test_int [cos(e + f*x)^4/(b*sin(e + f*x))^(1/3), x, 1, (3*cos(e + f*x)*HypergeometricFunctions._₂F₁(-3/2, 1/3, 4/3, sin(e + f*x)^2)*(b*sin(e + f*x))^(2/3))/(2*b*f*sqrt(cos(e + f*x)^2))]
    @test_int [cos(e + f*x)^2/(b*sin(e + f*x))^(1/3), x, 1, (3*cos(e + f*x)*HypergeometricFunctions._₂F₁(-1/2, 1/3, 4/3, sin(e + f*x)^2)*(b*sin(e + f*x))^(2/3))/(2*b*f*sqrt(cos(e + f*x)^2))]
    @test_int [cos(e + f*x)^0/(b*sin(e + f*x))^(1/3), x, 1, (3*cos(e + f*x)*HypergeometricFunctions._₂F₁(1/3, 1/2, 4/3, sin(e + f*x)^2)*(b*sin(e + f*x))^(2/3))/(2*b*f*sqrt(cos(e + f*x)^2))]
    @test_int [sec(e + f*x)^2/(b*sin(e + f*x))^(1/3), x, 1, (3*sqrt(cos(e + f*x)^2)*HypergeometricFunctions._₂F₁(1/3, 3/2, 4/3, sin(e + f*x)^2)*sec(e + f*x)*(b*sin(e + f*x))^(2/3))/(2*b*f)]
    @test_int [sec(e + f*x)^4/(b*sin(e + f*x))^(1/3), x, 1, (3*sqrt(cos(e + f*x)^2)*HypergeometricFunctions._₂F₁(1/3, 5/2, 4/3, sin(e + f*x)^2)*sec(e + f*x)*(b*sin(e + f*x))^(2/3))/(2*b*f)]


    @test_int [cos(e + f*x)^4/(b*sin(e + f*x))^(5/3), x, 1, (-3*cos(e + f*x)*HypergeometricFunctions._₂F₁(-3/2, -1/3, 2/3, sin(e + f*x)^2))/(2*b*f*sqrt(cos(e + f*x)^2)*(b*sin(e + f*x))^(2/3))]
    @test_int [cos(e + f*x)^2/(b*sin(e + f*x))^(5/3), x, 1, (-3*cos(e + f*x)*HypergeometricFunctions._₂F₁(-1/2, -1/3, 2/3, sin(e + f*x)^2))/(2*b*f*sqrt(cos(e + f*x)^2)*(b*sin(e + f*x))^(2/3))]
    @test_int [cos(e + f*x)^0/(b*sin(e + f*x))^(5/3), x, 1, (-3*cos(e + f*x)*HypergeometricFunctions._₂F₁(-1/3, 1/2, 2/3, sin(e + f*x)^2))/(2*b*f*sqrt(cos(e + f*x)^2)*(b*sin(e + f*x))^(2/3))]
    @test_int [sec(e + f*x)^2/(b*sin(e + f*x))^(5/3), x, 1, (-3*sqrt(cos(e + f*x)^2)*HypergeometricFunctions._₂F₁(-1/3, 3/2, 2/3, sin(e + f*x)^2)*sec(e + f*x))/(2*b*f*(b*sin(e + f*x))^(2/3))]
    @test_int [sec(e + f*x)^4/(b*sin(e + f*x))^(5/3), x, 1, (-3*sqrt(cos(e + f*x)^2)*HypergeometricFunctions._₂F₁(-1/3, 5/2, 2/3, sin(e + f*x)^2)*sec(e + f*x))/(2*b*f*(b*sin(e + f*x))^(2/3))]
    ...
    @test_int [(sin(e + f*x))^m*(cos(e + f*x))^n, x, 1, -((cos(e + f*x)^(1 + n)*HypergeometricFunctions._₂F₁((1 - m)/2, (1 + n)/2, (3 + n)/2, cos(e + f*x)^2)*sin(e + f*x)^(-1 + m)*(sin(e + f*x)^2)^((1 - m)/2))/(f*(1 + n)))]
    @test_int [(sin(e + f*x))^m*(d*cos(e + f*x))^n, x, 1, -(((d*cos(e + f*x))^(1 + n)*HypergeometricFunctions._₂F₁((1 - m)/2, (1 + n)/2, (3 + n)/2, cos(e + f*x)^2)*sin(e + f*x)^(-1 + m)*(sin(e + f*x)^2)^((1 - m)/2))/(d*f*(1 + n)))]
    @test_int [(b*sin(e + f*x))^m*(cos(e + f*x))^n, x, 1, -((b*cos(e + f*x)^(1 + n)*HypergeometricFunctions._₂F₁((1 - m)/2, (1 + n)/2, (3 + n)/2, cos(e + f*x)^2)*(b*sin(e + f*x))^(-1 + m)*(sin(e + f*x)^2)^((1 - m)/2))/(f*(1 + n)))]
    @test_int [(b*sin(e + f*x))^m*(d*cos(e + f*x))^n, x, 1, -((b*(d*cos(e + f*x))^(1 + n)*HypergeometricFunctions._₂F₁((1 - m)/2, (1 + n)/2, (3 + n)/2, cos(e + f*x)^2)*(b*sin(e + f*x))^(-1 + m)*(sin(e + f*x)^2)^((1 - m)/2))/(d*f*(1 + n)))]
    ...
    @test_int [sec(a + b*x)^1*(c*sin(a + b*x))^m, x, 2, (HypergeometricFunctions._₂F₁(1, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m))]
    @test_int [sec(a + b*x)^3*(c*sin(a + b*x))^m, x, 2, (HypergeometricFunctions._₂F₁(2, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m))]

    @test_int [cos(a + b*x)^4*(c*sin(a + b*x))^m, x, 1, (cos(a + b*x)*HypergeometricFunctions._₂F₁(-(3/2), (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m)*sqrt(cos(a + b*x)^2))]
    @test_int [cos(a + b*x)^2*(c*sin(a + b*x))^m, x, 1, (cos(a + b*x)*HypergeometricFunctions._₂F₁(-(1/2), (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m)*sqrt(cos(a + b*x)^2))]
    @test_int [cos(a + b*x)^0*(c*sin(a + b*x))^m, x, 1, (cos(a + b*x)*HypergeometricFunctions._₂F₁(1/2, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m)*sqrt(cos(a + b*x)^2))]
    @test_int [sec(a + b*x)^2*(c*sin(a + b*x))^m, x, 1, (sqrt(cos(a + b*x)^2)*HypergeometricFunctions._₂F₁(3/2, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*sec(a + b*x)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m))]
    @test_int [sec(a + b*x)^4*(c*sin(a + b*x))^m, x, 1, (sqrt(cos(a + b*x)^2)*HypergeometricFunctions._₂F₁(5/2, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*sec(a + b*x)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m))]


    @test_int [(c*sin(a + b*x))^m*(d*cos(a + b*x))^(3/2), x, 1, (d*sqrt(d*cos(a + b*x))*HypergeometricFunctions._₂F₁(-(1/4), (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m)*(cos(a + b*x)^2)^(1/4))]
    @test_int [(c*sin(a + b*x))^m*(d*cos(a + b*x))^(1/2), x, 1, (d*(cos(a + b*x)^2)^(1/4)*HypergeometricFunctions._₂F₁(1/4, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m)*sqrt(d*cos(a + b*x)))]
    @test_int [(c*sin(a + b*x))^m/(d*cos(a + b*x))^(1/2), x, 1, (d*(cos(a + b*x)^2)^(3/4)*HypergeometricFunctions._₂F₁(3/4, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m)*(d*cos(a + b*x))^(3/2))]
    @test_int [(c*sin(a + b*x))^m/(d*cos(a + b*x))^(3/2), x, 1, ((cos(a + b*x)^2)^(1/4)*HypergeometricFunctions._₂F₁(5/4, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*d*(1 + m)*sqrt(d*cos(a + b*x)))]
    @test_int [(c*sin(a + b*x))^m/(d*cos(a + b*x))^(5/2), x, 1, ((cos(a + b*x)^2)^(3/4)*HypergeometricFunctions._₂F₁(7/4, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*d*(1 + m)*(d*cos(a + b*x))^(3/2))]
    ...
    @test_int [csc(a + b*x)^1*(d*cos(a + b*x))^n, x, 2, -(((d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(1, (1 + n)/2, (3 + n)/2, cos(a + b*x)^2))/(b*d*(1 + n)))]
    @test_int [csc(a + b*x)^3*(d*cos(a + b*x))^n, x, 2, -(((d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(2, (1 + n)/2, (3 + n)/2, cos(a + b*x)^2))/(b*d*(1 + n)))]
    @test_int [csc(a + b*x)^5*(d*cos(a + b*x))^n, x, 2, -(((d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(3, (1 + n)/2, (3 + n)/2, cos(a + b*x)^2))/(b*d*(1 + n)))]

    @test_int [sin(a + b*x)^4*(d*cos(a + b*x))^n, x, 1, -(((d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(-(3/2), (1 + n)/2, (3 + n)/2, cos(a + b*x)^2)*sin(a + b*x))/(b*d*(1 + n)*sqrt(sin(a + b*x)^2)))]
    @test_int [sin(a + b*x)^2*(d*cos(a + b*x))^n, x, 1, -(((d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(-(1/2), (1 + n)/2, (3 + n)/2, cos(a + b*x)^2)*sin(a + b*x))/(b*d*(1 + n)*sqrt(sin(a + b*x)^2)))]
    @test_int [sin(a + b*x)^0*(d*cos(a + b*x))^n, x, 1, -(((d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(1/2, (1 + n)/2, (3 + n)/2, cos(a + b*x)^2)*sin(a + b*x))/(b*d*(1 + n)*sqrt(sin(a + b*x)^2)))]
    @test_int [csc(a + b*x)^2*(d*cos(a + b*x))^n, x, 1, -(((d*cos(a + b*x))^(1 + n)*csc(a + b*x)*HypergeometricFunctions._₂F₁(3/2, (1 + n)/2, (3 + n)/2, cos(a + b*x)^2)*sqrt(sin(a + b*x)^2))/(b*d*(1 + n)))]
    @test_int [csc(a + b*x)^4*(d*cos(a + b*x))^n, x, 1, -(((d*cos(a + b*x))^(1 + n)*csc(a + b*x)*HypergeometricFunctions._₂F₁(5/2, (1 + n)/2, (3 + n)/2, cos(a + b*x)^2)*sqrt(sin(a + b*x)^2))/(b*d*(1 + n)))]


    @test_int [(d*cos(a + b*x))^n*(c*sin(a + b*x))^(5/2), x, 1, -((c*(d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(-(3/4), (1 + n)/2, (3 + n)/2, cos(a + b*x)^2)*(c*sin(a + b*x))^(3/2))/(b*d*(1 + n)*(sin(a + b*x)^2)^(3/4)))]
    @test_int [(d*cos(a + b*x))^n*(c*sin(a + b*x))^(3/2), x, 1, -((c*(d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(-(1/4), (1 + n)/2, (3 + n)/2, cos(a + b*x)^2)*sqrt(c*sin(a + b*x)))/(b*d*(1 + n)*(sin(a + b*x)^2)^(1/4)))]
    @test_int [(d*cos(a + b*x))^n*(c*sin(a + b*x))^(1/2), x, 1, -((c*(d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(1/4, (1 + n)/2, (3 + n)/2, cos(a + b*x)^2)*(sin(a + b*x)^2)^(1/4))/(b*d*(1 + n)*sqrt(c*sin(a + b*x))))]
    @test_int [(d*cos(a + b*x))^n/(c*sin(a + b*x))^(1/2), x, 1, -((c*(d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(3/4, (1 + n)/2, (3 + n)/2, cos(a + b*x)^2)*(sin(a + b*x)^2)^(3/4))/(b*d*(1 + n)*(c*sin(a + b*x))^(3/2)))]
    @test_int [(d*cos(a + b*x))^n/(c*sin(a + b*x))^(3/2), x, 1, -(((d*cos(a + b*x))^(1 + n)*HypergeometricFunctions._₂F₁(5/4, (1 + n)/2, (3 + n)/2, cos(a + b*x)^2)*(sin(a + b*x)^2)^(1/4))/(b*c*d*(1 + n)*sqrt(c*sin(a + b*x))))]
    ...
    @test_int [sqrt(b*sec(e + f*x))*sin(e + f*x)^6, x, 5, (80*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(77*f) - (40*b*sin(e + f*x))/(77*f*sqrt(b*sec(e + f*x))) - (20*b*sin(e + f*x)^3)/(77*f*sqrt(b*sec(e + f*x))) - (2*b*sin(e + f*x)^5)/(11*f*sqrt(b*sec(e + f*x)))]
    @test_int [sqrt(b*sec(e + f*x))*sin(e + f*x)^4, x, 4, (8*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(7*f) - (4*b*sin(e + f*x))/(7*f*sqrt(b*sec(e + f*x))) - (2*b*sin(e + f*x)^3)/(7*f*sqrt(b*sec(e + f*x)))]
    @test_int [sqrt(b*sec(e + f*x))*sin(e + f*x)^2, x, 3, (4*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(3*f) - (2*b*sin(e + f*x))/(3*f*sqrt(b*sec(e + f*x)))]
    @test_int [sqrt(b*sec(e + f*x))*sin(e + f*x)^0, x, 2, (2*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/f]
    @test_int [csc(e + f*x)^2*sqrt(b*sec(e + f*x)), x, 3, -((b*csc(e + f*x))/(f*sqrt(b*sec(e + f*x)))) + (sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/f]
    @test_int [csc(e + f*x)^4*sqrt(b*sec(e + f*x)), x, 4, (-5*b*csc(e + f*x))/(6*f*sqrt(b*sec(e + f*x))) - (b*csc(e + f*x)^3)/(3*f*sqrt(b*sec(e + f*x))) + (5*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(6*f)]
    @test_int [csc(e + f*x)^6*sqrt(b*sec(e + f*x)), x, 5, (-3*b*csc(e + f*x))/(4*f*sqrt(b*sec(e + f*x))) - (3*b*csc(e + f*x)^3)/(10*f*sqrt(b*sec(e + f*x))) - (b*csc(e + f*x)^5)/(5*f*sqrt(b*sec(e + f*x))) + (3*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(4*f)]
    ...
    @test_int [(b*sec(e + f*x))^(3/2)*sin(e + f*x)^6, x, 5, (-16*b^2*Elliptic.E((e + f*x)/2, 2))/(3*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) + (8*b^3*sin(e + f*x))/(3*f*(b*sec(e + f*x))^(3/2)) + (20*b^3*sin(e + f*x)^3)/(9*f*(b*sec(e + f*x))^(3/2)) + (2*b*sqrt(b*sec(e + f*x))*sin(e + f*x)^5)/f]
    @test_int [(b*sec(e + f*x))^(3/2)*sin(e + f*x)^4, x, 4, (-24*b^2*Elliptic.E((e + f*x)/2, 2))/(5*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) + (12*b^3*sin(e + f*x))/(5*f*(b*sec(e + f*x))^(3/2)) + (2*b*sqrt(b*sec(e + f*x))*sin(e + f*x)^3)/f]
    @test_int [(b*sec(e + f*x))^(3/2)*sin(e + f*x)^2, x, 3, (-4*b^2*Elliptic.E((e + f*x)/2, 2))/(f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) + (2*b*sqrt(b*sec(e + f*x))*sin(e + f*x))/f]
    @test_int [(b*sec(e + f*x))^(3/2)*sin(e + f*x)^0, x, 3, (-2*b^2*Elliptic.E((e + f*x)/2, 2))/(f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) + (2*b*sqrt(b*sec(e + f*x))*sin(e + f*x))/f]
    @test_int [csc(e + f*x)^2*(b*sec(e + f*x))^(3/2), x, 4, (-3*b^2*Elliptic.E((e + f*x)/2, 2))/(f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) - (b*csc(e + f*x)*sqrt(b*sec(e + f*x)))/f + (3*b*sqrt(b*sec(e + f*x))*sin(e + f*x))/f]
    @test_int [csc(e + f*x)^4*(b*sec(e + f*x))^(3/2), x, 5, (-7*b^2*Elliptic.E((e + f*x)/2, 2))/(2*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) - (7*b*csc(e + f*x)*sqrt(b*sec(e + f*x)))/(6*f) - (b*csc(e + f*x)^3*sqrt(b*sec(e + f*x)))/(3*f) + (7*b*sqrt(b*sec(e + f*x))*sin(e + f*x))/(2*f)]
    ...
    @test_int [(b*sec(e + f*x))^(5/2)*sin(e + f*x)^6, x, 5, (-80*b^2*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(21*f) + (40*b^3*sin(e + f*x))/(21*f*sqrt(b*sec(e + f*x))) + (20*b^3*sin(e + f*x)^3)/(21*f*sqrt(b*sec(e + f*x))) + (2*b*(b*sec(e + f*x))^(3/2)*sin(e + f*x)^5)/(3*f)]
    @test_int [(b*sec(e + f*x))^(5/2)*sin(e + f*x)^4, x, 4, (-8*b^2*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(3*f) + (4*b^3*sin(e + f*x))/(3*f*sqrt(b*sec(e + f*x))) + (2*b*(b*sec(e + f*x))^(3/2)*sin(e + f*x)^3)/(3*f)]
    @test_int [(b*sec(e + f*x))^(5/2)*sin(e + f*x)^2, x, 3, (-4*b^2*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(3*f) + (2*b*(b*sec(e + f*x))^(3/2)*sin(e + f*x))/(3*f)]
    @test_int [(b*sec(e + f*x))^(5/2)*sin(e + f*x)^0, x, 3, (2*b^2*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(3*f) + (2*b*(b*sec(e + f*x))^(3/2)*sin(e + f*x))/(3*f)]
    @test_int [csc(e + f*x)^2*(b*sec(e + f*x))^(5/2), x, 4, -((5*b^3*csc(e + f*x))/(3*f*sqrt(b*sec(e + f*x)))) + (5*b^2*sqrt(cos(e + f*x))*Elliptic.F((1/2)*(e + f*x), 2)*sqrt(b*sec(e + f*x)))/(3*f) + (2*b*csc(e + f*x)*(b*sec(e + f*x))^(3/2))/(3*f)]
    @test_int [csc(e + f*x)^4*(b*sec(e + f*x))^(5/2), x, 5, -((5*b^3*csc(e + f*x))/(2*f*sqrt(b*sec(e + f*x)))) + (5*b^2*sqrt(cos(e + f*x))*Elliptic.F((1/2)*(e + f*x), 2)*sqrt(b*sec(e + f*x)))/(2*f) + (b*csc(e + f*x)*(b*sec(e + f*x))^(3/2))/f - (b*csc(e + f*x)^3*(b*sec(e + f*x))^(3/2))/(3*f)]
    ...
    @test_int [sin(e + f*x)^6/sqrt(b*sec(e + f*x)), x, 5, (16*Elliptic.E((e + f*x)/2, 2))/(39*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) - (8*b*sin(e + f*x))/(39*f*(b*sec(e + f*x))^(3/2)) - (20*b*sin(e + f*x)^3)/(117*f*(b*sec(e + f*x))^(3/2)) - (2*b*sin(e + f*x)^5)/(13*f*(b*sec(e + f*x))^(3/2))]
    @test_int [sin(e + f*x)^4/sqrt(b*sec(e + f*x)), x, 4, (8*Elliptic.E((e + f*x)/2, 2))/(15*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) - (4*b*sin(e + f*x))/(15*f*(b*sec(e + f*x))^(3/2)) - (2*b*sin(e + f*x)^3)/(9*f*(b*sec(e + f*x))^(3/2))]
    @test_int [sin(e + f*x)^2/sqrt(b*sec(e + f*x)), x, 3, (4*Elliptic.E((e + f*x)/2, 2))/(5*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) - (2*b*sin(e + f*x))/(5*f*(b*sec(e + f*x))^(3/2))]
    @test_int [sin(e + f*x)^0/sqrt(b*sec(e + f*x)), x, 2, (2*Elliptic.E((e + f*x)/2, 2))/(f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x)))]
    @test_int [csc(e + f*x)^2/sqrt(b*sec(e + f*x)), x, 3, -((b*csc(e + f*x))/(f*(b*sec(e + f*x))^(3/2))) - Elliptic.E((e + f*x)/2, 2)/(f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x)))]
    @test_int [csc(e + f*x)^4/sqrt(b*sec(e + f*x)), x, 4, -(b*csc(e + f*x))/(2*f*(b*sec(e + f*x))^(3/2)) - (b*csc(e + f*x)^3)/(3*f*(b*sec(e + f*x))^(3/2)) - Elliptic.E((e + f*x)/2, 2)/(2*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x)))]
    @test_int [csc(e + f*x)^6/sqrt(b*sec(e + f*x)), x, 5, (-7*b*csc(e + f*x))/(20*f*(b*sec(e + f*x))^(3/2)) - (7*b*csc(e + f*x)^3)/(30*f*(b*sec(e + f*x))^(3/2)) - (b*csc(e + f*x)^5)/(5*f*(b*sec(e + f*x))^(3/2)) - (7*Elliptic.E((e + f*x)/2, 2))/(20*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x)))]
    ...
    @test_int [sin(e + f*x)^4/(b*sec(e + f*x))^(3/2), x, 5, (8*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(77*b^2*f) - (12*b*sin(e + f*x))/(77*f*(b*sec(e + f*x))^(5/2)) + (8*sin(e + f*x))/(77*b*f*sqrt(b*sec(e + f*x))) - (2*b*sin(e + f*x)^3)/(11*f*(b*sec(e + f*x))^(5/2))]
    @test_int [sin(e + f*x)^2/(b*sec(e + f*x))^(3/2), x, 4, (4*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(21*b^2*f) - (2*b*sin(e + f*x))/(7*f*(b*sec(e + f*x))^(5/2)) + (4*sin(e + f*x))/(21*b*f*sqrt(b*sec(e + f*x)))]
    @test_int [sin(e + f*x)^0/(b*sec(e + f*x))^(3/2), x, 3, (2*sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(3*b^2*f) + (2*sin(e + f*x))/(3*b*f*sqrt(b*sec(e + f*x)))]
    @test_int [csc(e + f*x)^2/(b*sec(e + f*x))^(3/2), x, 3, -(csc(e + f*x)/(b*f*sqrt(b*sec(e + f*x)))) - (sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(b^2*f)]
    @test_int [csc(e + f*x)^4/(b*sec(e + f*x))^(3/2), x, 4, csc(e + f*x)/(6*b*f*sqrt(b*sec(e + f*x))) - csc(e + f*x)^3/(3*b*f*sqrt(b*sec(e + f*x))) - (sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(6*b^2*f)]
    @test_int [csc(e + f*x)^6/(b*sec(e + f*x))^(3/2), x, 5, csc(e + f*x)/(12*b*f*sqrt(b*sec(e + f*x))) + csc(e + f*x)^3/(30*b*f*sqrt(b*sec(e + f*x))) - csc(e + f*x)^5/(5*b*f*sqrt(b*sec(e + f*x))) - (sqrt(cos(e + f*x))*Elliptic.F((e + f*x)/2, 2)*sqrt(b*sec(e + f*x)))/(12*b^2*f)]
    ...
    @test_int [sin(e + f*x)^4/(b*sec(e + f*x))^(5/2), x, 5, (8*Elliptic.E((e + f*x)/2, 2))/(65*b^2*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) - (4*b*sin(e + f*x))/(39*f*(b*sec(e + f*x))^(7/2)) + (8*sin(e + f*x))/(195*b*f*(b*sec(e + f*x))^(3/2)) - (2*b*sin(e + f*x)^3)/(13*f*(b*sec(e + f*x))^(7/2))]
    @test_int [sin(e + f*x)^2/(b*sec(e + f*x))^(5/2), x, 4, (4*Elliptic.E((e + f*x)/2, 2))/(15*b^2*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) - (2*b*sin(e + f*x))/(9*f*(b*sec(e + f*x))^(7/2)) + (4*sin(e + f*x))/(45*b*f*(b*sec(e + f*x))^(3/2))]
    @test_int [sin(e + f*x)^0/(b*sec(e + f*x))^(5/2), x, 3, (6*Elliptic.E((e + f*x)/2, 2))/(5*b^2*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x))) + (2*sin(e + f*x))/(5*b*f*(b*sec(e + f*x))^(3/2))]
    @test_int [csc(e + f*x)^2/(b*sec(e + f*x))^(5/2), x, 3, -(csc(e + f*x)/(b*f*(b*sec(e + f*x))^(3/2))) - (3*Elliptic.E((e + f*x)/2, 2))/(b^2*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x)))]
    @test_int [csc(e + f*x)^4/(b*sec(e + f*x))^(5/2), x, 4, csc(e + f*x)/(2*b*f*(b*sec(e + f*x))^(3/2)) - csc(e + f*x)^3/(3*b*f*(b*sec(e + f*x))^(3/2)) + Elliptic.E((e + f*x)/2, 2)/(2*b^2*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x)))]
    @test_int [csc(e + f*x)^6/(b*sec(e + f*x))^(5/2), x, 5, (3*csc(e + f*x))/(20*b*f*(b*sec(e + f*x))^(3/2)) + csc(e + f*x)^3/(10*b*f*(b*sec(e + f*x))^(3/2)) - csc(e + f*x)^5/(5*b*f*(b*sec(e + f*x))^(3/2)) + (3*Elliptic.E((e + f*x)/2, 2))/(20*b^2*f*sqrt(cos(e + f*x))*sqrt(b*sec(e + f*x)))]
    ...
    @test_int [sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(7/2), x, 5, -((5*a^3*b*sqrt(a*sin(e + f*x)))/(6*f*sqrt(b*sec(e + f*x)))) - (a*b*(a*sin(e + f*x))^(5/2))/(3*f*sqrt(b*sec(e + f*x))) + (5*a^4*Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(12*f*sqrt(a*sin(e + f*x)))]
    @test_int [sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(3/2), x, 4, -((a*b*sqrt(a*sin(e + f*x)))/(f*sqrt(b*sec(e + f*x)))) + (a^2*Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(2*f*sqrt(a*sin(e + f*x)))]
    @test_int [sqrt(b*sec(e + f*x))/(a*sin(e + f*x))^(1/2), x, 3, (Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(f*sqrt(a*sin(e + f*x)))]
    @test_int [sqrt(b*sec(e + f*x))/(a*sin(e + f*x))^(5/2), x, 4, -((2*b)/(3*a*f*sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(3/2))) + (2*Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(3*a^2*f*sqrt(a*sin(e + f*x)))]
    @test_int [sqrt(b*sec(e + f*x))/(a*sin(e + f*x))^(9/2), x, 5, -((2*b)/(7*a*f*sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(7/2))) - (4*b)/(7*a^3*f*sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(3/2)) + (4*Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(7*a^4*f*sqrt(a*sin(e + f*x)))]
    ...
    @test_int [sin(e + f*x)^(9/2)/sqrt(b*sec(e + f*x)), x, 5, -((7*b*sin(e + f*x)^(3/2))/(30*f*(b*sec(e + f*x))^(3/2))) - (b*sin(e + f*x)^(7/2))/(5*f*(b*sec(e + f*x))^(3/2)) + (7*b*Elliptic.E(e - pi/4 + f*x, 2)*sqrt(sin(e + f*x)))/(20*b*f*(b*sec(e + f*x))^(1/2)*sqrt(sin(2*e + 2*f*x)))]
    @test_int [sin(e + f*x)^(5/2)/sqrt(b*sec(e + f*x)), x, 4, -((b*sin(e + f*x)^(3/2))/(3*f*(b*sec(e + f*x))^(3/2))) + (Elliptic.E(e - pi/4 + f*x, 2)*sqrt(sin(e + f*x)))/(2*f*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))]
    @test_int [sin(e + f*x)^(1/2)/sqrt(b*sec(e + f*x)), x, 3, (Elliptic.E(e - pi/4 + f*x, 2)*sqrt(sin(e + f*x)))/(f*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))]
    @test_int [1/(sin(e + f*x)^(3/2)*sqrt(b*sec(e + f*x))), x, 4, -((2*b)/(f*(b*sec(e + f*x))^(3/2)*sqrt(sin(e + f*x)))) - (2*Elliptic.E(e - pi/4 + f*x, 2)*sqrt(sin(e + f*x)))/(f*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))]
    @test_int [1/(sin(e + f*x)^(7/2)*sqrt(b*sec(e + f*x))), x, 5, -((2*b)/(5*f*(b*sec(e + f*x))^(3/2)*sin(e + f*x)^(5/2))) - (4*b)/(5*f*(b*sec(e + f*x))^(3/2)*sqrt(sin(e + f*x))) - (4*Elliptic.E(e - pi/4 + f*x, 2)*sqrt(sin(e + f*x)))/(5*f*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))]
    ...
    @test_int [(a*sin(e + f*x))^(7/2)/(b*sec(e + f*x))^(3/2), x, 6, -((a^3*sqrt(a*sin(e + f*x)))/(12*b*f*sqrt(b*sec(e + f*x)))) - (a*(a*sin(e + f*x))^(5/2))/(30*b*f*sqrt(b*sec(e + f*x))) + (a*sin(e + f*x))^(9/2)/(5*a*b*f*sqrt(b*sec(e + f*x))) + (a^4*Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(24*b^2*f*sqrt(a*sin(e + f*x)))]
    @test_int [(a*sin(e + f*x))^(3/2)/(b*sec(e + f*x))^(3/2), x, 5, -((a*sqrt(a*sin(e + f*x)))/(6*b*f*sqrt(b*sec(e + f*x)))) + (a*sin(e + f*x))^(5/2)/(3*a*b*f*sqrt(b*sec(e + f*x))) + (a^2*Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(12*b^2*f*sqrt(a*sin(e + f*x)))]
    @test_int [1/((a*sin(e + f*x))^(1/2)*(b*sec(e + f*x))^(3/2)), x, 4, sqrt(a*sin(e + f*x))/(a*b*f*sqrt(b*sec(e + f*x))) + (Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(2*b^2*f*sqrt(a*sin(e + f*x)))]
    @test_int [1/((a*sin(e + f*x))^(5/2)*(b*sec(e + f*x))^(3/2)), x, 4, -(2/(3*a*b*f*sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(3/2))) - (Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(3*a^2*b^2*f*sqrt(a*sin(e + f*x)))]
    @test_int [1/((a*sin(e + f*x))^(9/2)*(b*sec(e + f*x))^(3/2)), x, 5, -(2/(7*a*b*f*sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(7/2))) + 2/(21*a^3*b*f*sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(3/2)) - (2*Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(21*a^4*b^2*f*sqrt(a*sin(e + f*x)))]
    @test_int [1/((a*sin(e + f*x))^(13/2)*(b*sec(e + f*x))^(3/2)), x, 6, -(2/(11*a*b*f*sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(11/2))) + 2/(77*a^3*b*f*sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(7/2)) + 4/(77*a^5*b*f*sqrt(b*sec(e + f*x))*(a*sin(e + f*x))^(3/2)) - (4*Elliptic.F(e - pi/4 + f*x, 2)*sqrt(b*sec(e + f*x))*sqrt(sin(2*e + 2*f*x)))/(77*a^6*b^2*f*sqrt(a*sin(e + f*x)))]
    ...
    @test_int [(c*sin(a + b*x))^m*(d*sec(a + b*x))^(5/2), x, 2, (d*(cos(a + b*x)^2)^(3/4)*HypergeometricFunctions._₂F₁(7/4, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(d*sec(a + b*x))^(3/2)*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m))]
    @test_int [(c*sin(a + b*x))^m*(d*sec(a + b*x))^(3/2), x, 2, (d*(cos(a + b*x)^2)^(1/4)*HypergeometricFunctions._₂F₁(5/4, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*sqrt(d*sec(a + b*x))*(c*sin(a + b*x))^(1 + m))/(b*c*(1 + m))]
    @test_int [(c*sin(a + b*x))^m*(d*sec(a + b*x))^(1/2), x, 2, ((cos(a + b*x)^2)^(3/4)*HypergeometricFunctions._₂F₁(3/4, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(d*sec(a + b*x))^(3/2)*(c*sin(a + b*x))^(1 + m))/(b*c*d*(1 + m))]
    @test_int [(c*sin(a + b*x))^m/(d*sec(a + b*x))^(1/2), x, 2, ((cos(a + b*x)^2)^(1/4)*HypergeometricFunctions._₂F₁(1/4, (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*sqrt(d*sec(a + b*x))*(c*sin(a + b*x))^(1 + m))/(b*c*d*(1 + m))]
    @test_int [(c*sin(a + b*x))^m/(d*sec(a + b*x))^(3/2), x, 2, (HypergeometricFunctions._₂F₁(-(1/4), (1 + m)/2, (3 + m)/2, sin(a + b*x)^2)*(c*sin(a + b*x))^(1 + m))/(b*c*d*(1 + m)*(cos(a + b*x)^2)^(1/4)*sqrt(d*sec(a + b*x)))]
    ...
    @test_int [(sin(e + f*x))^m*(sec(e + f*x))^n, x, 2, -((HypergeometricFunctions._₂F₁((1 - m)/2, (1 - n)/2, (3 - n)/2, cos(e + f*x)^2)*sec(e + f*x)^(-1 + n)*sin(e + f*x)^(-1 + m)*(sin(e + f*x)^2)^((1 - m)/2))/(f*(1 - n)))]
    @test_int [(a*sin(e + f*x))^m*(sec(e + f*x))^n, x, 2, -((a*HypergeometricFunctions._₂F₁((1 - m)/2, (1 - n)/2, (3 - n)/2, cos(e + f*x)^2)*sec(e + f*x)^(-1 + n)*(a*sin(e + f*x))^(-1 + m)*(sin(e + f*x)^2)^((1 - m)/2))/(f*(1 - n)))]
    @test_int [(sin(e + f*x))^m*(b*sec(e + f*x))^n, x, 2, -((b*HypergeometricFunctions._₂F₁((1 - m)/2, (1 - n)/2, (3 - n)/2, cos(e + f*x)^2)*(b*sec(e + f*x))^(-1 + n)*sin(e + f*x)^(-1 + m)*(sin(e + f*x)^2)^((1 - m)/2))/(f*(1 - n)))]
    @test_int [(a*sin(e + f*x))^m*(b*sec(e + f*x))^n, x, 2, -((a*b*HypergeometricFunctions._₂F₁((1 - m)/2, (1 - n)/2, (3 - n)/2, cos(e + f*x)^2)*(b*sec(e + f*x))^(-1 + n)*(a*sin(e + f*x))^(-1 + m)*(sin(e + f*x)^2)^((1 - m)/2))/(f*(1 - n)))]
    ...
    @test_int [(b*sec(e + f*x))^n*csc(e + f*x)^1, x, 2, -((HypergeometricFunctions._₂F₁(1, (1 + n)/2, (3 + n)/2, sec(e + f*x)^2)*(b*sec(e + f*x))^(1 + n))/(f*b*(1 + n)))]
    @test_int [(b*sec(e + f*x))^n*csc(e + f*x)^3, x, 2, (HypergeometricFunctions._₂F₁(2, (3 + n)/2, (5 + n)/2, sec(e + f*x)^2)*(b*sec(e + f*x))^(3 + n))/(f*b^3*(3 + n))]

    @test_int [(b*sec(e + f*x))^n*sin(e + f*x)^6, x, 2, -((b*HypergeometricFunctions._₂F₁(-(5/2), (1 - n)/2, (3 - n)/2, cos(e + f*x)^2)*(b*sec(e + f*x))^(-1 + n)*sin(e + f*x))/(f*(1 - n)*sqrt(sin(e + f*x)^2)))]
    @test_int [(b*sec(e + f*x))^n*sin(e + f*x)^4, x, 2, -((b*HypergeometricFunctions._₂F₁(-(3/2), (1 - n)/2, (3 - n)/2, cos(e + f*x)^2)*(b*sec(e + f*x))^(-1 + n)*sin(e + f*x))/(f*(1 - n)*sqrt(sin(e + f*x)^2)))]
    @test_int [(b*sec(e + f*x))^n*sin(e + f*x)^2, x, 2, -((b*HypergeometricFunctions._₂F₁(-(1/2), (1 - n)/2, (3 - n)/2, cos(e + f*x)^2)*(b*sec(e + f*x))^(-1 + n)*sin(e + f*x))/(f*(1 - n)*sqrt(sin(e + f*x)^2)))]
    @test_int [(b*sec(e + f*x))^n*sin(e + f*x)^0, x, 2, -((b*HypergeometricFunctions._₂F₁(1/2, (1 - n)/2, (3 - n)/2, cos(e + f*x)^2)*(b*sec(e + f*x))^(-1 + n)*sin(e + f*x))/(f*(1 - n)*sqrt(sin(e + f*x)^2)))]
    @test_int [(b*sec(e + f*x))^n*csc(e + f*x)^2, x, 2, -((b*csc(e + f*x)*HypergeometricFunctions._₂F₁(3/2, (1 - n)/2, (3 - n)/2, cos(e + f*x)^2)*(b*sec(e + f*x))^(-1 + n)*sqrt(sin(e + f*x)^2))/(f*(1 - n)))]
    @test_int [(b*sec(e + f*x))^n*csc(e + f*x)^4, x, 2, -((b*csc(e + f*x)*HypergeometricFunctions._₂F₁(5/2, (1 - n)/2, (3 - n)/2, cos(e + f*x)^2)*(b*sec(e + f*x))^(-1 + n)*sqrt(sin(e + f*x)^2))/(f*(1 - n)))]


    @test_int [(b*sec(a + b*x))^n*(c*sin(a + b*x))^(3/2), x, 2, -((c*HypergeometricFunctions._₂F₁(-(1/4), (1 - n)/2, (3 - n)/2, cos(a + b*x)^2)*(b*sec(a + b*x))^(-1 + n)*sqrt(c*sin(a + b*x)))/((1 - n)*(sin(a + b*x)^2)^(1/4)))]
    @test_int [(b*sec(a + b*x))^n*(c*sin(a + b*x))^(1/2), x, 2, -((c*HypergeometricFunctions._₂F₁(1/4, (1 - n)/2, (3 - n)/2, cos(a + b*x)^2)*(b*sec(a + b*x))^(-1 + n)*(sin(a + b*x)^2)^(1/4))/((1 - n)*sqrt(c*sin(a + b*x))))]
    @test_int [(b*sec(a + b*x))^n/(c*sin(a + b*x))^(1/2), x, 2, -((c*HypergeometricFunctions._₂F₁(3/4, (1 - n)/2, (3 - n)/2, cos(a + b*x)^2)*(b*sec(a + b*x))^(-1 + n)*(sin(a + b*x)^2)^(3/4))/((1 - n)*(c*sin(a + b*x))^(3/2)))]
    @test_int [(b*sec(a + b*x))^n/(c*sin(a + b*x))^(3/2), x, 2, -((HypergeometricFunctions._₂F₁(5/4, (1 - n)/2, (3 - n)/2, cos(a + b*x)^2)*(b*sec(a + b*x))^(-1 + n)*(sin(a + b*x)^2)^(1/4))/(c*(1 - n)*sqrt(c*sin(a + b*x))))]
    ...
    @test_int [sqrt(d*csc(e + f*x))*sin(e + f*x)^4, x, 5, -((2*d^3*cos(e + f*x))/(7*f*(d*csc(e + f*x))^(5/2))) - (10*d*cos(e + f*x))/(21*f*sqrt(d*csc(e + f*x))) + (10*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(21*f)]
    @test_int [sqrt(d*csc(e + f*x))*sin(e + f*x)^3, x, 4, -((2*d^2*cos(e + f*x))/(5*f*(d*csc(e + f*x))^(3/2))) + (6*d*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(5*f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [sqrt(d*csc(e + f*x))*sin(e + f*x)^2, x, 4, -((2*d*cos(e + f*x))/(3*f*sqrt(d*csc(e + f*x)))) + (2*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(3*f)]
    @test_int [sqrt(d*csc(e + f*x))*sin(e + f*x)^1, x, 3, (2*d*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [sqrt(d*csc(e + f*x))*sin(e + f*x)^0, x, 2, (2*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/f]
    @test_int [csc(e + f*x)^1*sqrt(d*csc(e + f*x)), x, 4, -((2*cos(e + f*x)*sqrt(d*csc(e + f*x)))/f) - (2*d*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [csc(e + f*x)^2*sqrt(d*csc(e + f*x)), x, 4, -((2*cos(e + f*x)*(d*csc(e + f*x))^(3/2))/(3*d*f)) + (2*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(3*f)]
    @test_int [csc(e + f*x)^3*sqrt(d*csc(e + f*x)), x, 5, -((6*cos(e + f*x)*sqrt(d*csc(e + f*x)))/(5*f)) - (2*cos(e + f*x)*(d*csc(e + f*x))^(5/2))/(5*d^2*f) - (6*d*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(5*f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]


    @test_int [(d*csc(e + f*x))^(3/2)*sin(e + f*x)^5, x, 5, -((2*d^4*cos(e + f*x))/(7*f*(d*csc(e + f*x))^(5/2))) - (10*d^2*cos(e + f*x))/(21*f*sqrt(d*csc(e + f*x))) + (10*d*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(21*f)]
    @test_int [(d*csc(e + f*x))^(3/2)*sin(e + f*x)^4, x, 4, -((2*d^3*cos(e + f*x))/(5*f*(d*csc(e + f*x))^(3/2))) + (6*d^2*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(5*f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [(d*csc(e + f*x))^(3/2)*sin(e + f*x)^3, x, 4, -((2*d^2*cos(e + f*x))/(3*f*sqrt(d*csc(e + f*x)))) + (2*d*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(3*f)]
    @test_int [(d*csc(e + f*x))^(3/2)*sin(e + f*x)^2, x, 3, (2*d^2*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [(d*csc(e + f*x))^(3/2)*sin(e + f*x)^1, x, 3, (2*d*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/f]
    @test_int [(d*csc(e + f*x))^(3/2)*sin(e + f*x)^0, x, 3, -((2*d*cos(e + f*x)*sqrt(d*csc(e + f*x)))/f) - (2*d^2*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [csc(e + f*x)^1*(d*csc(e + f*x))^(3/2), x, 4, -((2*cos(e + f*x)*(d*csc(e + f*x))^(3/2))/(3*f)) + (2*d*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(3*f)]
    @test_int [csc(e + f*x)^2*(d*csc(e + f*x))^(3/2), x, 5, -((6*d*cos(e + f*x)*sqrt(d*csc(e + f*x)))/(5*f)) - (2*cos(e + f*x)*(d*csc(e + f*x))^(5/2))/(5*d*f) - (6*d^2*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(5*f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    ...
    @test_int [sin(e + f*x)^3/sqrt(d*csc(e + f*x)), x, 5, -((2*d^2*cos(e + f*x))/(7*f*(d*csc(e + f*x))^(5/2))) - (10*cos(e + f*x))/(21*f*sqrt(d*csc(e + f*x))) + (10*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(21*d*f)]
    @test_int [sin(e + f*x)^2/sqrt(d*csc(e + f*x)), x, 4, -((2*d*cos(e + f*x))/(5*f*(d*csc(e + f*x))^(3/2))) + (6*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(5*f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [sin(e + f*x)^1/sqrt(d*csc(e + f*x)), x, 4, -((2*cos(e + f*x))/(3*f*sqrt(d*csc(e + f*x)))) + (2*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(3*d*f)]
    @test_int [sin(e + f*x)^0/sqrt(d*csc(e + f*x)), x, 2, (2*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [csc(e + f*x)^1/sqrt(d*csc(e + f*x)), x, 3, (2*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(d*f)]
    @test_int [csc(e + f*x)^2/sqrt(d*csc(e + f*x)), x, 4, -((2*cos(e + f*x)*sqrt(d*csc(e + f*x)))/(d*f)) - (2*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [csc(e + f*x)^3/sqrt(d*csc(e + f*x)), x, 4, -((2*cos(e + f*x)*(d*csc(e + f*x))^(3/2))/(3*d^2*f)) + (2*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(3*d*f)]


    @test_int [sin(e + f*x)^2/(d*csc(e + f*x))^(3/2), x, 5, -((2*d*cos(e + f*x))/(7*f*(d*csc(e + f*x))^(5/2))) - (10*cos(e + f*x))/(21*d*f*sqrt(d*csc(e + f*x))) + (10*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(21*d^2*f)]
    @test_int [sin(e + f*x)^1/(d*csc(e + f*x))^(3/2), x, 4, -((2*cos(e + f*x))/(5*f*(d*csc(e + f*x))^(3/2))) + (6*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(5*d*f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [sin(e + f*x)^0/(d*csc(e + f*x))^(3/2), x, 3, -((2*cos(e + f*x))/(3*d*f*sqrt(d*csc(e + f*x)))) + (2*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(3*d^2*f)]
    @test_int [csc(e + f*x)^1/(d*csc(e + f*x))^(3/2), x, 3, (2*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(d*f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [csc(e + f*x)^2/(d*csc(e + f*x))^(3/2), x, 3, (2*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(d^2*f)]
    @test_int [csc(e + f*x)^3/(d*csc(e + f*x))^(3/2), x, 4, -((2*cos(e + f*x)*sqrt(d*csc(e + f*x)))/(d^2*f)) - (2*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(d*f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    @test_int [csc(e + f*x)^4/(d*csc(e + f*x))^(3/2), x, 4, -((2*cos(e + f*x)*(d*csc(e + f*x))^(3/2))/(3*d^3*f)) + (2*sqrt(d*csc(e + f*x))*Elliptic.F((1/2)*(e - pi/2 + f*x), 2)*sqrt(sin(e + f*x)))/(3*d^2*f)]
    @test_int [csc(e + f*x)^5/(d*csc(e + f*x))^(3/2), x, 5, -((6*cos(e + f*x)*sqrt(d*csc(e + f*x)))/(5*d^2*f)) - (2*cos(e + f*x)*(d*csc(e + f*x))^(5/2))/(5*d^4*f) - (6*Elliptic.E((1/2)*(e - pi/2 + f*x), 2))/(5*d*f*sqrt(d*csc(e + f*x))*sqrt(sin(e + f*x)))]
    ...
    @test_int [(a*sin(e + f*x))^m*(b*csc(e + f*x))^n, x, 2, (cos(e + f*x)*(b*csc(e + f*x))^n*HypergeometricFunctions._₂F₁(1/2, (1/2)*(1 + m - n), (1/2)*(3 + m - n), sin(e + f*x)^2)*(a*sin(e + f*x))^(1 + m))/(a*f*(1 + m - n)*sqrt(cos(e + f*x)^2))]
    end
