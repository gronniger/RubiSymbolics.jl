@testset "4.1.1.3 (g tan)^p (a+b sin)^m" begin
    ...
    @test_int [tan(e + f*x)^4/(a + a*sin(e + f*x))^(1/3), x, 8, (973*sec(e + f*x))/(396*f*(a + a*sin(e + f*x))^(1/3)) - (973*sec(e + f*x)*(1 - sin(e + f*x)))/(495*f*(a + a*sin(e + f*x))^(1/3)) - (sec(e + f*x)*(95*a + 356*a*sin(e + f*x)))/(132*f*(1 - sin(e + f*x))*(a + a*sin(e + f*x))^(4/3)) + (973*Elliptic.F(acos((2^(1/3)*a^(1/3) - (1 - sqrt(3))*(a + a*sin(e + f*x))^(1/3))/(2^(1/3)*a^(1/3) - (1 + sqrt(3))*(a + a*sin(e + f*x))^(1/3))), (1/4)*(2 + sqrt(3)))*sec(e + f*x)*(a + a*sin(e + f*x))^(2/3)*(2^(1/3)*a^(1/3) - (a + a*sin(e + f*x))^(1/3))*sqrt((2^(2/3)*a^(2/3) + 2^(1/3)*a^(1/3)*(a + a*sin(e + f*x))^(1/3) + (a + a*sin(e + f*x))^(2/3))/(2^(1/3)*a^(1/3) - (1 + sqrt(3))*(a + a*sin(e + f*x))^(1/3))^2))/(495*2^(1/3)*3^(1/4)*a^(4/3)*f*sqrt(-(((a + a*sin(e + f*x))^(1/3)*(2^(1/3)*a^(1/3) - (a + a*sin(e + f*x))^(1/3)))/(2^(1/3)*a^(1/3) - (1 + sqrt(3))*(a + a*sin(e + f*x))^(1/3))^2))) + (3*a^2*sin(e + f*x)*tan(e + f*x))/(4*f*(a - a*sin(e + f*x))*(a + a*sin(e + f*x))^(4/3)) + (3*a^2*sin(e + f*x)^2*tan(e + f*x))/(f*(a - a*sin(e + f*x))*(a + a*sin(e + f*x))^(4/3))]
    @test_int [tan(e + f*x)^2/(a + a*sin(e + f*x))^(1/3), x, 4, -((3*sec(e + f*x))/(5*f*(a + a*sin(e + f*x))^(1/3))) + (11*2^(1/6)*cos(e + f*x)*HypergeometricFunctions._₂F₁(1/2, 5/6, 3/2, (1/2)*(1 - sin(e + f*x))))/(15*f*(1 + sin(e + f*x))^(1/6)*(a + a*sin(e + f*x))^(1/3)) + (4*sec(e + f*x)*(a + a*sin(e + f*x))^(2/3))/(5*a*f)]
    ...
    @test_int [(g*tan(e + f*x))^p*(a + a*sin(e + f*x))^3, x, 10, (a^3*HypergeometricFunctions._₂F₁(1, (1 + p)/2, (3 + p)/2, -tan(e + f*x)^2)*(g*tan(e + f*x))^(1 + p))/(f*g*(1 + p)) + (1/(f*g*(2 + p)))*(3*a^3*(cos(e + f*x)^2)^((1 + p)/2)*HypergeometricFunctions._₂F₁((1 + p)/2, (2 + p)/2, (4 + p)/2, sin(e + f*x)^2)*sin(e + f*x)*(g*tan(e + f*x))^(1 + p)) + (1/(f*g*(4 + p)))*(a^3*(cos(e + f*x)^2)^((1 + p)/2)*HypergeometricFunctions._₂F₁((1 + p)/2, (4 + p)/2, (6 + p)/2, sin(e + f*x)^2)*sin(e + f*x)^3*(g*tan(e + f*x))^(1 + p)) + (3*a^3*HypergeometricFunctions._₂F₁(2, (3 + p)/2, (5 + p)/2, -tan(e + f*x)^2)*(g*tan(e + f*x))^(3 + p))/(f*g^3*(3 + p))]
    @test_int [(g*tan(e + f*x))^p*(a + a*sin(e + f*x))^2, x, 8, (a^2*HypergeometricFunctions._₂F₁(1, (1 + p)/2, (3 + p)/2, -tan(e + f*x)^2)*(g*tan(e + f*x))^(1 + p))/(f*g*(1 + p)) + (1/(f*g*(2 + p)))*(2*a^2*(cos(e + f*x)^2)^((1 + p)/2)*HypergeometricFunctions._₂F₁((1 + p)/2, (2 + p)/2, (4 + p)/2, sin(e + f*x)^2)*sin(e + f*x)*(g*tan(e + f*x))^(1 + p)) + (a^2*HypergeometricFunctions._₂F₁(2, (3 + p)/2, (5 + p)/2, -tan(e + f*x)^2)*(g*tan(e + f*x))^(3 + p))/(f*g^3*(3 + p))]
    @test_int [(g*tan(e + f*x))^p*(a + a*sin(e + f*x))^1, x, 6, (a*HypergeometricFunctions._₂F₁(1, (1 + p)/2, (3 + p)/2, -tan(e + f*x)^2)*(g*tan(e + f*x))^(1 + p))/(f*g*(1 + p)) + (1/(f*g*(2 + p)))*(a*(cos(e + f*x)^2)^((1 + p)/2)*HypergeometricFunctions._₂F₁((1 + p)/2, (2 + p)/2, (4 + p)/2, sin(e + f*x)^2)*sin(e + f*x)*(g*tan(e + f*x))^(1 + p))]
    @test_int [(g*tan(e + f*x))^p/(a + a*sin(e + f*x))^1, x, 4, (g*tan(e + f*x))^(1 + p)/(a*f*g*(1 + p)) - ((cos(e + f*x)^2)^((3 + p)/2)*HypergeometricFunctions._₂F₁((2 + p)/2, (3 + p)/2, (4 + p)/2, sin(e + f*x)^2)*sec(e + f*x)*(g*tan(e + f*x))^(2 + p))/(a*f*g^2*(2 + p))]
    @test_int [(g*tan(e + f*x))^p/(a + a*sin(e + f*x))^2, x, 10, (g*tan(e + f*x))^(1 + p)/(a^2*f*g*(1 + p)) - (2*(cos(e + f*x)^2)^((5 + p)/2)*HypergeometricFunctions._₂F₁((2 + p)/2, (5 + p)/2, (4 + p)/2, sin(e + f*x)^2)*sec(e + f*x)^3*(g*tan(e + f*x))^(2 + p))/(a^2*f*g^2*(2 + p)) + (2*(g*tan(e + f*x))^(3 + p))/(a^2*f*g^3*(3 + p))]
    @test_int [(g*tan(e + f*x))^p/(a + a*sin(e + f*x))^3, x, 13, (g*tan(e + f*x))^(1 + p)/(a^3*f*g*(1 + p)) - (3*(cos(e + f*x)^2)^((7 + p)/2)*HypergeometricFunctions._₂F₁((2 + p)/2, (7 + p)/2, (4 + p)/2, sin(e + f*x)^2)*sec(e + f*x)^5*(g*tan(e + f*x))^(2 + p))/(a^3*f*g^2*(2 + p)) + (5*(g*tan(e + f*x))^(3 + p))/(a^3*f*g^3*(3 + p)) - ((cos(e + f*x)^2)^((7 + p)/2)*HypergeometricFunctions._₂F₁((4 + p)/2, (7 + p)/2, (6 + p)/2, sin(e + f*x)^2)*sec(e + f*x)^3*(g*tan(e + f*x))^(4 + p))/(a^3*f*g^4*(4 + p)) + (4*(g*tan(e + f*x))^(5 + p))/(a^3*f*g^5*(5 + p))]
    ...
    @test_int [tan(e + f*x)^3*(a + a*sin(e + f*x))^m, x, 4, (a*(4 + m)*HypergeometricFunctions._₂F₁(1, -1 + m, m, (1/2)*(1 + sin(e + f*x)))*(a + a*sin(e + f*x))^(-1 + m))/(4*f*(1 - m)) - (a^2*sin(e + f*x)^2*(a + a*sin(e + f*x))^(-1 + m))/(f*m*(a - a*sin(e + f*x))) + ((a + a*sin(e + f*x))^(-1 + m)*(a*(2 - 3*m - m^2) + 2*a*m*sin(e + f*x)))/(2*f*(1 - m)*m*(1 - sin(e + f*x)))]
    @test_int [tan(e + f*x)^1*(a + a*sin(e + f*x))^m, x, 3, -((a + a*sin(e + f*x))^m/(2*f*m)) + (HypergeometricFunctions._₂F₁(1, 1 + m, 2 + m, (1/2)*(1 + sin(e + f*x)))*(a + a*sin(e + f*x))^(1 + m))/(4*a*f*(1 + m))]
    @test_int [cot(e + f*x)^1*(a + a*sin(e + f*x))^m, x, 2, -((HypergeometricFunctions._₂F₁(1, 1 + m, 2 + m, 1 + sin(e + f*x))*(a + a*sin(e + f*x))^(1 + m))/(a*f*(1 + m)))]
    @test_int [cot(e + f*x)^3*(a + a*sin(e + f*x))^m, x, 3, -((csc(e + f*x)^2*(a + a*sin(e + f*x))^(2 + m))/(2*a^2*f)) - ((2 - m)*HypergeometricFunctions._₂F₁(2, 2 + m, 3 + m, 1 + sin(e + f*x))*(a + a*sin(e + f*x))^(2 + m))/(2*a^2*f*(2 + m))]
    @test_int [cot(e + f*x)^5*(a + a*sin(e + f*x))^m, x, 4, ((9 - m)*csc(e + f*x)^3*(a + a*sin(e + f*x))^(3 + m))/(12*a^3*f) - (csc(e + f*x)^4*(a + a*sin(e + f*x))^(3 + m))/(4*a^3*f) - ((12 - 9*m + m^2)*HypergeometricFunctions._₂F₁(3, 3 + m, 4 + m, 1 + sin(e + f*x))*(a + a*sin(e + f*x))^(3 + m))/(12*a^3*f*(3 + m))]

    @test_int [tan(e + f*x)^4*(a + a*sin(e + f*x))^m, x, 6, (2^(-(3/2) + m)*(9 - 12*m - 7*m^2 + 6*m^3 + m^4)*HypergeometricFunctions._₂F₁(1/2, 5/2 - m, 3/2, (1/2)*(1 - sin(e + f*x)))*sec(e + f*x)*(1 - sin(e + f*x))*(1 + sin(e + f*x))^(1/2 - m)*(a + a*sin(e + f*x))^m)/(3*f*(1 - m)*m) - (sec(e + f*x)*(a + a*sin(e + f*x))^(-1 + m)*(a*(6 - m - 7*m^2 - m^3) - a*(9 - 6*m - 8*m^2 - m^3)*sin(e + f*x)))/(3*f*(1 - m)*m*(1 - sin(e + f*x))) + (a^2*sin(e + f*x)*(a + a*sin(e + f*x))^(-1 + m)*tan(e + f*x))/(f*(1 - m)*(a - a*sin(e + f*x))) - (a^2*sin(e + f*x)^2*(a + a*sin(e + f*x))^(-1 + m)*tan(e + f*x))/(f*m*(a - a*sin(e + f*x)))]
    @test_int [tan(e + f*x)^2*(a + a*sin(e + f*x))^m, x, 5, (sec(e + f*x)*(a + a*sin(e + f*x))^m)/(f*(1 - m)*m) + (2^(-(1/2) + m)*(1 - m - m^2)*HypergeometricFunctions._₂F₁(-(1/2), 3/2 - m, 1/2, (1/2)*(1 - sin(e + f*x)))*sec(e + f*x)*(1 + sin(e + f*x))^(1/2 - m)*(a + a*sin(e + f*x))^m)/(f*(1 - m)*m) - (sec(e + f*x)*(a + a*sin(e + f*x))^(1 + m))/(a*f*m)]
    @test_int [tan(e + f*x)^0*(a + a*sin(e + f*x))^m, x, 2, -((2^(1/2 + m)*cos(e + f*x)*HypergeometricFunctions._₂F₁(1/2, 1/2 - m, 3/2, (1/2)*(1 - sin(e + f*x)))*(1 + sin(e + f*x))^(-(1/2) - m)*(a + a*sin(e + f*x))^m)/f)]
    ...
    @test_int [(g*tan(e + f*x))^p*(a + b*sin(e + f*x))^3, x, 10, (a^3*HypergeometricFunctions._₂F₁(1, (1 + p)/2, (3 + p)/2, -tan(e + f*x)^2)*(g*tan(e + f*x))^(1 + p))/(f*g*(1 + p)) + (1/(f*g*(2 + p)))*(3*a^2*b*(cos(e + f*x)^2)^((1 + p)/2)*HypergeometricFunctions._₂F₁((1 + p)/2, (2 + p)/2, (4 + p)/2, sin(e + f*x)^2)*sin(e + f*x)*(g*tan(e + f*x))^(1 + p)) + (1/(f*g*(4 + p)))*(b^3*(cos(e + f*x)^2)^((1 + p)/2)*HypergeometricFunctions._₂F₁((1 + p)/2, (4 + p)/2, (6 + p)/2, sin(e + f*x)^2)*sin(e + f*x)^3*(g*tan(e + f*x))^(1 + p)) + (3*a*b^2*HypergeometricFunctions._₂F₁(2, (3 + p)/2, (5 + p)/2, -tan(e + f*x)^2)*(g*tan(e + f*x))^(3 + p))/(f*g^3*(3 + p))]
    @test_int [(g*tan(e + f*x))^p*(a + b*sin(e + f*x))^2, x, 8, (a^2*HypergeometricFunctions._₂F₁(1, (1 + p)/2, (3 + p)/2, -tan(e + f*x)^2)*(g*tan(e + f*x))^(1 + p))/(f*g*(1 + p)) + (1/(f*g*(2 + p)))*(2*a*b*(cos(e + f*x)^2)^((1 + p)/2)*HypergeometricFunctions._₂F₁((1 + p)/2, (2 + p)/2, (4 + p)/2, sin(e + f*x)^2)*sin(e + f*x)*(g*tan(e + f*x))^(1 + p)) + (b^2*HypergeometricFunctions._₂F₁(2, (3 + p)/2, (5 + p)/2, -tan(e + f*x)^2)*(g*tan(e + f*x))^(3 + p))/(f*g^3*(3 + p))]
    @test_int [(g*tan(e + f*x))^p*(a + b*sin(e + f*x))^1, x, 6, (a*HypergeometricFunctions._₂F₁(1, (1 + p)/2, (3 + p)/2, -tan(e + f*x)^2)*(g*tan(e + f*x))^(1 + p))/(f*g*(1 + p)) + (1/(f*g*(2 + p)))*(b*(cos(e + f*x)^2)^((1 + p)/2)*HypergeometricFunctions._₂F₁((1 + p)/2, (2 + p)/2, (4 + p)/2, sin(e + f*x)^2)*sin(e + f*x)*(g*tan(e + f*x))^(1 + p))]
