@testset "4.7.7 Trig functions" begin
    (A, B, C, a, b, c, d, e, f, g, h, m, n, r, s, x, z, ) = @variables A B C a b c d e f g h m n r s x z
    ...
    @test_int [sqrt(a + b*sec(c + d*x))/(1 + cos(c + d*x)), x, 2, (Elliptic.E(asin(tan(c + d*x)/(1 + sec(c + d*x))), (a - b)/(a + b))*sqrt(1/(1 + sec(c + d*x)))*sqrt(a + b*sec(c + d*x)))/(d*sqrt((a + b*sec(c + d*x))/((a + b)*(1 + sec(c + d*x)))))]
    ...
    @test_int [tan(n*x)*sin(x), x, 6, ((1/2)*im)/ℯ^(im*x) + (1/2)*im*ℯ^(im*x) - (im*HypergeometricFunctions._₂F₁(1, -(1/(2*n)), 1 - 1/(2*n), -ℯ^(2*im*n*x)))/ℯ^(im*x) - im*ℯ^(im*x)*HypergeometricFunctions._₂F₁(1, 1/(2*n), (1/2)*(2 + 1/n), -ℯ^(2*im*n*x))]
    ...
    @test_int [cot(n*x)*cos(x), x, 6, -(1/2)/ℯ^(im*x) + ℯ^(im*x)/2 + HypergeometricFunctions._₂F₁(1, -(1/(2*n)), 1 - 1/(2*n), ℯ^(2*im*n*x))/ℯ^(im*x) - ℯ^(im*x)*HypergeometricFunctions._₂F₁(1, 1/(2*n), (1/2)*(2 + 1/n), ℯ^(2*im*n*x))]
    ...
    @test_int [(a*cos(c+d*x) + b*sin(c+d*x))^n, x, 2, -((cos(c + d*x - atan(a, b))^(1 + n)*HypergeometricFunctions._₂F₁(1/2, (1 + n)/2, (3 + n)/2, cos(c + d*x - atan(a, b))^2)*(a*cos(c + d*x) + b*sin(c + d*x))^n*sin(c + d*x - atan(a, b)))/(((a*cos(c + d*x) + b*sin(c + d*x))/sqrt(a^2 + b^2))^n*(d*(1 + n)*sqrt(sin(c + d*x - atan(a, b))^2))))]
    @test_int [(2*cos(c+d*x) + 3*sin(c+d*x))^n, x, 2, -((13^(n/2)*cos(c + d*x - atan(3/2))^(1 + n)*HypergeometricFunctions._₂F₁(1/2, (1 + n)/2, (3 + n)/2, cos(c + d*x - atan(3/2))^2)*sin(c + d*x - atan(3/2)))/(d*(1 + n)*sqrt(sin(c + d*x - atan(3/2))^2)))]
    ...
    @test_int [(a*cos(c+d*x) + b*sin(c+d*x))^(7/2), x, 4, -((10*(a^2 + b^2)*(b*cos(c + d*x) - a*sin(c + d*x))*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))/(21*d)) - (2*(b*cos(c + d*x) - a*sin(c + d*x))*(a*cos(c + d*x) + b*sin(c + d*x))^(5/2))/(7*d) + (10*(a^2 + b^2)^2*Elliptic.F((1/2)*(c + d*x - atan(a, b)), 2)*sqrt((a*cos(c + d*x) + b*sin(c + d*x))/sqrt(a^2 + b^2)))/(21*d*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))]
    @test_int [(a*cos(c+d*x) + b*sin(c+d*x))^(5/2), x, 3, -((2*(b*cos(c + d*x) - a*sin(c + d*x))*(a*cos(c + d*x) + b*sin(c + d*x))^(3/2))/(5*d)) + (6*(a^2 + b^2)*Elliptic.E((1/2)*(c + d*x - atan(a, b)), 2)*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))/(5*d*sqrt((a*cos(c + d*x) + b*sin(c + d*x))/sqrt(a^2 + b^2)))]
    @test_int [(a*cos(c+d*x) + b*sin(c+d*x))^(3/2), x, 3, -((2*(b*cos(c + d*x) - a*sin(c + d*x))*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))/(3*d)) + (2*(a^2 + b^2)*Elliptic.F((1/2)*(c + d*x - atan(a, b)), 2)*sqrt((a*cos(c + d*x) + b*sin(c + d*x))/sqrt(a^2 + b^2)))/(3*d*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))]
    @test_int [(a*cos(c+d*x) + b*sin(c+d*x))^(1/2), x, 2, (2*Elliptic.E((1/2)*(c + d*x - atan(a, b)), 2)*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))/(d*sqrt((a*cos(c + d*x) + b*sin(c + d*x))/sqrt(a^2 + b^2)))]
    @test_int [1/(a*cos(c+d*x) + b*sin(c+d*x))^(1/2), x, 2, (2*Elliptic.F((1/2)*(c + d*x - atan(a, b)), 2)*sqrt((a*cos(c + d*x) + b*sin(c + d*x))/sqrt(a^2 + b^2)))/(d*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))]
    @test_int [1/(a*cos(c+d*x) + b*sin(c+d*x))^(3/2), x, 3, -((2*(b*cos(c + d*x) - a*sin(c + d*x)))/((a^2 + b^2)*d*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))) - (2*Elliptic.E((1/2)*(c + d*x - atan(a, b)), 2)*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))/((a^2 + b^2)*d*sqrt((a*cos(c + d*x) + b*sin(c + d*x))/sqrt(a^2 + b^2)))]
    @test_int [1/(a*cos(c+d*x) + b*sin(c+d*x))^(5/2), x, 3, -((2*(b*cos(c + d*x) - a*sin(c + d*x)))/(3*(a^2 + b^2)*d*(a*cos(c + d*x) + b*sin(c + d*x))^(3/2))) + (2*Elliptic.F((1/2)*(c + d*x - atan(a, b)), 2)*sqrt((a*cos(c + d*x) + b*sin(c + d*x))/sqrt(a^2 + b^2)))/(3*(a^2 + b^2)*d*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))]
    @test_int [1/(a*cos(c+d*x) + b*sin(c+d*x))^(7/2), x, 4, -((2*(b*cos(c + d*x) - a*sin(c + d*x)))/(5*(a^2 + b^2)*d*(a*cos(c + d*x) + b*sin(c + d*x))^(5/2))) - (6*(b*cos(c + d*x) - a*sin(c + d*x)))/(5*(a^2 + b^2)^2*d*sqrt(a*cos(c + d*x) + b*sin(c + d*x))) - (6*Elliptic.E((1/2)*(c + d*x - atan(a, b)), 2)*sqrt(a*cos(c + d*x) + b*sin(c + d*x)))/(5*(a^2 + b^2)^2*d*sqrt((a*cos(c + d*x) + b*sin(c + d*x))/sqrt(a^2 + b^2)))]


    @test_int [(2*cos(c+d*x) + 3*sin(c+d*x))^(7/2), x, 4, (130*13^(3/4)*Elliptic.F((1/2)*(c + d*x - atan(3/2)), 2))/(21*d) - (130*(3*cos(c + d*x) - 2*sin(c + d*x))*sqrt(2*cos(c + d*x) + 3*sin(c + d*x)))/(21*d) - (2*(3*cos(c + d*x) - 2*sin(c + d*x))*(2*cos(c + d*x) + 3*sin(c + d*x))^(5/2))/(7*d)]
    @test_int [(2*cos(c+d*x) + 3*sin(c+d*x))^(5/2), x, 3, (78*13^(1/4)*Elliptic.E((1/2)*(c + d*x - atan(3/2)), 2))/(5*d) - (2*(3*cos(c + d*x) - 2*sin(c + d*x))*(2*cos(c + d*x) + 3*sin(c + d*x))^(3/2))/(5*d)]
    @test_int [(2*cos(c+d*x) + 3*sin(c+d*x))^(3/2), x, 3, (2*13^(3/4)*Elliptic.F((1/2)*(c + d*x - atan(3/2)), 2))/(3*d) - (2*(3*cos(c + d*x) - 2*sin(c + d*x))*sqrt(2*cos(c + d*x) + 3*sin(c + d*x)))/(3*d)]
    @test_int [(2*cos(c+d*x) + 3*sin(c+d*x))^(1/2), x, 2, (2*13^(1/4)*Elliptic.E((1/2)*(c + d*x - atan(3/2)), 2))/d]
    @test_int [1/(2*cos(c+d*x) + 3*sin(c+d*x))^(1/2), x, 2, (2*Elliptic.F((1/2)*(c + d*x - atan(3/2)), 2))/(13^(1/4)*d)]
    @test_int [1/(2*cos(c+d*x) + 3*sin(c+d*x))^(3/2), x, 3, -((2*Elliptic.E((1/2)*(c + d*x - atan(3/2)), 2))/(13^(3/4)*d)) - (2*(3*cos(c + d*x) - 2*sin(c + d*x)))/(13*d*sqrt(2*cos(c + d*x) + 3*sin(c + d*x)))]
    @test_int [1/(2*cos(c+d*x) + 3*sin(c+d*x))^(5/2), x, 3, (2*Elliptic.F((1/2)*(c + d*x - atan(3/2)), 2))/(39*13^(1/4)*d) - (2*(3*cos(c + d*x) - 2*sin(c + d*x)))/(39*d*(2*cos(c + d*x) + 3*sin(c + d*x))^(3/2))]
    @test_int [1/(2*cos(c+d*x) + 3*sin(c+d*x))^(7/2), x, 4, -((6*Elliptic.E((1/2)*(c + d*x - atan(3/2)), 2))/(65*13^(3/4)*d)) - (2*(3*cos(c + d*x) - 2*sin(c + d*x)))/(65*d*(2*cos(c + d*x) + 3*sin(c + d*x))^(5/2)) - (6*(3*cos(c + d*x) - 2*sin(c + d*x)))/(845*d*sqrt(2*cos(c + d*x) + 3*sin(c + d*x)))]
    ...
    @test_int [(2 + 3*cos(d + e*x) + 5*sin(d + e*x))^(5/2), x, 7, (796*sqrt(2 + sqrt(34))*Elliptic.E((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15))/(15*e) + (64*Elliptic.F((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15))/(sqrt(2 + sqrt(34))*e) - (32*(5*cos(d + e*x) - 3*sin(d + e*x))*sqrt(2 + 3*cos(d + e*x) + 5*sin(d + e*x)))/(15*e) - (2*(5*cos(d + e*x) - 3*sin(d + e*x))*(2 + 3*cos(d + e*x) + 5*sin(d + e*x))^(3/2))/(5*e)]
    @test_int [(2 + 3*cos(d + e*x) + 5*sin(d + e*x))^(3/2), x, 6, (16*sqrt(2 + sqrt(34))*Elliptic.E((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15))/(3*e) + (20*Elliptic.F((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15))/(sqrt(2 + sqrt(34))*e) - (2*(5*cos(d + e*x) - 3*sin(d + e*x))*sqrt(2 + 3*cos(d + e*x) + 5*sin(d + e*x)))/(3*e)]
    @test_int [sqrt(2 + 3*cos(d + e*x) + 5*sin(d + e*x)), x, 2, (2*sqrt(2 + sqrt(34))*Elliptic.E((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15))/e]
    @test_int [1/sqrt(2 + 3*cos(d + e*x) + 5*sin(d + e*x)), x, 2, (2*Elliptic.F((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15))/(sqrt(2 + sqrt(34))*e)]
    @test_int [(2 + 3*cos(d + e*x) + 5*sin(d + e*x))^(-3/2), x, 3, -(sqrt(2 + sqrt(34))*Elliptic.E((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15))/(15*e) - (5*cos(d + e*x) - 3*sin(d + e*x))/(15*e*sqrt(2 + 3*cos(d + e*x) + 5*sin(d + e*x)))]
    @test_int [(2 + 3*cos(d + e*x) + 5*sin(d + e*x))^(-5/2), x, 7, (4*sqrt(2 + sqrt(34))*Elliptic.E((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15))/(675*e) + Elliptic.F((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15)/(45*sqrt(2 + sqrt(34))*e) - (5*cos(d + e*x) - 3*sin(d + e*x))/(45*e*(2 + 3*cos(d + e*x) + 5*sin(d + e*x))^(3/2)) + (4*(5*cos(d + e*x) - 3*sin(d + e*x)))/(675*e*sqrt(2 + 3*cos(d + e*x) + 5*sin(d + e*x)))]
    @test_int [(2 + 3*cos(d + e*x) + 5*sin(d + e*x))^(-7/2), x, 8, (-199*sqrt(2 + sqrt(34))*Elliptic.E((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15))/(101250*e) - (8*Elliptic.F((d + e*x - atan(5/3))/2, (2*(17 - sqrt(34)))/15))/(3375*sqrt(2 + sqrt(34))*e) - (5*cos(d + e*x) - 3*sin(d + e*x))/(75*e*(2 + 3*cos(d + e*x) + 5*sin(d + e*x))^(5/2)) + (8*(5*cos(d + e*x) - 3*sin(d + e*x)))/(3375*e*(2 + 3*cos(d + e*x) + 5*sin(d + e*x))^(3/2)) - (199*(5*cos(d + e*x) - 3*sin(d + e*x)))/(101250*e*sqrt(2 + 3*cos(d + e*x) + 5*sin(d + e*x)))]


    @test_int [(a + b*cos(d + e*x) + c*sin(d + e*x))^(5/2), x, 7, (-16*(a*c*cos(d + e*x) - a*b*sin(d + e*x))*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))/(15*e) - (2*(c*cos(d + e*x) - b*sin(d + e*x))*(a + b*cos(d + e*x) + c*sin(d + e*x))^(3/2))/(5*e) + (2*(23*a^2 + 9*(b^2 + c^2))*Elliptic.E((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))/(15*e*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2)))) - (16*a*(a^2 - b^2 - c^2)*Elliptic.F((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2))))/(15*e*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))]
    @test_int [(a + b*cos(d + e*x) + c*sin(d + e*x))^(3/2), x, 6, (-2*(c*cos(d + e*x) - b*sin(d + e*x))*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))/(3*e) + (8*a*Elliptic.E((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))/(3*e*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2)))) - (2*(a^2 - b^2 - c^2)*Elliptic.F((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2))))/(3*e*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))]
    @test_int [sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)), x, 2, (2*Elliptic.E((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))/(e*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2))))]
    @test_int [1/sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)), x, 2, (2*Elliptic.F((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2))))/(e*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))]
    @test_int [(a + b*cos(d + e*x) + c*sin(d + e*x))^(-3/2), x, 3, (2*(c*cos(d + e*x) - b*sin(d + e*x)))/((a^2 - b^2 - c^2)*e*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x))) + (2*Elliptic.E((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))/((a^2 - b^2 - c^2)*e*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2))))]
    @test_int [(a + b*cos(d + e*x) + c*sin(d + e*x))^(-5/2), x, 7, (2*(c*cos(d + e*x) - b*sin(d + e*x)))/(3*(a^2 - b^2 - c^2)*e*(a + b*cos(d + e*x) + c*sin(d + e*x))^(3/2)) + (8*(a*c*cos(d + e*x) - a*b*sin(d + e*x)))/(3*(a^2 - b^2 - c^2)^2*e*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x))) + (8*a*Elliptic.E((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))/(3*(a^2 - b^2 - c^2)^2*e*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2)))) - (2*Elliptic.F((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2))))/(3*(a^2 - b^2 - c^2)*e*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))]
    @test_int [(a + b*cos(d + e*x) + c*sin(d + e*x))^(-7/2), x, 8, (2*(c*cos(d + e*x) - b*sin(d + e*x)))/(5*(a^2 - b^2 - c^2)*e*(a + b*cos(d + e*x) + c*sin(d + e*x))^(5/2)) + (16*(a*c*cos(d + e*x) - a*b*sin(d + e*x)))/(15*(a^2 - b^2 - c^2)^2*e*(a + b*cos(d + e*x) + c*sin(d + e*x))^(3/2)) + (2*(23*a^2 + 9*(b^2 + c^2))*Elliptic.E((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))/(15*(a^2 - b^2 - c^2)^3*e*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2)))) - (16*a*Elliptic.F((d + e*x - atan(b, c))/2, (2*sqrt(b^2 + c^2))/(a + sqrt(b^2 + c^2)))*sqrt((a + b*cos(d + e*x) + c*sin(d + e*x))/(a + sqrt(b^2 + c^2))))/(15*(a^2 - b^2 - c^2)^2*e*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x))) + (2*(c*(23*a^2 + 9*(b^2 + c^2))*cos(d + e*x) - b*(23*a^2 + 9*(b^2 + c^2))*sin(d + e*x)))/(15*(a^2 - b^2 - c^2)^3*e*sqrt(a + b*cos(d + e*x) + c*sin(d + e*x)))]
    ...
    @test_int [(a + b*csc(d + e*x) + c*cot(d + e*x))^(3/2)/csc(d + e*x)^(3/2), x, 7, (8*b*(a + c*cot(d + e*x) + b*csc(d + e*x))^(3/2)*Elliptic.E((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2))))/(3*e*csc(d + e*x)^(3/2)*(b + c*cos(d + e*x) + a*sin(d + e*x))*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2)))) + (2*(a^2 - b^2 + c^2)*(a + c*cot(d + e*x) + b*csc(d + e*x))^(3/2)*Elliptic.F((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2))))/(3*e*csc(d + e*x)^(3/2)*(b + c*cos(d + e*x) + a*sin(d + e*x))^2) - (2*(a + c*cot(d + e*x) + b*csc(d + e*x))^(3/2)*(a*cos(d + e*x) - c*sin(d + e*x)))/(3*e*csc(d + e*x)^(3/2)*(b + c*cos(d + e*x) + a*sin(d + e*x)))]
    @test_int [(a + b*csc(d + e*x) + c*cot(d + e*x))^(1/2)/csc(d + e*x)^(1/2), x, 3, (2*sqrt(a + c*cot(d + e*x) + b*csc(d + e*x))*Elliptic.E((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2))))/(e*sqrt(csc(d + e*x))*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2))))]
    @test_int [csc(d + e*x)^(1/2)/(a + b*csc(d + e*x) + c*cot(d + e*x))^(1/2), x, 3, (2*sqrt(csc(d + e*x))*Elliptic.F((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2))))/(e*sqrt(a + c*cot(d + e*x) + b*csc(d + e*x)))]
    @test_int [csc(d + e*x)^(3/2)/(a + b*csc(d + e*x) + c*cot(d + e*x))^(3/2), x, 4, -((2*csc(d + e*x)^(3/2)*Elliptic.E((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*(b + c*cos(d + e*x) + a*sin(d + e*x))^2)/((a^2 - b^2 + c^2)*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(3/2)*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2))))) - (2*csc(d + e*x)^(3/2)*(b + c*cos(d + e*x) + a*sin(d + e*x))*(a*cos(d + e*x) - c*sin(d + e*x)))/((a^2 - b^2 + c^2)*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(3/2))]
    @test_int [csc(d + e*x)^(5/2)/(a + b*csc(d + e*x) + c*cot(d + e*x))^(5/2), x, 8, (8*b*csc(d + e*x)^(5/2)*Elliptic.E((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*(b + c*cos(d + e*x) + a*sin(d + e*x))^3)/(3*(a^2 - b^2 + c^2)^2*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(5/2)*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2)))) + (2*csc(d + e*x)^(5/2)*Elliptic.F((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*(b + c*cos(d + e*x) + a*sin(d + e*x))^2*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2))))/(3*(a^2 - b^2 + c^2)*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(5/2)) - (2*csc(d + e*x)^(5/2)*(b + c*cos(d + e*x) + a*sin(d + e*x))*(a*cos(d + e*x) - c*sin(d + e*x)))/(3*(a^2 - b^2 + c^2)*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(5/2)) + (8*csc(d + e*x)^(5/2)*(b + c*cos(d + e*x) + a*sin(d + e*x))^2*(a*b*cos(d + e*x) - b*c*sin(d + e*x)))/(3*(a^2 - b^2 + c^2)^2*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(5/2))]


    @test_int [sin(d + e*x)^(3/2)*(a + b*csc(d + e*x) + c*cot(d + e*x))^(3/2), x, 7, (8*b*(a + c*cot(d + e*x) + b*csc(d + e*x))^(3/2)*Elliptic.E((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*sin(d + e*x)^(3/2))/(3*e*(b + c*cos(d + e*x) + a*sin(d + e*x))*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2)))) + (2*(a^2 - b^2 + c^2)*(a + c*cot(d + e*x) + b*csc(d + e*x))^(3/2)*Elliptic.F((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*sin(d + e*x)^(3/2)*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2))))/(3*e*(b + c*cos(d + e*x) + a*sin(d + e*x))^2) - (2*(a + c*cot(d + e*x) + b*csc(d + e*x))^(3/2)*sin(d + e*x)^(3/2)*(a*cos(d + e*x) - c*sin(d + e*x)))/(3*e*(b + c*cos(d + e*x) + a*sin(d + e*x)))]
    @test_int [sin(d + e*x)^(1/2)*(a + b*csc(d + e*x) + c*cot(d + e*x))^(1/2), x, 3, (2*sqrt(a + c*cot(d + e*x) + b*csc(d + e*x))*Elliptic.E((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*sqrt(sin(d + e*x)))/(e*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2))))]
    @test_int [1/(sin(d + e*x)^(1/2)*(a + b*csc(d + e*x) + c*cot(d + e*x))^(1/2)), x, 3, (2*Elliptic.F((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2))))/(e*sqrt(a + c*cot(d + e*x) + b*csc(d + e*x))*sqrt(sin(d + e*x)))]
    @test_int [1/(sin(d + e*x)^(3/2)*(a + b*csc(d + e*x) + c*cot(d + e*x))^(3/2)), x, 4, -((2*Elliptic.E((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*(b + c*cos(d + e*x) + a*sin(d + e*x))^2)/((a^2 - b^2 + c^2)*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(3/2)*sin(d + e*x)^(3/2)*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2))))) - (2*(b + c*cos(d + e*x) + a*sin(d + e*x))*(a*cos(d + e*x) - c*sin(d + e*x)))/((a^2 - b^2 + c^2)*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(3/2)*sin(d + e*x)^(3/2))]
    @test_int [1/(sin(d + e*x)^(5/2)*(a + b*csc(d + e*x) + c*cot(d + e*x))^(5/2)), x, 8, (8*b*Elliptic.E((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*(b + c*cos(d + e*x) + a*sin(d + e*x))^3)/(3*(a^2 - b^2 + c^2)^2*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(5/2)*sin(d + e*x)^(5/2)*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2)))) + (2*Elliptic.F((1/2)*(d + e*x - atan(c, a)), (2*sqrt(a^2 + c^2))/(b + sqrt(a^2 + c^2)))*(b + c*cos(d + e*x) + a*sin(d + e*x))^2*sqrt((b + c*cos(d + e*x) + a*sin(d + e*x))/(b + sqrt(a^2 + c^2))))/(3*(a^2 - b^2 + c^2)*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(5/2)*sin(d + e*x)^(5/2)) - (2*(b + c*cos(d + e*x) + a*sin(d + e*x))*(a*cos(d + e*x) - c*sin(d + e*x)))/(3*(a^2 - b^2 + c^2)*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(5/2)*sin(d + e*x)^(5/2)) + (8*(b + c*cos(d + e*x) + a*sin(d + e*x))^2*(a*b*cos(d + e*x) - b*c*sin(d + e*x)))/(3*(a^2 - b^2 + c^2)^2*e*(a + c*cot(d + e*x) + b*csc(d + e*x))^(5/2)*sin(d + e*x)^(5/2))]
    ...
    @test_int [(a + b*cos(c + d*x)*sin(c + d*x))^(5/2), x, 8, -((2*sqrt(2)*a*b*cos(2*c + 2*d*x)*sqrt(2*a + b*sin(2*c + 2*d*x)))/(15*d)) - (b*cos(2*c + 2*d*x)*(2*a + b*sin(2*c + 2*d*x))^(3/2))/(20*sqrt(2)*d) + ((92*a^2 + 9*b^2)*Elliptic.E(c - pi/4 + d*x, (2*b)/(2*a + b))*sqrt(2*a + b*sin(2*c + 2*d*x)))/(60*sqrt(2)*d*sqrt((2*a + b*sin(2*c + 2*d*x))/(2*a + b))) - (2*sqrt(2)*a*(4*a^2 - b^2)*Elliptic.F(c - pi/4 + d*x, (2*b)/(2*a + b))*sqrt((2*a + b*sin(2*c + 2*d*x))/(2*a + b)))/(15*d*sqrt(2*a + b*sin(2*c + 2*d*x)))]
    @test_int [(a + b*cos(c + d*x)*sin(c + d*x))^(3/2), x, 7, -((b*cos(2*c + 2*d*x)*sqrt(2*a + b*sin(2*c + 2*d*x)))/(6*sqrt(2)*d)) + (2*sqrt(2)*a*Elliptic.E(c - pi/4 + d*x, (2*b)/(2*a + b))*sqrt(2*a + b*sin(2*c + 2*d*x)))/(3*d*sqrt((2*a + b*sin(2*c + 2*d*x))/(2*a + b))) - ((4*a^2 - b^2)*Elliptic.F(c - pi/4 + d*x, (2*b)/(2*a + b))*sqrt((2*a + b*sin(2*c + 2*d*x))/(2*a + b)))/(6*sqrt(2)*d*sqrt(2*a + b*sin(2*c + 2*d*x)))]
    @test_int [(a + b*cos(c + d*x)*sin(c + d*x))^(1/2), x, 3, (Elliptic.E(c - pi/4 + d*x, (2*b)/(2*a + b))*sqrt(2*a + b*sin(2*c + 2*d*x)))/(sqrt(2)*d*sqrt((2*a + b*sin(2*c + 2*d*x))/(2*a + b)))]
    @test_int [1/(a + b*cos(c + d*x)*sin(c + d*x))^(1/2), x, 3, (sqrt(2)*Elliptic.F(c - pi/4 + d*x, (2*b)/(2*a + b))*sqrt((2*a + b*sin(2*c + 2*d*x))/(2*a + b)))/(d*sqrt(2*a + b*sin(2*c + 2*d*x)))]
    @test_int [1/(a + b*cos(c + d*x)*sin(c + d*x))^(3/2), x, 5, (2*sqrt(2)*b*cos(2*c + 2*d*x))/((4*a^2 - b^2)*d*sqrt(2*a + b*sin(2*c + 2*d*x))) + (2*sqrt(2)*Elliptic.E(c - pi/4 + d*x, (2*b)/(2*a + b))*sqrt(2*a + b*sin(2*c + 2*d*x)))/((4*a^2 - b^2)*d*sqrt((2*a + b*sin(2*c + 2*d*x))/(2*a + b)))]
    @test_int [1/(a + b*cos(c + d*x)*sin(c + d*x))^(5/2), x, 8, (4*sqrt(2)*b*cos(2*c + 2*d*x))/(3*(4*a^2 - b^2)*d*(2*a + b*sin(2*c + 2*d*x))^(3/2)) + (32*sqrt(2)*a*b*cos(2*c + 2*d*x))/(3*(4*a^2 - b^2)^2*d*sqrt(2*a + b*sin(2*c + 2*d*x))) + (32*sqrt(2)*a*Elliptic.E(c - pi/4 + d*x, (2*b)/(2*a + b))*sqrt(2*a + b*sin(2*c + 2*d*x)))/(3*(4*a^2 - b^2)^2*d*sqrt((2*a + b*sin(2*c + 2*d*x))/(2*a + b))) - (4*sqrt(2)*Elliptic.F(c - pi/4 + d*x, (2*b)/(2*a + b))*sqrt((2*a + b*sin(2*c + 2*d*x))/(2*a + b)))/(3*(4*a^2 - b^2)*d*sqrt(2*a + b*sin(2*c + 2*d*x)))]
    ...
    @test_int [ℯ^sin(x)*sec(x)^2*(x*cos(x)^3 - sin(x)), x, If(13<9, -3, -2), ℯ^sin(x)*(-1 + x*cos(x))*sec(x)]
    ...
    @test_int [sin(c + d*x)*(a + b/sqrt(sin(c + d*x)) + c*sin(c + d*x))^1, x, 7, (c*x)/2 - (a*cos(c + d*x))/d + (2*b*Elliptic.E((1/2)*(c - pi/2 + d*x), 2))/d - (c*cos(c + d*x)*sin(c + d*x))/(2*d)]
    @test_int [sin(c + d*x)*(a + b/sqrt(sin(c + d*x)) + c*sin(c + d*x))^2, x, 11, b^2*x + a*c*x - (a^2*cos(c + d*x))/d - (c^2*cos(c + d*x))/d + (c^2*cos(c + d*x)^3)/(3*d) + (4*a*b*Elliptic.E((1/2)*(c - pi/2 + d*x), 2))/d + (4*b*c*Elliptic.F((1/2)*(c - pi/2 + d*x), 2))/(3*d) - (4*b*c*cos(c + d*x)*sqrt(sin(c + d*x)))/(3*d) - (a*c*cos(c + d*x)*sin(c + d*x))/d]
