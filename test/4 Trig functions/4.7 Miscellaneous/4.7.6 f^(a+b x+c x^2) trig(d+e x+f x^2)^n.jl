@testset "4.7.6 f^(a+b x+c x^2) trig(d+e x+f x^2)^n" begin
    (F, a, b, c, d, e, f, m, n, x, ) = @variables F a b c d e f m n x
    ...
    @test_int [F^(c*(a + b*x))*sin(d + e*x)^n, x, 2, -((F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(-n, -((e*n + im*b*c*log(F))/(2*e)), (1/2)*(2 - n - (im*b*c*log(F))/e), ℯ^(2*im*(d + e*x)))*sin(d + e*x)^n)/((1 - ℯ^(2*im*(d + e*x)))^n*(im*e*n - b*c*log(F))))]
    ...
    @test_int [F^(c*(a + b*x))*csc(d + e*x)^1, x, 1, -((2*ℯ^(im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, (e - im*b*c*log(F))/(2*e), (1/2)*(3 - (im*b*c*log(F))/e), ℯ^(2*im*(d + e*x))))/(e - im*b*c*log(F)))]
    @test_int [F^(c*(a + b*x))*csc(d + e*x)^2, x, 1, -((4*ℯ^(2*im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, 1 - (im*b*c*log(F))/(2*e), 2 - (im*b*c*log(F))/(2*e), ℯ^(2*im*(d + e*x))))/(2*im*e + b*c*log(F)))]
    @test_int [F^(c*(a + b*x))*csc(d + e*x)^3, x, 2, -((F^(c*(a + b*x))*cot(d + e*x)*csc(d + e*x))/(2*e)) - (b*c*F^(c*(a + b*x))*csc(d + e*x)*log(F))/(2*e^2) - (ℯ^(im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, (e - im*b*c*log(F))/(2*e), (1/2)*(3 - (im*b*c*log(F))/e), ℯ^(2*im*(d + e*x)))*(e + im*b*c*log(F)))/e^2]
    @test_int [F^(c*(a + b*x))*csc(d + e*x)^4, x, 2, -((F^(c*(a + b*x))*cot(d + e*x)*csc(d + e*x)^2)/(3*e)) - (b*c*F^(c*(a + b*x))*csc(d + e*x)^2*log(F))/(6*e^2) + (2*ℯ^(2*im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, 1 - (im*b*c*log(F))/(2*e), 2 - (im*b*c*log(F))/(2*e), ℯ^(2*im*(d + e*x)))*(2*im*e - b*c*log(F)))/(3*e^2)]
    ...
    @test_int [F^(c*(a + b*x))*cos(d + e*x)^n, x, 2, -((F^(c*(a + b*x))*cos(d + e*x)^n*HypergeometricFunctions._₂F₁(-n, -((e*n + im*b*c*log(F))/(2*e)), (1/2)*(2 - n - (im*b*c*log(F))/e), -ℯ^(2*im*(d + e*x))))/((1 + ℯ^(2*im*(d + e*x)))^n*(im*e*n - b*c*log(F))))]
    ...
    @test_int [F^(c*(a + b*x))*sec(d + e*x)^1, x, 1, (2*ℯ^(im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, (e - im*b*c*log(F))/(2*e), (1/2)*(3 - (im*b*c*log(F))/e), -ℯ^(2*im*(d + e*x))))/(im*e + b*c*log(F))]
    @test_int [F^(c*(a + b*x))*sec(d + e*x)^2, x, 1, (4*ℯ^(2*im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, 1 - (im*b*c*log(F))/(2*e), 2 - (im*b*c*log(F))/(2*e), -ℯ^(2*im*(d + e*x))))/(2*im*e + b*c*log(F))]
    @test_int [F^(c*(a + b*x))*sec(d + e*x)^3, x, 2, -((ℯ^(im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, (e - im*b*c*log(F))/(2*e), (1/2)*(3 - (im*b*c*log(F))/e), -ℯ^(2*im*(d + e*x)))*(im*e - b*c*log(F)))/e^2) - (b*c*F^(c*(a + b*x))*log(F)*sec(d + e*x))/(2*e^2) + (F^(c*(a + b*x))*sec(d + e*x)*tan(d + e*x))/(2*e)]
    @test_int [F^(c*(a + b*x))*sec(d + e*x)^4, x, 2, -((2*ℯ^(2*im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, 1 - (im*b*c*log(F))/(2*e), 2 - (im*b*c*log(F))/(2*e), -ℯ^(2*im*(d + e*x)))*(2*im*e - b*c*log(F)))/(3*e^2)) - (b*c*F^(c*(a + b*x))*log(F)*sec(d + e*x)^2)/(6*e^2) + (F^(c*(a + b*x))*sec(d + e*x)^2*tan(d + e*x))/(3*e)]
    ...
    @test_int [ℯ^(c*(a + b*x))*tan(d + e*x)^3, x, 6, (im*ℯ^(c*(a + b*x)))/(b*c) - (6*im*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), -ℯ^(2*im*(d + e*x))))/(b*c) + (12*im*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), -ℯ^(2*im*(d + e*x))))/(b*c) - (8*im*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(3, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), -ℯ^(2*im*(d + e*x))))/(b*c)]
    @test_int [ℯ^(c*(a + b*x))*tan(d + e*x)^2, x, 5, -(ℯ^(c*(a + b*x))/(b*c)) + (4*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), -ℯ^(2*im*(d + e*x))))/(b*c) - (4*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), -ℯ^(2*im*(d + e*x))))/(b*c)]
    @test_int [ℯ^(c*(a + b*x))*tan(d + e*x)^1, x, 4, -((im*ℯ^(c*(a + b*x)))/(b*c)) + (2*im*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), -ℯ^(2*im*(d + e*x))))/(b*c)]
    @test_int [ℯ^(c*(a + b*x))*cot(d + e*x)^1, x, 4, (im*ℯ^(c*(a + b*x)))/(b*c) - (2*im*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), ℯ^(2*im*(d + e*x))))/(b*c)]
    @test_int [ℯ^(c*(a + b*x))*cot(d + e*x)^2, x, 5, -(ℯ^(c*(a + b*x))/(b*c)) + (4*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), ℯ^(2*im*(d + e*x))))/(b*c) - (4*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), ℯ^(2*im*(d + e*x))))/(b*c)]
    @test_int [ℯ^(c*(a + b*x))*cot(d + e*x)^3, x, 6, -((im*ℯ^(c*(a + b*x)))/(b*c)) + (6*im*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(1, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), ℯ^(2*im*(d + e*x))))/(b*c) - (12*im*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), ℯ^(2*im*(d + e*x))))/(b*c) + (8*im*ℯ^(c*(a + b*x))*HypergeometricFunctions._₂F₁(3, -((im*b*c)/(2*e)), 1 - (im*b*c)/(2*e), ℯ^(2*im*(d + e*x))))/(b*c)]


    @test_int [F^(a + b*x)*tan(pi/4 - (c + d*x)/2), x, 5, (im*F^(a + b*x))/(b*log(F)) - (2*im*F^(a + b*x)*HypergeometricFunctions._₂F₁(1, -((im*b*log(F))/d), 1 - (im*b*log(F))/d, im*ℯ^(im*(c + d*x))))/(b*log(F))]
    ...
    @test_int [F^(c*(a + b*x))*sec(d + e*x)^n, x, 2, ((1 + ℯ^(2*im*(d + e*x)))^n*F^(a*c + b*c*x)*HypergeometricFunctions._₂F₁(n, (e*n - im*b*c*log(F))/(2*e), (1/2)*(2 + n - (im*b*c*log(F))/e), -ℯ^(2*im*(d + e*x)))*sec(d + e*x)^n)/(im*e*n + b*c*log(F))]
    ...
    @test_int [F^(c*(a + b*x))*csc(d + e*x)^n, x, 2, -(((1 - ℯ^(-2*im*(d + e*x)))^n*F^(a*c + b*c*x)*csc(d + e*x)^n*HypergeometricFunctions._₂F₁(n, (e*n + im*b*c*log(F))/(2*e), (1/2)*(2 + n + (im*b*c*log(F))/e), ℯ^(-2*im*(d + e*x))))/(im*e*n - b*c*log(F)))]
    ...
    @test_int [F^(a + b*x)*(cos(c + d*x)/(e + e*sin(c + d*x))), x, 5, (im*F^(a + b*x))/(b*e*log(F)) - (2*im*F^(a + b*x)*HypergeometricFunctions._₂F₁(1, -((im*b*log(F))/d), 1 - (im*b*log(F))/d, im*ℯ^(im*(c + d*x))))/(b*e*log(F))]
    @test_int [F^(a + b*x)*(cos(c + d*x)/(e - e*sin(c + d*x))), x, 5, -((im*F^(a + b*x))/(b*e*log(F))) + (2*im*F^(a + b*x)*HypergeometricFunctions._₂F₁(1, -((im*b*log(F))/d), 1 - (im*b*log(F))/d, (-im)*ℯ^(im*(c + d*x))))/(b*e*log(F))]
    @test_int [F^(a + b*x)*(sin(c + d*x)/(e + e*cos(c + d*x))), x, 5, -((im*F^(a + b*x))/(b*e*log(F))) + (2*im*F^(a + b*x)*HypergeometricFunctions._₂F₁(1, -((im*b*log(F))/d), 1 - (im*b*log(F))/d, -ℯ^(im*(c + d*x))))/(b*e*log(F))]
    @test_int [F^(a + b*x)*(sin(c + d*x)/(e - e*cos(c + d*x))), x, 5, (im*F^(a + b*x))/(b*e*log(F)) - (2*im*F^(a + b*x)*HypergeometricFunctions._₂F₁(1, -((im*b*log(F))/d), 1 - (im*b*log(F))/d, ℯ^(im*(c + d*x))))/(b*e*log(F))]
    ...
    @test_int [f^(a + c*x^2)*cos(d + e*x), x, 8, If(13>=8, -(ℯ^((-im)*d + e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((im*e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(4*sqrt(c)*sqrt(log(f))) + (ℯ^(im*d + e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((im*e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(4*sqrt(c)*sqrt(log(f))), (ℯ^((-im)*d + e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi(-((im*e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f))))))/(4*sqrt(c)*sqrt(log(f))) + (ℯ^(im*d + e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((im*e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(4*sqrt(c)*sqrt(log(f))))]
    @test_int [f^(a + c*x^2)*cos(d + e*x)^2, x, 9, If(13>=8, (f^a*sqrt(pi)*erfi(sqrt(c)*x*sqrt(log(f))))/(4*sqrt(c)*sqrt(log(f))) - (ℯ^((-2*im)*d + e^2/(c*log(f)))*f^a*sqrt(pi)*erfi((im*e - c*x*log(f))/(sqrt(c)*sqrt(log(f)))))/(8*sqrt(c)*sqrt(log(f))) + (ℯ^((2*im)*d + e^2/(c*log(f)))*f^a*sqrt(pi)*erfi((im*e + c*x*log(f))/(sqrt(c)*sqrt(log(f)))))/(8*sqrt(c)*sqrt(log(f))), (f^a*sqrt(pi)*erfi(sqrt(c)*x*sqrt(log(f))))/(4*sqrt(c)*sqrt(log(f))) + (ℯ^(-2*im*d + e^2/(c*log(f)))*f^a*sqrt(pi)*erfi(-((im*e - c*x*log(f))/(sqrt(c)*sqrt(log(f))))))/(8*sqrt(c)*sqrt(log(f))) + (ℯ^(2*im*d + e^2/(c*log(f)))*f^a*sqrt(pi)*erfi((im*e + c*x*log(f))/(sqrt(c)*sqrt(log(f)))))/(8*sqrt(c)*sqrt(log(f))))]
    @test_int [f^(a + c*x^2)*cos(d + e*x)^3, x, 14, If(13>=8, (-3*ℯ^((-im)*d + e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((im*e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) - (ℯ^((-3*im)*d + (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*erfi(((3*im)*e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) + (3*ℯ^(im*d + e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((im*e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) + (ℯ^((3*im)*d + (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*erfi(((3*im)*e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))), (3*ℯ^((-im)*d + e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi(-((im*e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f))))))/(16*sqrt(c)*sqrt(log(f))) + (ℯ^(-3*im*d + (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*erfi(-((3*im*e - 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f))))))/(16*sqrt(c)*sqrt(log(f))) + (3*ℯ^(im*d + e^2/(4*c*log(f)))*f^a*sqrt(pi)*erfi((im*e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))) + (ℯ^(3*im*d + (9*e^2)/(4*c*log(f)))*f^a*sqrt(pi)*erfi((3*im*e + 2*c*x*log(f))/(2*sqrt(c)*sqrt(log(f)))))/(16*sqrt(c)*sqrt(log(f))))]
    ...
    @test_int [F^(c*(a + b*x))/(f + f*sin(d + e*x))^1, x, 2, -((2*ℯ^(im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, 1 - (im*b*c*log(F))/e, 2 - (im*b*c*log(F))/e, im*ℯ^(im*(d + e*x))))/(f*(e - im*b*c*log(F))))]
    @test_int [F^(c*(a + b*x))/(f + f*sin(d + e*x))^2, x, 3, -((F^(c*(a + b*x))*cot(d/2 + pi/4 + (e*x)/2)*csc(d/2 + pi/4 + (e*x)/2)^2)/(6*e*f^2)) - (b*c*F^(c*(a + b*x))*csc(d/2 + pi/4 + (e*x)/2)^2*log(F))/(6*e^2*f^2) - (2*ℯ^(im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, 1 - (im*b*c*log(F))/e, 2 - (im*b*c*log(F))/e, im*ℯ^(im*(d + e*x)))*(e + im*b*c*log(F)))/(3*e^2*f^2)]
    ...
    @test_int [F^(c*(a + b*x))/(f + f*cos(d + e*x))^1, x, 2, (2*ℯ^(im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, 1 - (im*b*c*log(F))/e, 2 - (im*b*c*log(F))/e, -ℯ^(im*(d + e*x))))/(f*(im*e + b*c*log(F)))]
    @test_int [F^(c*(a + b*x))/(f + f*cos(d + e*x))^2, x, 3, -((2*ℯ^(im*(d + e*x))*F^(c*(a + b*x))*HypergeometricFunctions._₂F₁(2, 1 - (im*b*c*log(F))/e, 2 - (im*b*c*log(F))/e, -ℯ^(im*(d + e*x)))*(im*e - b*c*log(F)))/(3*e^2*f^2)) - (b*c*F^(c*(a + b*x))*log(F)*sec(d/2 + (e*x)/2)^2)/(6*e^2*f^2) + (F^(c*(a + b*x))*sec(d/2 + (e*x)/2)^2*tan(d/2 + (e*x)/2))/(6*e*f^2)]
    end
