@testset "4.5.2.3 (g sec)^p (a+b sec)^m (c+d sec)^n" begin
    ...
    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m*(c - c*sec(e + f*x))^n, x, 3, -((2^(1/2 + n)*c*HypergeometricFunctions._₂F₁(1/2 + m, 1/2 - n, 3/2 + m, (1/2)*(1 + sec(e + f*x)))*(1 - sec(e + f*x))^(1/2 - n)*(a + a*sec(e + f*x))^m*(c - c*sec(e + f*x))^(-1 + n)*tan(e + f*x))/(f*(1 + 2*m)))]


    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m*(c - c*sec(e + f*x))^2, x, 3, (2^(1/2 + m)*a*HypergeometricFunctions._₂F₁(5/2, 1/2 - m, 7/2, (1/2)*(1 - sec(e + f*x)))*(1 + sec(e + f*x))^(1/2 - m)*(a + a*sec(e + f*x))^(-1 + m)*(c - c*sec(e + f*x))^2*tan(e + f*x))/(5*f)]
    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m*(c - c*sec(e + f*x))^1, x, 3, (2^(1/2 + m)*a*HypergeometricFunctions._₂F₁(3/2, 1/2 - m, 5/2, (1/2)*(1 - sec(e + f*x)))*(1 + sec(e + f*x))^(1/2 - m)*(a + a*sec(e + f*x))^(-1 + m)*(c - c*sec(e + f*x))*tan(e + f*x))/(3*f)]
    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m/(c - c*sec(e + f*x))^1, x, 3, -((2^(1/2 + m)*a*HypergeometricFunctions._₂F₁(-(1/2), 1/2 - m, 1/2, (1/2)*(1 - sec(e + f*x)))*(1 + sec(e + f*x))^(1/2 - m)*(a + a*sec(e + f*x))^(-1 + m)*tan(e + f*x))/(f*(c - c*sec(e + f*x))))]
    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m/(c - c*sec(e + f*x))^2, x, 3, -((2^(1/2 + m)*a*HypergeometricFunctions._₂F₁(-(3/2), 1/2 - m, -(1/2), (1/2)*(1 - sec(e + f*x)))*(1 + sec(e + f*x))^(1/2 - m)*(a + a*sec(e + f*x))^(-1 + m)*tan(e + f*x))/(3*f*(c - c*sec(e + f*x))^2))]
    ...
    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m/(c - c*sec(e + f*x))^(1/2), x, 2, -((HypergeometricFunctions._₂F₁(1, 1/2 + m, 3/2 + m, (1/2)*(1 + sec(e + f*x)))*(a + a*sec(e + f*x))^m*tan(e + f*x))/(f*(1 + 2*m)*sqrt(c - c*sec(e + f*x))))]
    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m/(c - c*sec(e + f*x))^(3/2), x, 2, -((HypergeometricFunctions._₂F₁(2, 1/2 + m, 3/2 + m, (1/2)*(1 + sec(e + f*x)))*(a + a*sec(e + f*x))^m*tan(e + f*x))/(2*c*f*(1 + 2*m)*sqrt(c - c*sec(e + f*x))))]
    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m/(c - c*sec(e + f*x))^(5/2), x, 2, -((HypergeometricFunctions._₂F₁(3, 1/2 + m, 3/2 + m, (1/2)*(1 + sec(e + f*x)))*(a + a*sec(e + f*x))^m*tan(e + f*x))/(4*c^2*f*(1 + 2*m)*sqrt(c - c*sec(e + f*x))))]
    ...
    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m/(c - c*sec(e + f*x))^(m + 0), x, 3, -((2^(1/2 - m)*c*HypergeometricFunctions._₂F₁(1/2 + m, 1/2 + m, 3/2 + m, (1/2)*(1 + sec(e + f*x)))*(1 - sec(e + f*x))^(1/2 + m)*(a + a*sec(e + f*x))^m*(c - c*sec(e + f*x))^(-1 - m)*tan(e + f*x))/(f*(1 + 2*m)))]
    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m/(c - c*sec(e + f*x))^(m - 1), x, 3, -((2^(3/2 - m)*c*HypergeometricFunctions._₂F₁(-(1/2) + m, 1/2 + m, 3/2 + m, (1/2)*(1 + sec(e + f*x)))*(1 - sec(e + f*x))^(-(1/2) + m)*(a + a*sec(e + f*x))^m*tan(e + f*x))/((c - c*sec(e + f*x))^m*(f*(1 + 2*m))))]
    @test_int [sec(e + f*x)*(a + a*sec(e + f*x))^m/(c - c*sec(e + f*x))^(m - 2), x, 3, -((2^(5/2 - m)*c^2*HypergeometricFunctions._₂F₁(-(3/2) + m, 1/2 + m, 3/2 + m, (1/2)*(1 + sec(e + f*x)))*(1 - sec(e + f*x))^(-(1/2) + m)*(a + a*sec(e + f*x))^m*tan(e + f*x))/((c - c*sec(e + f*x))^m*(f*(1 + 2*m))))]
    ...
    @test_int [(g*sec(e + f*x))^p*(a + a*sec(e + f*x))^2*(c - c*sec(e + f*x)), x, 5, -((a^2*c*(cos(e + f*x)^2)^((3 + p)/2)*HypergeometricFunctions._₂F₁(3/2, (3 + p)/2, 5/2, sin(e + f*x)^2)*(g*sec(e + f*x))^p*tan(e + f*x)^3)/(3*f)) - (a^2*c*(cos(e + f*x)^2)^((4 + p)/2)*HypergeometricFunctions._₂F₁(3/2, (4 + p)/2, 5/2, sin(e + f*x)^2)*(g*sec(e + f*x))^(1 + p)*tan(e + f*x)^3)/(3*f*g)]
    @test_int [(g*sec(e + f*x))^p*(a + a*sec(e + f*x))^1*(c - c*sec(e + f*x)), x, 2, -((a*c*(cos(e + f*x)^2)^((3 + p)/2)*HypergeometricFunctions._₂F₁(3/2, (3 + p)/2, 5/2, sin(e + f*x)^2)*(g*sec(e + f*x))^p*tan(e + f*x)^3)/(3*f))]
    @test_int [(g*sec(e + f*x))^p/(a + a*sec(e + f*x))^1*(c - c*sec(e + f*x)), x, 6, -((c*g*(1 - 2*p)*HypergeometricFunctions._₂F₁(1/2, (1 - p)/2, (3 - p)/2, cos(e + f*x)^2)*(g*sec(e + f*x))^(-1 + p)*sin(e + f*x))/(a*f*(1 - p)*sqrt(sin(e + f*x)^2))) + (2*c*HypergeometricFunctions._₂F₁(1/2, -(p/2), (2 - p)/2, cos(e + f*x)^2)*(g*sec(e + f*x))^p*sin(e + f*x))/(a*f*sqrt(sin(e + f*x)^2)) - (2*c*(g*sec(e + f*x))^p*tan(e + f*x))/(f*(a + a*sec(e + f*x)))]
    @test_int [(g*sec(e + f*x))^p/(a + a*sec(e + f*x))^2*(c - c*sec(e + f*x)), x, 7, -((c*g*(3 - 4*p)*HypergeometricFunctions._₂F₁(1/2, (1 - p)/2, (3 - p)/2, cos(e + f*x)^2)*(g*sec(e + f*x))^(-1 + p)*sin(e + f*x))/(3*a^2*f*sqrt(sin(e + f*x)^2))) + (c*(5 - 4*p)*HypergeometricFunctions._₂F₁(1/2, -(p/2), (2 - p)/2, cos(e + f*x)^2)*(g*sec(e + f*x))^p*sin(e + f*x))/(3*a^2*f*sqrt(sin(e + f*x)^2)) - (c*(5 - 4*p)*(g*sec(e + f*x))^p*tan(e + f*x))/(3*a^2*f*(1 + sec(e + f*x))) - (2*c*(g*sec(e + f*x))^p*tan(e + f*x))/(3*f*(a + a*sec(e + f*x))^2)]
    ...
    @test_int [sec(e + f*x)*sqrt(a + b*sec(e + f*x))/sqrt(c + d*sec(e + f*x)), x, 1, (2*cot(e + f*x)*Elliptic.Pi((b*(c + d))/((a + b)*d), asin((sqrt((a + b)/(c + d))*sqrt(c + d*sec(e + f*x)))/sqrt(a + b*sec(e + f*x))), ((a - b)*(c + d))/((a + b)*(c - d)))*sqrt(-(((b*c - a*d)*(1 - sec(e + f*x)))/((c + d)*(a + b*sec(e + f*x)))))*sqrt(((b*c - a*d)*(1 + sec(e + f*x)))/((c - d)*(a + b*sec(e + f*x))))*(a + b*sec(e + f*x)))/(d*sqrt((a + b)/(c + d))*f)]
    ...
    @test_int [sec(e + f*x)/(sqrt(a + b*sec(e + f*x))*sqrt(c + d*sec(e + f*x))), x, 1, (2*sqrt(a + b)*cot(e + f*x)*Elliptic.F(asin((sqrt(c + d)*sqrt(a + b*sec(e + f*x)))/(sqrt(a + b)*sqrt(c + d*sec(e + f*x)))), ((a + b)*(c - d))/((a - b)*(c + d)))*sqrt(((b*c - a*d)*(1 - sec(e + f*x)))/((a + b)*(c + d*sec(e + f*x))))*sqrt(-(((b*c - a*d)*(1 + sec(e + f*x)))/((a - b)*(c + d*sec(e + f*x)))))*(c + d*sec(e + f*x)))/(sqrt(c + d)*(b*c - a*d)*f)]


    @test_int [sec(e + f*x)/(sqrt(2 + 3*sec(e + f*x))*sqrt(-4 + 5*sec(e + f*x))), x, 1, (2*cot(e + f*x)*Elliptic.F(asin(sqrt(2 + 3*sec(e + f*x))/(sqrt(5)*sqrt(-4 + 5*sec(e + f*x)))), 45)*(4 - 5*sec(e + f*x))*sqrt((1 - sec(e + f*x))/(4 - 5*sec(e + f*x)))*sqrt((1 + sec(e + f*x))/(4 - 5*sec(e + f*x))))/f]
    @test_int [sec(e + f*x)/(sqrt(2 + 3*sec(e + f*x))*sqrt(4 - 5*sec(e + f*x))), x, 1, (2*im*cot(e + f*x)*Elliptic.F(im*asinh((sqrt(5)*sqrt(4 - 5*sec(e + f*x)))/sqrt(2 + 3*sec(e + f*x))), 1/45)*sqrt((1 - sec(e + f*x))/(2 + 3*sec(e + f*x)))*sqrt((1 + sec(e + f*x))/(2 + 3*sec(e + f*x)))*(2 + 3*sec(e + f*x)))/(3*sqrt(5)*f)]
    ...
    @test_int [(g*sec(e + f*x))^(3/2)*(c + d*sec(e + f*x))^(1/2)/(a + b*sec(e + f*x)), x, 7, (2*d*g*sqrt((d + c*cos(e + f*x))/(c + d))*Elliptic.Pi(2, (1/2)*(e + f*x), (2*c)/(c + d))*sqrt(g*sec(e + f*x)))/(b*f*sqrt(c + d*sec(e + f*x))) + (2*(b*c - a*d)*g*sqrt((d + c*cos(e + f*x))/(c + d))*Elliptic.Pi((2*a)/(a + b), (1/2)*(e + f*x), (2*c)/(c + d))*sqrt(g*sec(e + f*x)))/(b*(a + b)*f*sqrt(c + d*sec(e + f*x)))]
    @test_int [(g*sec(e + f*x))^(3/2)/((c + d*sec(e + f*x))^(1/2)*(a + b*sec(e + f*x))), x, 3, (2*g*sqrt((d + c*cos(e + f*x))/(c + d))*Elliptic.Pi((2*a)/(a + b), (1/2)*(e + f*x), (2*c)/(c + d))*sqrt(g*sec(e + f*x)))/((a + b)*f*sqrt(c + d*sec(e + f*x)))]
    #= [(g*sec(e + f*x))^(3/2)/((c + d*sec(e + f*x))^(3/2)*(a + b*sec(e + f*x))), x, 0, 0]
    @test_int [(g*sec(e + f*x))^(3/2)/((c + d*sec(e + f*x))^(5/2)*(a + b*sec(e + f*x))), x, 0, 0] =#


    @test_int [(sqrt(g*sec(e + f*x))*sqrt(c + d*sec(e + f*x)))/(a + b*cos(e + f*x)), x, 8, (2*d*sqrt((d + c*cos(e + f*x))/(c + d))*Elliptic.Pi(2, (1/2)*(e + f*x), (2*c)/(c + d))*sqrt(g*sec(e + f*x)))/(a*f*sqrt(c + d*sec(e + f*x))) + (2*(a*c - b*d)*sqrt((d + c*cos(e + f*x))/(c + d))*Elliptic.Pi((2*b)/(a + b), (1/2)*(e + f*x), (2*c)/(c + d))*sqrt(g*sec(e + f*x)))/(a*(a + b)*f*sqrt(c + d*sec(e + f*x)))]
    ...
    @test_int [(sec(e + f*x)*sqrt(a + b*sec(e + f*x)))/(c + c*sec(e + f*x)), x, 1, (Elliptic.E(asin(tan(e + f*x)/(1 + sec(e + f*x))), (a - b)/(a + b))*sqrt(1/(1 + sec(e + f*x)))*sqrt(a + b*sec(e + f*x)))/(c*f*sqrt((a + b*sec(e + f*x))/((a + b)*(1 + sec(e + f*x)))))]


    @test_int [(g*sec(e + f*x))^(3/2)*sqrt(a + b*sec(e + f*x))/(c + c*sec(e + f*x)), x, 11, (g*(b + a*cos(e + f*x))*Elliptic.E((1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/(c*f*sqrt((b + a*cos(e + f*x))/(a + b))*sqrt(a + b*sec(e + f*x))) + ((a - b)*g*sqrt((b + a*cos(e + f*x))/(a + b))*Elliptic.F((1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/(c*f*sqrt(a + b*sec(e + f*x))) + (2*b*g*sqrt((b + a*cos(e + f*x))/(a + b))*Elliptic.Pi(2, (1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/(c*f*sqrt(a + b*sec(e + f*x))) - (g*(b + a*cos(e + f*x))*sqrt(g*sec(e + f*x))*sin(e + f*x))/(f*(c + c*cos(e + f*x))*sqrt(a + b*sec(e + f*x)))]
    ...
    @test_int [sec(e + f*x)^1/(sqrt(a + b*sec(e + f*x))*(c + c*sec(e + f*x))), x, 3, -((2*sqrt(a + b)*cot(e + f*x)*Elliptic.F(asin(sqrt(a + b*sec(e + f*x))/sqrt(a + b)), (a + b)/(a - b))*sqrt((b*(1 - sec(e + f*x)))/(a + b))*sqrt(-((b*(1 + sec(e + f*x)))/(a - b))))/((a - b)*c*f)) + (Elliptic.E(asin(tan(e + f*x)/(1 + sec(e + f*x))), (a - b)/(a + b))*sqrt(1/(1 + sec(e + f*x)))*sqrt(a + b*sec(e + f*x)))/((a - b)*c*f*sqrt((a + b*sec(e + f*x))/((a + b)*(1 + sec(e + f*x)))))]
    @test_int [sec(e + f*x)^2/(sqrt(a + b*sec(e + f*x))*(c + c*sec(e + f*x))), x, 3, (2*a*sqrt(a + b)*cot(e + f*x)*Elliptic.F(asin(sqrt(a + b*sec(e + f*x))/sqrt(a + b)), (a + b)/(a - b))*sqrt((b*(1 - sec(e + f*x)))/(a + b))*sqrt(-((b*(1 + sec(e + f*x)))/(a - b))))/((a - b)*b*c*f) - (Elliptic.E(asin(tan(e + f*x)/(1 + sec(e + f*x))), (a - b)/(a + b))*sqrt(1/(1 + sec(e + f*x)))*sqrt(a + b*sec(e + f*x)))/((a - b)*c*f*sqrt((a + b*sec(e + f*x))/((a + b)*(1 + sec(e + f*x)))))]


    @test_int [(g*sec(e + f*x))^(3/2)/(sqrt(a + b*sec(e + f*x))*(c + c*sec(e + f*x))), x, 7, (g*(b + a*cos(e + f*x))*Elliptic.E((1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/((a - b)*c*f*sqrt((b + a*cos(e + f*x))/(a + b))*sqrt(a + b*sec(e + f*x))) + (g*sqrt((b + a*cos(e + f*x))/(a + b))*Elliptic.F((1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/(c*f*sqrt(a + b*sec(e + f*x))) - (g*(b + a*cos(e + f*x))*sqrt(g*sec(e + f*x))*sin(e + f*x))/((a - b)*f*(c + c*cos(e + f*x))*sqrt(a + b*sec(e + f*x)))]
    @test_int [(g*sec(e + f*x))^(5/2)/(sqrt(a + b*sec(e + f*x))*(c + c*sec(e + f*x))), x, 11, -((g^2*(b + a*cos(e + f*x))*Elliptic.E((1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/((a - b)*c*f*sqrt((b + a*cos(e + f*x))/(a + b))*sqrt(a + b*sec(e + f*x)))) - (g^2*sqrt((b + a*cos(e + f*x))/(a + b))*Elliptic.F((1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/(c*f*sqrt(a + b*sec(e + f*x))) + (2*g^2*sqrt((b + a*cos(e + f*x))/(a + b))*Elliptic.Pi(2, (1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/(c*f*sqrt(a + b*sec(e + f*x))) + (g^2*(b + a*cos(e + f*x))*sqrt(g*sec(e + f*x))*sin(e + f*x))/((a - b)*f*(c + c*cos(e + f*x))*sqrt(a + b*sec(e + f*x)))]
    ...
    @test_int [(g*sec(e + f*x))^(3/2)*sqrt(a + b*sec(e + f*x))/(c + d*sec(e + f*x)), x, 7, (2*b*g*sqrt((b + a*cos(e + f*x))/(a + b))*Elliptic.Pi(2, (1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/(d*f*sqrt(a + b*sec(e + f*x))) - (2*(b*c - a*d)*g*sqrt((b + a*cos(e + f*x))/(a + b))*Elliptic.Pi((2*c)/(c + d), (1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/(d*(c + d)*f*sqrt(a + b*sec(e + f*x)))]
    ...
    @test_int [sec(e + f*x)^1/(sqrt(a + b*sec(e + f*x))*(c + d*sec(e + f*x))), x, 1, (2*Elliptic.Pi((2*d)/(c + d), asin(sqrt(1 - sec(e + f*x))/sqrt(2)), (2*b)/(a + b))*sqrt((a + b*sec(e + f*x))/(a + b))*tan(e + f*x))/((c + d)*f*sqrt(a + b*sec(e + f*x))*sqrt(-tan(e + f*x)^2))]
    @test_int [sec(e + f*x)^2/(sqrt(a + b*sec(e + f*x))*(c + d*sec(e + f*x))), x, 3, (2*sqrt(a + b)*cot(e + f*x)*Elliptic.F(asin(sqrt(a + b*sec(e + f*x))/sqrt(a + b)), (a + b)/(a - b))*sqrt((b*(1 - sec(e + f*x)))/(a + b))*sqrt(-((b*(1 + sec(e + f*x)))/(a - b))))/(b*d*f) - (2*c*Elliptic.Pi((2*d)/(c + d), asin(sqrt(1 - sec(e + f*x))/sqrt(2)), (2*b)/(a + b))*sqrt((a + b*sec(e + f*x))/(a + b))*tan(e + f*x))/(d*(c + d)*f*sqrt(a + b*sec(e + f*x))*sqrt(-tan(e + f*x)^2))]


    @test_int [(g*sec(e + f*x))^(3/2)/(sqrt(a + b*sec(e + f*x))*(c + d*sec(e + f*x))), x, 3, (2*g*sqrt((b + a*cos(e + f*x))/(a + b))*Elliptic.Pi((2*c)/(c + d), (1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/((c + d)*f*sqrt(a + b*sec(e + f*x)))]
    @test_int [(g*sec(e + f*x))^(5/2)/(sqrt(a + b*sec(e + f*x))*(c + d*sec(e + f*x))), x, 7, (2*g^2*sqrt((b + a*cos(e + f*x))/(a + b))*Elliptic.Pi(2, (1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/(d*f*sqrt(a + b*sec(e + f*x))) - (2*c*g^2*sqrt((b + a*cos(e + f*x))/(a + b))*Elliptic.Pi((2*c)/(c + d), (1/2)*(e + f*x), (2*a)/(a + b))*sqrt(g*sec(e + f*x)))/(d*(c + d)*f*sqrt(a + b*sec(e + f*x)))]
