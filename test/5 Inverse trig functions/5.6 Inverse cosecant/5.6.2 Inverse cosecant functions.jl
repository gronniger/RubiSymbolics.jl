@testset "5.6.2 Inverse cosecant functions" begin
    ...
    @test_int [ℯ^acsc(a*x)*x^2, x, 6, ((4/5 - (12*im)/5)*ℯ^((1 + 3*im)*acsc(a*x))*HypergeometricFunctions._₂F₁(3/2 - im/2, 3, 5/2 - im/2, ℯ^(2*im*acsc(a*x))))/a^3 - ((8/5 - (24*im)/5)*ℯ^((1 + 3*im)*acsc(a*x))*HypergeometricFunctions._₂F₁(3/2 - im/2, 4, 5/2 - im/2, ℯ^(2*im*acsc(a*x))))/a^3]
    @test_int [ℯ^acsc(a*x)*x^1, x, 6, ((8/5 + (4*im)/5)*ℯ^((1 + 2*im)*acsc(a*x))*HypergeometricFunctions._₂F₁(1 - im/2, 2, 2 - im/2, ℯ^(2*im*acsc(a*x))))/a^2 - ((16/5 + (8*im)/5)*ℯ^((1 + 2*im)*acsc(a*x))*HypergeometricFunctions._₂F₁(1 - im/2, 3, 2 - im/2, ℯ^(2*im*acsc(a*x))))/a^2]
    @test_int [ℯ^acsc(a*x)*x^0, x, 5, -(((1 - im)*ℯ^((1 + im)*acsc(a*x))*HypergeometricFunctions._₂F₁(1/2 - im/2, 1, 3/2 - im/2, ℯ^(2*im*acsc(a*x))))/a) + ((2 - 2*im)*ℯ^((1 + im)*acsc(a*x))*HypergeometricFunctions._₂F₁(1/2 - im/2, 2, 3/2 - im/2, ℯ^(2*im*acsc(a*x))))/a]
    @test_int [ℯ^acsc(a*x)/x^1, x, 6, (-im)*ℯ^acsc(a*x) + 2*im*ℯ^acsc(a*x)*HypergeometricFunctions._₂F₁(-(im/2), 1, 1 - im/2, ℯ^(2*im*acsc(a*x)))]
