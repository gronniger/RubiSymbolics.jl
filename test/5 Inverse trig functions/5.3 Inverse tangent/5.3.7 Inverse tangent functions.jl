@testset "5.3.7 Inverse tangent functions" begin
    ...
    @test_int [x^(9/2)*atan((sqrt(-e)*x)/sqrt(d + e*x^2)), x, 6, (60*d^2*sqrt(x)*sqrt(d + e*x^2))/(847*(-e)^(5/2)) + (36*d*x^(5/2)*sqrt(d + e*x^2))/(847*(-e)^(3/2)) + (4*x^(9/2)*sqrt(d + e*x^2))/(121*sqrt(-e)) + (2*x^(11/2)*atan((sqrt(-e)*x)/sqrt(d + e*x^2)))/11 + (30*d^(11/4)*sqrt(-e)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*EllipticF(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(847*e^(13/4)*sqrt(d + e*x^2))]
    @test_int [x^(5/2)*atan((sqrt(-e)*x)/sqrt(d + e*x^2)), x, 5, (20*d*sqrt(x)*sqrt(d + e*x^2))/(147*(-e)^(3/2)) + (4*x^(5/2)*sqrt(d + e*x^2))/(49*sqrt(-e)) + (2*x^(7/2)*atan((sqrt(-e)*x)/sqrt(d + e*x^2)))/7 - (10*d^(7/4)*sqrt(-e)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*EllipticF(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(147*e^(9/4)*sqrt(d + e*x^2))]
    @test_int [x^(1/2)*atan((sqrt(-e)*x)/sqrt(d + e*x^2)), x, 4, (4*sqrt(x)*sqrt(d + e*x^2))/(9*sqrt(-e)) + (2*x^(3/2)*atan((sqrt(-e)*x)/sqrt(d + e*x^2)))/3 + (2*d^(3/4)*sqrt(-e)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*EllipticF(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(9*e^(5/4)*sqrt(d + e*x^2))]
    @test_int [atan((sqrt(-e)*x)/sqrt(d + e*x^2))/x^(3/2), x, 3, (-2*atan((sqrt(-e)*x)/sqrt(d + e*x^2)))/sqrt(x) + (2*sqrt(-e)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*EllipticF(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(d^(1/4)*e^(1/4)*sqrt(d + e*x^2))]
    @test_int [atan((sqrt(-e)*x)/sqrt(d + e*x^2))/x^(7/2), x, 4, (-4*sqrt(-e)*sqrt(d + e*x^2))/(15*d*x^(3/2)) - (2*atan((sqrt(-e)*x)/sqrt(d + e*x^2)))/(5*x^(5/2)) - (2*sqrt(-e)*e^(3/4)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*EllipticF(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(15*d^(5/4)*sqrt(d + e*x^2))]
    @test_int [atan((sqrt(-e)*x)/sqrt(d + e*x^2))/x^(11/2), x, 5, (-4*sqrt(-e)*sqrt(d + e*x^2))/(63*d*x^(7/2)) - (20*(-e)^(3/2)*sqrt(d + e*x^2))/(189*d^2*x^(3/2)) - (2*atan((sqrt(-e)*x)/sqrt(d + e*x^2)))/(9*x^(9/2)) + (10*sqrt(-e)*e^(7/4)*(sqrt(d) + sqrt(e)*x)*sqrt((d + e*x^2)/(sqrt(d) + sqrt(e)*x)^2)*EllipticF(2*atan((e^(1/4)*sqrt(x))/d^(1/4)), 1/2))/(189*d^(9/4)*sqrt(d + e*x^2))]
